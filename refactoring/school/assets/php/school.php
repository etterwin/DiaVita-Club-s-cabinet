...
<div class="wrapper-school">
    ...
    <div id="introduction" class="school__body introduction show show-mob">
        ...
        <div class="school-accordion">
            ...
            <h1 class="school-accordion-caption"><?= Yii::t('front', 'First lesson'); ?></h1>
            <div class="school-accordion__container first-lesson">

                <div class="lesson-header">

                    <h1 class="lesson-header-caption"><?= Yii::t('front', 'Who we are?'); ?></h1>
                ...
                <div class="lesson__container--white">
                    ...
                    <div class="lesson__block">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/medal.svg" class="lesson-block-icon"
                             alt="">
                        <p class="lesson-block-text"><?= Yii::t('front', 'We are one of the most innovative network companies in the
                            world.'); ?></p>
                    ...
                    <div class="lesson__block">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/networking.svg"
                             ...
                             alt="">
                        <p class="lesson-block-text"><?= Yii::t('front', 'We offer excellent opportunities for doing business for
                            everyone.'); ?></p>
                    ...
                    <div class="lesson__block">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/presentation.svg"
                             class="lesson-block-icon"
                             alt="">
                        <p class="lesson-block-text"><?= Yii::t('front', 'We teach to build effective marketing plans and effectively use
                    ...
                    <div class="lesson__block">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/like.svg" class="lesson-block-icon"
                             alt="">
                        <p class="lesson-block-text"><?= Yii::t('front', 'What\'s important is that you will not need any material
                            investment.'); ?></p>
                    ...
                    <div class="lesson__block">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/online-shop.svg"
                             class="lesson-block-icon"
                             alt="">
                        <p class="lesson-block-text"><?= Yii::t('front', 'In addition, if you become a part of our team, then you will be
                ...
                <div class="lesson__container">
                    ...
                    <h2 class="lesson-caption--white"><?= Yii::t('front', 'For whom are we?'); ?></h2>
                    ...
                    <div class="lesson__block--two">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/handshake.svg"
                             ...
                             alt="">
                        <p class="lesson-block-text--two--white"><?= Yii::t('front', 'If you dream of your own business, but you do not have seed
                    ...
                    <div class="lesson__block--two">
                        ...
                        <p class="lesson-block-text--two--white"><?= Yii::t('front', 'You can safely call yourself a single-minded person and you
                ...
                <h2 class="lesson-caption--black"><?= Yii::t('front', 'What do we offer?'); ?></h2>
                ...
                <div class="lesson__container--white">
                    ...
                    <div class="first-lesson-wrapper">
                        ...
                        <div class="first-lesson__container">
                            ...
                            <p class="first-lesson-text"><?= Yii::t('front', 'Lack of costs. You do not have to borrow or invest a lot to
                        ...
                        <div class="first-lesson__container">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/certeficate%20-%201.svg"
                                 ...
                                 alt="">
                            <p class="first-lesson-text"><?= Yii::t('front', 'You will learn the secrets of successful business conduct:
                        ...
                        <div class="first-lesson__container">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/laptop-and-rocket.svg"
                                 class="first-lesson-icon"
                                 alt="">
                            <p class="first-lesson-text"><?= Yii::t('front', 'Innovative IT solutions for attracting new customers and
                        ...
                        <div class="first-lesson__container">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/progress.svg"
                                 class="first-lesson-icon" alt="">
                            <p class="first-lesson-text"><?= Yii::t('front', 'Opportunities for rapid career growth.'); ?></p>
                        ...
                        <div class="first-lesson__container">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/three.svg"
                                 class="first-lesson-icon" alt="">
                            <p class="first-lesson-text"><?= Yii::t('front', 'You will find a friendly team and constant acquaintance with
                                successful people.'); ?></p>
            ...
            <h1 class="school-accordion-caption"><?= Yii::t('front', 'Second lesson'); ?></h1>
            <div class="school-accordion__container">

                <div class="lesson-header">

                    <h1 class="lesson-header-caption"><?= Yii::t('front', 'Why should I become a SBL* (Senior Business Leader)?'); ?></h1>
                ...
                <div class="second-lesson__container">
                    ...
                    <p class="second-lesson-text--border"><?= Yii::t('front', 'Show as a comparison of an ordinary partner and SBL. Start
                ...
                <div class="lesson__container">
                    ...
                    <div class="second-lesson__container">
                        ...
                        <p class="second-lesson-container-text"><?= Yii::t('front', 'Our Partner has no structure because he is lazy and
                            looks for a pretext.
                    ...
                    <div class="second-lesson__container">
                        ...
                        <p class="second-lesson-container-text"><?= Yii::t('front', 'Our Partner constantly worries about the personal volume
                ...
                <div class="second-lesson__container">
                    ...
                    <p class="second-lesson-text--border"><?= Yii::t('front', 'Our Partner does not even try to spend a little time and offer
                ...
                <div class="second-lesson__container">
                    ...
                    <p class="second-lesson-text--border"><?= Yii::t('front', 'Our Partner knows other members of the DiaVita Club only a
                ...
                <footer class="lesson-footer">
                    <p class="lesson-footer-text"><?= Yii::t('front', 'Make the right choice, become SBL!'); ?></p>
            ...
            <h1 class="school-accordion-caption"><?= Yii::t('front', 'Third lesson'); ?></h1>
            <div class="school-accordion__container">

                <div class="lesson-header">

                    <h1 class="lesson-header-caption"><?= Yii::t('front', 'Why do you need to team up and share information?'); ?></h1>
                ...
                <div class="third-lesson__container">
                    ...
                    <p class="third-lesson-container-text"><?= Yii::t('front', 'The first is afraid of partnership, because he thinks that
                ...
                <div class="third-lesson__container--gradient">
                    ...
                    <p class="third-lesson-container-text--white"><?= Yii::t('front', 'The second is sharing information with his partners. He
                ...
                <div class="third-lesson__container">
                    ...
                    <p class="third-lesson-container-text"><?= Yii::t('front', 'The first collects information himself, and all his
                ...
                <div class="third-lesson__container--gradient">
                    ...
                    <p class="third-lesson-container-text--white"><?= Yii::t('front', 'The second and his colleagues joined together for a common
                ...
                <div class="third-lesson__container">
                    ...
                    <p class="third-lesson-container-text"><?= Yii::t('front', 'One in the field is not a warrior. The first has loaded on
                ...
                <div class="third-lesson__container--gradient">
                    ...
                    <p class="third-lesson-container-text--white"><?= Yii::t('front', 'The first has reached the status of MP, but for a very long
                ...
                <div class="third-lesson__container">
                    ...
                    <div class="third-lesson-container__content">
                        ...
                        <p class="third-lesson-container-content-text"><?= Yii::t('front', 'No one knows the first panda: he does not
                        ...
                        <p class="third-lesson-container-content-text"><?= Yii::t('front', 'It is necessary to unite in teams, because
    ...
    <div id="online-promotion" class="school__body online-promotion hide hide-mob">
        ...
        <div class="school-accordion">
            ...
            <h1 class="school-accordion-caption"><?= Yii::t('front', 'Basic course of promotion in Instagram'); ?></h1>
            <div class="school-accordion__container">

                <div class="lesson-header">

                    <h2 class="lesson-header-caption"><?= Yii::t('front', 'Basic course of promotion in Instagram'); ?></h2>
                    <img src="/modules/admin/cabinet_assets/pictures/svg/drows/insta-panda.svg"
                         class="lesson-header-img lesson-header-img--320" alt="">

                </div>

                <p class="lesson-text--border"><?= Yii::t('front', 'One of the easiest ways to promote - it\'s personal account Instagram.'); ?></p>

                <p class="lesson-text"><?= Yii::t('front', 'In fact, you can register in Instagram only through the official mobile
                    application. You can log into an existing instagram account on your computer only via a browser.'); ?></p>
                <p class="lesson-text"><?= Yii::t('front', 'To register in this social network and create your own page, install the official
                ...
                <div class="basic-inst-links__container">
                    ...
                    <div class="basic-inst__link">
                        ...
                        <div class="android__container">
                            <a href="https://play.google.com/store/apps/details?id=com.instagram.android&hl=en">
                                ...
                                <img src="/moduless/admin/cabinet_assets/pictures/svg/icons/black-circle.svg"
                        ...
                        <p class="basic-inst-link-text"><?= Yii::t('front', 'For Android'); ?></p>
                    ...
                    <div class="basic-inst__link">
                        ...
                        <p class="basic-inst-link-text"><?= Yii::t('front', 'For iPhone (iOS)'); ?></p>
                    ...
                    <div class="basic-inst__link basic-inst__link-rain">
                        ...
                        <a href="https://www.microsoft.com/en-us/store/p/instagram/9nblggh5l9xt?SilentAuth=1&wa=wsignin1.0">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/windows-logo.svg"
                                 class="basic-inst-link-img" alt=""/></a>
                        <p class="basic-inst-link-text"><?= Yii::t('front', 'For Windows Mobile'); ?></p>
                ...
                <div class="lesson__container">
                    ...
                    <div class="lesson__block">
                        ...
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'Go to the link above, select in accordance with your phone
                    ...
                    <div class="lesson__block">
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/user.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'Run the application and select the registration method. You
                    ...
                    <div class="lesson__block">
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/send-mail.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'You can register via email or phone number, just switch the
                                tab'); ?></p>
                    ...
                    <div class="lesson__block">
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/stationery.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'Enter your phone number or e-mail.'); ?></p>
                    ...
                    <div class="lesson__block">
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/contract.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'Next, enter your name and surname, login and password.
                    ...
                    <div class="lesson__block">
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/networking.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'Subscribe to the maximum number of friends. The more of
                    ...
                    <div class="lesson__block">
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/flag.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'That is all, an account is created, now you should design
                                and set up it.'); ?></p>
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'For successful promotion in Instagram we need at least 100 subscribers.
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'To start promoting goods of the company DV, it is enough to post you have
                ...
                <footer class="lesson-footer">
                    <p class="lesson-footer-text"><?= Yii::t('front', 'More detailed methodology, with private and secret techniques of fast
            ...
            <h1 class="school-accordion-caption"><?= Yii::t('front', 'Basic course of promotion on Facebook'); ?></h1>
            <div class="school-accordion__container">

                <div class="lesson-header">

                    <h2 class="lesson-header-caption"><?= Yii::t('front', 'Basic course of promotion on Facebook'); ?></h2>
                    <img src="/modules/admin/cabinet_assets/pictures/svg/drows/fb-panda.svg"
                         class="lesson-header-img lesson-header-img--320" alt=""/>

                </div>

                <p class="lesson-text--border"><?= Yii::t('front', 'Facebook takes the 1st place in the world by users who visit the resource
                ...
                <p class="lesson-text"><?= Yii::t('front', 'The first thing to do is to download the official Facebook application. Users of
                ...
                <p class="lesson-text"><?= Yii::t('front', 'If you already have a working account in social networks, you just need to log in
                ...
                <div class="lesson__container">
                    ...
                    <div class="lesson__block">
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/fb-logo.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'Launch installed on your smartphone Facebook.'); ?></p>
                        <span class="lesson-block-num--white">1</span>
                    </div>
                    ...
                    <div class="lesson__block">
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/check-symbol.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-block-text--white"><?= Yii::t('front', '"Push" the inscription "Register on Facebook", and then -
                                "Start".'); ?></p>
                        <span class="lesson-block-num--white">2</span>
                    </div>
                    ...
                    <div class="lesson__block">
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/list.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'Enter your real e-mail, as well as a mobile phone number to
                    ...
                    <div class="lesson__block">
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/shield.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'Enter your personal data: name and surname, place of
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'After all the required information is specified, the system will send a
                    confirmation code to your e-mail or number, which you will need to enter in the application to
                    complete the registration.'); ?></p>
                <p class="lesson-text--border"><?= Yii::t('front', 'Then you fill out the questionnaire and start looking for friends. The
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'Promotion in facebook is very similar to promotion in Instagram. Your
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'In the future you need to post about VE (Vite Energy). Then you tell a
                    story about this product and attach a photo. The better quality of the post, the more responses you
                    will receive.'); ?></p>

                <footer class="lesson-footer">
                    <p class="lesson-footer-text"><?= Yii::t('front', 'More detailed information on the promotion on FB you will find in our
            ...
            <h1 class="school-accordion-caption"><?= Yii::t('front', 'Use of other resources and sites'); ?></h1>
            <div class="school-accordion__container">

                <div class="lesson-header">

                    <h2 class="lesson-header-caption"><?= Yii::t('front', 'Use of other resources and sites'); ?></h2>
                    <img src="/modules/admin/cabinet_assets/pictures/svg/drows/line-panda.svg"
                         class="lesson-header-img lesson-header-img--320" alt="">

                </div>

                <p class="lesson-text"><?= Yii::t('front', 'In our previous DiaVita Club lessons we learned how effectively use sites like
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'We\'ll answer 3 main questions: what is Line, how to work with Line, how
                    to sell in Line. So, let\'s go.'); ?></p>

                <div class="lesson__container">

                    <h2 class="lesson-caption--white"><?= Yii::t('front', 'What is Line?'); ?></h2>
                    <p class="lesson-text--white"><?= Yii::t('front', 'If explained easily and briefly Line is a messenger. And a messenger
                    ...
                    <p class="lesson-text--white"><?= Yii::t('front', 'In addition, Line allows you to make free calls from one account to
                ...
                <h2 class="lesson-caption--black"><?= Yii::t('front', 'How to work with Line?'); ?></h2>

                <p class="lesson-text--border"><?= Yii::t('front', 'Currently, Line is available for both PCs and cell phones. So there are
                ...
                <div class="lesson__container--small">
                    ...
                    <div class="lesson__block--four">
                        ...
                        <p class="lesson-block-text--four"><?= Yii::t('front', 'official iTunes and Google Play'); ?></p>
                    ...
                    <div class="lesson__block--four">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/shop.svg"
                             class="lesson-block-icon--four" alt=""/>
                        <p class="lesson-block-text--four"><?= Yii::t('front', 'internal stores of supported OS'); ?></p>
                    ...
                    <div class="lesson__block--four">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/site.svg"
                             class="lesson-block-icon--four" alt=""/>
                        <p class="lesson-block-text--four"><?= Yii::t('front', 'official product website'); ?></p>
                    ...
                    <div class="lesson__block--four">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/internet.svg"
                             class="lesson-block-icon--four" alt=""/>
                        <p class="lesson-block-text--four"><?= Yii::t('front', 'also numerous third-party sites in the Internet'); ?></p>

                    </div>

                </div>

                <p class="lesson-text"><?= Yii::t('front', 'You can log in only via cell phone. You\'ll need to write your phone number and
                    then you\'ll receive a special access code. This code is put in the Line textbox and you can start.'); ?></p>
                <p class="lesson-text--border"><?= Yii::t('front', 'After creating an account you will have all options available: adding
                ...
                <div class="lesson__block">
                    ...
                    <div class="lesson-block__container">
                        <span class="lesson-block-container-text--bold"><?= Yii::t('front', 'ADD FRIENDS.'); ?></span>
                        <span class="lesson-block-container-text"><?= Yii::t('front', 'To add
                ...
                <div class="lesson__block">
                    ...
                    <div class="lesson-block__container">
                        <span class="lesson-block-container-text--bold"><?= Yii::t('front', 'CREATE GROUP CHAT.'); ?></span>
                        <span class="lesson-block-container-text"><?= Yii::t('front', ' In
                ...
                <div class="lesson__block">
                    ...
                    <div class="lesson-block__container">
                        <span class="lesson-block-container-text--bold"><?= Yii::t('front', 'PERSONAL PAGE.'); ?></span>
                        <span class="lesson-block-container-text"><?= Yii::t('front', ' As for
                ...
                <div class="lesson__container">
                    ...
                    <h2 class="lesson-caption--white"><?= Yii::t('front', 'How to sell via Line?'); ?></h2>
                    <p class="lesson-text--white"><?= Yii::t('front', 'Your sales in Line depend on your ability to communicate and persuade
                    ...
                    <div class="line__container--border">
                        ...
                        <div class="line__container--horizontal">
                            ...
                            <div class="lesson-block__container">
                                <b class="lesson-block-container-text--bold"><?= Yii::t('front', 'Establishing a contact.'); ?></b>
                                <p class="lesson-block-container-text"><?= Yii::t('front', 'Add your friends, their friends, subscribers of pages similar with what you\'re offering.
                        ...
                        <div class="line__container--horizontal">
                            ...
                            <div class="lesson-block__container">
                                <b class="lesson-block-container-text--bold"><?= Yii::t('front', 'Identifying needs. '); ?></b>
                                <p class="lesson-block-container-text"><?= Yii::t('front', 'In order for a potential buyer to become your client you need to foresee and feel his
                        ...
                        <div class="line__container--horizontal">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/icon-<?=$lng;?>ree.svg"
                                 class="line-num-icon" alt=""/>

                            <div class="lesson-block__container">
                                <b class="lesson-block-container-text--bold"><?= Yii::t('front', 'Product presentation. '); ?></b>
                                <p class="lesson-block-container-text"><?= Yii::t('front', 'After you saw a person need the product or you convinced him you need to present the
                    ...
                    <p class="lesson-text--white"><?= Yii::t('front', 'Vita Energy is a new generation product, wholly natural and has a
                    ...
                    <div class="line__container--border">
                        ...
                        <div class="line__container--horizontal">
                            ...
                            <div class="lesson-block__container">
                                <b class="lesson-block-container-text--bold"><?= Yii::t('front', 'Working with arguments against. '); ?></b>
                                <p class="lesson-block-container-text"><?= Yii::t('front', 'We will pay a special attention to this step since it is the closing stage of a transaction.
                ...
                <div class="lesson-caption__container">
                    ...
                    <span class="lesson-caption--black"><?= Yii::t('front', 'Arguments against because of errors at establishing a contact stage'); ?></span>

                </div>

                <h3 class="lesson-caption--darkblue"><?= Yii::t('front', 'Case 1. A client refuses to talk'); ?></h3>
                <p class="lesson-text"><?= Yii::t('front', 'Perhaps a client hasn\'t decided yet and wants to study the catalog in more
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'A dialogue is revived. Now your task is to do a nice presentation and
                        convince a potential buyer to purchase the goods.'); ?></p>

                <h3 class="lesson-caption--darkblue"><?= Yii::t('front', 'Case 2. A client expresses distrust.'); ?></h3>
                <p class="lesson-text"><?= Yii::t('front', 'Set a friendly tone. Say hello, introduce yourself and refer to a client by
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'A client is interested it means there is no distrust anymore.'); ?></p>
                ...
                <div class="lesson-caption__container">
                    ...
                    <h2 class="lesson-caption--black"><?= Yii::t('front', 'Arguments against because of mismatching needs'); ?></h2>

                </div>

                <p class="lesson-text--border"><?= Yii::t('front', 'A client should always see benefits for him in your offer! Keep this
                        in mind when establishing a contact!'); ?></p>
                <h3 class="lesson-caption--darkblue"><?= Yii::t('front', 'Case 1. The client doubts whether to buy the goods.'); ?></h3>
                <p class="lesson-text"><?= Yii::t('front', 'When choosing a product a customer can\'t examine it personally. He objects
                ...
                <div class="lesson-caption__container">
                    ...
                    <h2 class="lesson-caption--black"><?= Yii::t('front', 'Arguments against because of incomplete presentation.'); ?></h2>

                </div>

                <p class="lesson-text--border"><?= Yii::t('front', 'Your task is to offer a product that meet the requirements of a
                        client. Let\'s look through main arguments against at this stage.'); ?></p>
                <h3 class="lesson-caption--darkblue"><?= Yii::t('front', 'Case 1. A client doesn\'t understand the benefits.'); ?></h3>
                <p class="lesson-text"><?= Yii::t('front', 'Arguments against are well known: it\'s expensive, I get used to what I have
                ...
                <h3 class="lesson-caption--darkblue"><?= Yii::t('front', 'Case 2. A client doubts because lack of information.'); ?></h3>
                <p class="lesson-text"><?= Yii::t('front', 'This is one of the consequences of the product\'s bad presentation. Try to
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'Remember the main thing: your sales are in your hands. Come up with
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'With LINE you can enjoy comfortable, safe and high-quality
            ...
            <h1 class="school-accordion-caption"><?= Yii::t('front', 'Advanced course of promotion in Instagram'); ?></h1>
            <div class="school-accordion__container">

                <div class="lesson-header">

                    <h2 class="lesson-header-caption"><?= Yii::t('front', 'Advanced course of promotion in Instagram'); ?></h2>
                    <img src="/modules/admin/cabinet_assets/pictures/svg/drows/insta-panda.svg"
                         class="lesson-header-img lesson-header-img--320" alt="">

                </div>

                <p class="lesson-text"><?= Yii::t('front', 'In the DVC lesson on basic principles of promotion in Instagram you learned about
                    registration in the app, adding friends and posting possibilities.'); ?></p>
                <p class="lesson-text--border"><?= Yii::t('front', 'In this advanced course you will learn what kind of accounts there are,
                    how to avoid ban, about basic rules of decorating an account and effective posting.'); ?></p>

                <div class="lesson__container">

                    <h2 class="lesson-caption--white"><?= Yii::t('front', 'Question 1. What types of accounts are there?'); ?></h2>
                    <p class="lesson-text--white"><?= Yii::t('front', 'To begin with, decide what you need Instagram for in order to
                    ...
                    <div class="lesson__block">
                        ...
                        <div class="lesson__block--five">
                            ...
                            <p class="lesson-block-text--five--white"><?= Yii::t('front', 'personal account'); ?></p>
                        ...
                        <div class="lesson__block--five">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/group-trio.svg"
                                 class="lesson-block-icon--five"/>
                            <p class="lesson-block-text--five--white"><?= Yii::t('front', 'public account'); ?></p>
                        ...
                        <div class="lesson__block--five">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/online-shop.svg"
                                 class="lesson-block-icon--five"/>
                            <p class="lesson-block-text--five--white"><?= Yii::t('front', 'online stores'); ?></p>
                        ...
                        <div class="lesson__block--five">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/networking.svg"
                                 class="lesson-block-icon--five"/>
                            <p class="lesson-block-text--five--white"><?= Yii::t('front', 'business accounts'); ?></p>
                        ...
                        <div class="lesson__block--five">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/itunes-googleplay.svg"
                                 class="lesson-block-icon--five"/>
                            <p class="lesson-block-text--five--white"><?= Yii::t('front', 'brand account'); ?></p>

                        </div>

                    </div>

                    <p class="lesson-text--border--white"><?= Yii::t('front', 'When chosen why you create an Instagram account you can choose
                ...
                <h2 class="lesson-caption--black"><?= Yii::t('front', 'Question 2. How to avoid account blocking?'); ?></h2>
                <p class="lesson-text"><?= Yii::t('front', 'There are limits for certain user actions in Instagram. Since exceeding these
                ...
                <div class="lesson__block">
                    ...
                    <div class="lesson__block--three">
                        ...
                        <p class="lesson-block-text--three"><?= Yii::t('front', 'Likes - up to 60 likes per hour.'); ?></p>
                    ...
                    <div class="lesson__block--three">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/comments.svg"
                             class="lesson-block-icon--three"/>
                        <p class="lesson-block-text--three"><?= Yii::t('front', 'Comments - up to 60 comments per hour.'); ?></p>
                    ...
                    <div class="lesson__block--three">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/new-members.svg"
                             class="lesson-block-icon--three"/>
                        <p class="lesson-block-text--three"><?= Yii::t('front', 'Follows and unfollows - up to 60 follows and unfollows
                            per hour.'); ?></p>
                ...
                <p class="lesson-text"><?= Yii::t('front', 'Instagram accounts aren\'t banned manually, but according to some algorithm which
                ...
                <ul class="lesson-list">
                    <li class="lesson-item ">
                        ...
                        <p class="lesson-item-text"><?= Yii::t('front', 'The most important criterion is a sharply increased account
                            popularity.'); ?></p>
                    </li>
                    <li class="lesson-item ">
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/close.svg" class="lesson-item-icon"/>
                        <p class="lesson-item-text"><?= Yii::t('front', 'Secondly, it\'s a frequent IP change.'); ?></p>
                    </li>
                    <li class="lesson-item ">
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/close.svg" class="lesson-item-icon"/>
                        <p class="lesson-item-text"><?= Yii::t('front', 'Thirdly, it\'s a change of device to which an account is
                            attached.'); ?></p>
                    </li>
                </ul>

                <p class="lesson-text"><?= Yii::t('front', 'In order to avoid ban for rules violation, we advise you to carefully read
                ...
                <ul class="lesson-list">
                    <li class="lesson-item">
                        ...
                        <a href="https://help.instagram.com/478745558852511">
                            <p class="lesson-item-text"><?= Yii::t('front', 'Terms of Use'); ?></p>
                        </a>
                    </li>
                    <li class="lesson-item">
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/tick.svg" class="lesson-item-icon"/>
                        <a href="https://help.instagram.com/477434105621119">
                            <p class="lesson-item-text"><?= Yii::t('front', 'Community Guidelines'); ?></p>
                        </a>
                    </li>
                </ul>
                ...
                <div class="lesson__container">
                    ...
                    <h2 class="lesson-caption--white"><?= Yii::t('front', 'Question 3. How to design an account?'); ?></h2>
                    <p class="lesson-text--white"><?= Yii::t('front', 'You should design an account in a way so that a user can
                    ...
                    <h3 class="lesson-caption--white--small"><?= Yii::t('front', 'Photo.'); ?></h3>
                    <p class="lesson-text--white"><?= Yii::t('front', 'If you have a personal account or you promote yourself in Instagram as a brand, then upload
                    ...
                    <h3 class="lesson-caption--white--small"><?= Yii::t('front', 'Name.'); ?></h3>
                    <p class="lesson-text--white"><?= Yii::t('front', 'The basic rule is simplicity. A person should easily remember your name and search for you
                    ...
                    <h3 class="lesson-caption--white--small"><?= Yii::t('front', 'Username.'); ?></h3>
                    <p class="lesson-text--white"><?= Yii::t('front', 'Username limit is 30 characters. Don\'t duplicate your account name in username, it\'s better
                        to write down connected keywords. Don\'t be afraid to use emojis, but moderately, of course.'); ?></p>

                    <h3 class="lesson-caption--white--small"><?= Yii::t('front', 'Bio.'); ?></h3>
                    <p class="lesson-text--white"><?= Yii::t('front', 'Bio limit is 150 characters. Difficulty of this is that you have to fit the whole essence
                    ...
                    <h2 class="lesson-caption--white"><?= Yii::t('front', 'What 150 characters should include?'); ?></h2>
                    ...
                    <div class="lesson__block">
                        ...
                        <div class="lesson__block--four">
                            ...
                            <p class="lesson-block-text--four--white"><?= Yii::t('front', 'Your advantages'); ?></p>
                        ...
                        <div class="lesson__block--four">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/ringing-phone.svg"
                                 class="lesson-block-icon--four"/>
                            <p class="lesson-block-text--four--white"><?= Yii::t('front', 'Information on how to contact you'); ?></p>
                        ...
                        <div class="lesson__block--four">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/megaphone.svg"
                                 class="lesson-block-icon--four"/>
                            <p class="lesson-block-text--four--white"><?= Yii::t('front', 'Call to action'); ?></p>
                        ...
                        <div class="lesson__block--four">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/user-card.svg"
                                 class="lesson-block-icon--four"/>
                            <p class="lesson-block-text--four--white"><?= Yii::t('front', 'Additional Information'); ?></p>
                ...
                <h2 class="lesson-caption--black"><?= Yii::t('front', 'Question 4. What to post?'); ?></h2>
                <p class="lesson-text--border"><?= Yii::t('front', 'Your account content should be as clear and interesting as possible.
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'As for the visual component (photos and video content), we advise you to
                ...
                <p class="lesson-text"><?= Yii::t('front', 'Text as well as photos is the same strong, rich and important part of content.
                ...
                <p class="lesson-text"><?= Yii::t('front', 'Remember that Instagram texts have a limited length, they should not exceed 2200
                ...
                <p class="lesson-text"><?= Yii::t('front', 'At the end of the lesson we offer you some cool goodies that will help you to
                    make visual content of your account stylish:'); ?></p>

                <h2 class="lesson-caption--black"><?= Yii::t('front', 'Apps for photo editing:'); ?></h2>
                ...
                <h2 class="lesson-caption--black"><?= Yii::t('front', 'Apps for video editing:'); ?></h2>
                ...
                <footer class="lesson-footer">
                    ...
                    <p class="lesson-footer-text"><?= Yii::t('front', 'Instagram is one of the main online tools. Use it at full power! More
            ...
            <h1 class="school-accordion-caption"><?= Yii::t('front', 'Advanced course of promotion on Facebook'); ?></h1>
            <div class="school-accordion__container">

                <div class="lesson-header">

                    <h2 class="lesson-header-caption"><?= Yii::t('front', 'Advanced course of promotion on Facebook'); ?></h2>
                    <img src="/modules/admin/cabinet_assets/pictures/svg/drows/fb-panda.svg"
                         class="lesson-header-img lesson-header-img--320" alt=""/>

                </div>

                <p class="lesson-text"><?= Yii::t('front', 'In the previous lesson on basic principles of Facebook promotion, we covered
                    process of installing the app and signing up in the network in detail, as well as first steps of
                    using it.'); ?></p>
                <p class="lesson-text--border"><?= Yii::t('front', 'In the advanced course you\'ll learn how to properly design a page,
                    create thematic groups and make effective posts.'); ?></p>

                <div class="lesson__container">

                    <h2 class="lesson-caption--white"><?= Yii::t('front', 'Question 1. How to design a profile?'); ?></h2>
                    ...
                    <div class="lesson__block">
                        ...
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'The first thing you need to take care of is your personal profile photo.
                    ...
                    <p class="lesson-text--border--white"><?= Yii::t('front', 'You can make an unusual profile picture which will continue
                    ...
                    <p class="lesson-text--white"><?= Yii::t('front', 'Animated profile pictures are gaining great popularity and
                    ...
                    <ul class="lesson-list">
                        <li class="lesson-item">
                            ...
                            <p class="lesson-item-text--white"><?= Yii::t('front', 'Log into Facebook app from your mobile device'); ?></p>
                        </li>
                        <li class="lesson-item">
                            <span class="lesson-item-num--white">2</span>
                            <p class="lesson-item-text--white"><?= Yii::t('front', 'Go to your profile and click on your profile photo'); ?></p>
                        </li>
                        <li class="lesson-item">
                            <span class="lesson-item-num--white">3</span>
                            <p class="lesson-item-text--white"><?= Yii::t('front', 'Select "Take a Video" or "Upload a Video" option'); ?></p>
                        </li>
                        <li class="lesson-item">
                            <span class="lesson-item-num--white">4</span>
                            <p class="lesson-item-text--white"><?= Yii::t('front', 'When you\'re done click "Save"'); ?></p>
                        </li>
                    </ul>
                    ...
                    <div class="lesson__block">
                        ...
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'Be sure to fill in a “Describe yourself” section and add your
                    ...
                    <div class="lesson__block">
                        ...
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'Try to add as much as possible of personal information. By that you
                ...
                <h2 class="lesson-caption--black"><?= Yii::t('front', 'Question 2. How to create a group and what to do with it?'); ?></h2>
                <p class="lesson-text"><?= Yii::t('front', 'Facebook group is a great way to promote your business, sales and to find
                ...
                <div class="advanced-fb__screen">
                    ...
                    <p class="advanced-fb-screen-text"><?= Yii::t('front', 'Go to your personal Facebook account. Click Down button at the
                ...
                <div class="advanced-fb__screen">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/img/adv-fb-screen-2-<?=$lng;?>.png"
                         class="advanced-fb-screen"/>
                    <p class="advanced-fb-screen-text"><?= Yii::t('front', 'Fill in the form with data about your company. Try to briefly and
                ...
                <p class="advanced-text"><?= Yii::t('front', 'Carefully write down data about your target audience. Facebook will recommend
                ...
                <div class="advanced-fb__screen">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/img/adv-fb-screen-3-<?=$lng;?>.png"
                         class="advanced-fb-screen"/>
                    <p class="advanced-fb-screen-text"><?= Yii::t('front', 'Create a cover for the page. The cover size is 851 х 315 px. When
                        creating a picture, follow these parameters, and then you won\'t lose any pixel of quality.'); ?></p>

                </div>

                <p class="advanced-text"><?= Yii::t('front', 'You created the page, but it\'s too early to promote it. It\'s empty and you have
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'We\'ll talk about how to create beautiful and high-quality content for
                    Facebook group in the next block.'); ?></p>

                <div class="lesson__container">

                    <h2 class="lesson-caption--white"><?= Yii::t('front', 'Question 3. How to create effective content?'); ?></h2>
                    <p class="lesson-text--border--white"><?= Yii::t('front', 'Facebook  content is as simple as in other social networks.
                        You can post texts, photo and video content and add entire photo albums.'); ?></p>
                    <p class="lesson-text--white"><?= Yii::t('front', 'We present you 8 really effective tips for creating high-quality
                        Facebook content: '); ?></p>
                    ...
                    <div class="lesson__block">
                        ...
                        <div class="lesson-block__container--wide">
                            ...
                            <h3 class="lesson-caption--white--small"><?= Yii::t('front', 'Tip 1. More positivity'); ?></h3>
                            <p class="lesson-text--white"><?= Yii::t('front', 'Today we have a trend to divide everything into "fun" and
                    ...
                    <div class="lesson__block">
                        ...
                        <div class="lesson-block__container--wide">
                            ...
                            <h3 class="lesson-caption--white--small"><?= Yii::t('front', 'Tip 2. Create intrigue'); ?></h3>
                            <p class="lesson-text--white"><?= Yii::t('front', 'Most popular posts are those where you offer something
                    ...
                    <div class="lesson__block">
                        ...
                        <div class="lesson-block__container--wide">
                            ...
                            <h3 class="lesson-caption--white--small"><?= Yii::t('front', 'Tip 3. Short links'); ?></h3>
                            <p class="lesson-text--white"><?= Yii::t('front', 'If you want to share a link with subscribers in your post, make
                                it short. A perfect help are by services like'); ?></p>
                            <a href="https://bitly.com/" class="advanced-icon-link">
                                Bitly.
                            </a>
                            <p class="lesson-text--white"><?= Yii::t('front', 'Don\'t overload a post with unnecessary characters. Brevity is the soul of wit.'); ?></p>
                    ...
                    <div class="lesson__block">
                        ...
                        <div class="lesson-block__container--wide">
                            ...
                            <h3 class="lesson-caption--white--small"><?= Yii::t('front', 'Tip 4. Make images juicy'); ?></h3>
                            <p class="lesson-text--white"><?= Yii::t('front', 'Most engaging Facebook posts are those which have a picture.
                    ...
                    <div class="lesson__block">
                        ...
                        <div class="lesson-block__container--wide">
                            ...
                            <h3 class="lesson-caption--white--small"><?= Yii::t('front', 'Tip 5. Adjust to devices'); ?></h3>
                            <p class="lesson-text--white"><?= Yii::t('front', 'Even if you upload posts from PC don\'t forget that most
                    ...
                    <div class="lesson__block">
                        ...
                        <div class="lesson-block__container--wide">
                            ...
                            <h3 class="lesson-caption--white--small"><?= Yii::t('front', 'Tip 6. Involve through dialogue'); ?></h3>
                            <p class="lesson-text--white"><?= Yii::t('front', 'Comments and answers also attract your audience\'s attention to
                    ...
                    <div class="lesson__block">
                        ...
                        <div class="lesson-block__container--wide">
                            ...
                            <h3 class="lesson-caption--white--small"><?= Yii::t('front', 'Tip 7. Maintain prime time'); ?></h3>
                            <p class="lesson-text--white"><?= Yii::t('front', 'Prime time is the most appropriate time for posting content
                    ...
                    <div class="lesson__block">
                        ...
                        <div class="lesson-block__container--wide">
                            ...
                            <h3 class="lesson-caption--white--small"><?= Yii::t('front', 'Tip 8. Use auto posting'); ?></h3>
                            <p class="lesson-text--white"><?= Yii::t('front', 'Auto posting, or in other words ability to plan posts and upload
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'After you have high-quality content in your page and group, don\'t forget
                ...
                <div class="lesson__block">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/time-refresh.svg"
                         class="lesson-block-icon"/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Update content regularly. Give your subscribers a
                ...
                <div class="lesson__block">
                    ...
                    <p class="lesson-block-text"><?= Yii::t('front', 'Communicate with subscribers, make new friends, expand
                ...
                <div class="lesson__block">
                    ...
                    <p class="lesson-block-text"><?= Yii::t('front', 'Always think about your reputation. You need to create
                ...
                <footer class="lesson-footer">
                    ...
                    <p class="lesson-footer-text"><?= Yii::t('front', 'In private Facebook promotion course you will learn about your group promotion
            ...
            <h1 class="school-accordion-caption"><?= Yii::t('front', 'Targeted advertising on Facebook'); ?></h1>
            <div class="school-accordion__container">

                <div class="lesson-header">

                    <h2 class="lesson-header-caption"><?= Yii::t('front', 'Targeted advertising on Facebook'); ?></h2>
                    <img src="/modules/admin/cabinet_assets/pictures/svg/drows/panda-darts.svg"
                         class="lesson-header-img" alt=""/>

                </div>

                <p class="lesson-text--border"><?= Yii::t('front', 'In previous lessons you\'ve already learned basic principles of Facebook
                ...
                <p class="lesson-text"><?= Yii::t('front', 'Facebook constantly analyzes interests and behavior of users on the site, in the
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'What you need to do to start using an effective tool like targeted
                ...
                <div class="lesson__block">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/create-page.svg"
                         class="lesson-block-icon"/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Create a business page for yourself or for your brand. Or make sure that
                ...
                <div class="lesson__block">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/create-ad.svg"
                         class="lesson-block-icon"/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Targeting of Facebook advertising begins in section Adsmanager, where you
                ...
                <div class="lesson__block">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/target-ad.svg"
                         class="lesson-block-icon"/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Choose a campaign\'s purpose. By choosing a purpose you tell Facebook what
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'Let\'s observe them in more detail, so you understand what advertising
                ...
                <div class="lesson__container">
                    ...
                    <div class="target-fb__box">
                        ...
                        <div class="target-fb__content--small">
                            ...
                            <h2 class="target-fb-caption--white"><?= Yii::t('front', 'Recognition'); ?></h2>
                            <p class="target-fb-text--white"><?= Yii::t('front', 'main goal is to increase awareness of your brand, this
                    ...
                    <ul class="target-fb-list">
                        <li class="target-fb-item">
                            <p class="target-fb-item-text"><?= Yii::t('front', 'Brand recognition - advertising is shown to create a brand
                                image in your target audience.'); ?></p>
                        </li>
                        <li class="target-fb-item">
                            <p class="target-fb-item-text"><?= Yii::t('front', 'Reach - allows you to choose how often users will see your
                                ad.'); ?></p>
                        </li>
                    </ul>
                    ...
                    <div class="target-fb__box">
                        ...
                        <div class="target-fb__content--alone">
                            ...
                            <h2 class="target-fb-caption--white"><?= Yii::t('front', 'Leads'); ?></h2>
                            <p class="target-fb-text--white"><?= Yii::t('front', 'purposes of this group are aimed at involving users to
                    ...
                    <ul class="target-fb-list">
                        <li class="target-fb-item">
                            <p class="target-fb-item-text"><?= Yii::t('front', 'Traffic - allows to show ads to people who are more likely
                                to click on a link in an ad.'); ?></p>
                        </li>
                        <li class="target-fb-item">
                            <p class="target-fb-item-text"><?= Yii::t('front', 'Involvement - allows to show ads to people who will interact
                                with your ad: like it, comment, click on links, put "like" to your page.'); ?></p>
                        </li>
                        <li class="target-fb-item">
                            <p class="target-fb-item-text"><?= Yii::t('front', 'App settings - shows ads to those who are more likely to
                                install your app.'); ?></p>
                        </li>
                        <li class="target-fb-item">
                            <p class="target-fb-item-text"><?= Yii::t('front', 'Watching videos - shows ads to those who are more likely to
                                see your video.'); ?></p>
                        </li>
                        <li class="target-fb-item">
                            <p class="target-fb-item-text"><?= Yii::t('front', 'Leads generation - shows ads to people who are more likely
                    ...
                    <div class="target-fb__box">
                        ...
                        <div class="target-fb__content--small">
                            ...
                            <h2 class="target-fb-caption--white"><?= Yii::t('front', 'Conversion'); ?></h2>
                            <p class="target-fb-text--white"><?= Yii::t('front', 'purposes of this group are aimed at getting sales /
                    ...
                    <ul class="target-fb-list">
                        <li class="target-fb-item">
                            <p class="target-fb-item-text"><?= Yii::t('front', 'Conversions - allows you to show ads to people who are more
                                likely to perform a targeted action: send an application, make a purchase, sign in,
                                etc.'); ?></p>
                        </li>
                        <li class="target-fb-item">
                            <p class="target-fb-item-text"><?= Yii::t('front', 'Sales by products catalog - allows you to download a product
                                catalog and show ads depending on a person\'s actions on a site: viewing a product card,
                                adding to a shopping cart, etc.'); ?></p>
                        </li>
                        <li class="target-fb-item">
                            <p class="target-fb-item-text"><?= Yii::t('front', 'Visiting points - shows ads to people who can visit your
                                campaign.'); ?></p>
                        </li>
                    </ul>
                ...
                <div class="lesson__block">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/head-management.svg"
                         class="lesson-block-icon"/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Write a campaign title. If you click "Split test", you can set up ads
                ...
                <div class="lesson__block">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/setting-ad.svg"
                         class="lesson-block-icon"/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Set up your advertising account. You should select country, currency and
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'Be sure to choose currency in which you\'ll pay for advertising. After
                ...
                <div class="lesson__block">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/setting-ad.svg"
                         class="lesson-block-icon"/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Set up targeting and select an audience to show ads to.'); ?></p>
                ...
                <div class="lesson__container">
                    ...
                    <h2 class="lesson-caption--white"><?= Yii::t('front', 'Basic targeting settings include:'); ?></h2>

                    <ul class="lesson-list">
                        <li class="lesson-item">
                            <img src="/modules/modules/admin/cabinet_assets/pictures/svg/icons/earth-white.svg"
                                 class="lesson-item-icon"/>
                            <p class="lesson-item-text--white"><?= Yii::t('front', 'Geo - allows you to select cities, countries or
                                points on map to show ads.'); ?></p>
                        </li>
                        <li class="lesson-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/map-mark.svg"
                                 class="lesson-item-icon"/>
                            <p class="lesson-item-text--white"><?= Yii::t('front', 'Location - allows you to choose permanent residents
                                of a place, travelers and recent visitors.'); ?></p>
                        </li>
                        <li class="lesson-item">
                            <img src="/modules/modules/admin/cabinet_assets/pictures/svg/icons/age-icon.svg"
                                 class="lesson-item-icon"/>
                            <p class="lesson-item-text--white"><?= Yii::t('front', 'Age - gives age choice from 13 to 65+ years.'); ?></p>
                        </li>
                        <li class="lesson-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/gender-icon.svg"
                                 class="lesson-item-icon"/>
                            <p class="lesson-item-text--white"><?= Yii::t('front', 'Sex - allows you to choose men, women or both sexes
                                to show ads to.'); ?></p>
                        </li>
                        <li class="lesson-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/language-icon.svg"
                                 class="lesson-item-icon"/>
                            <p class="lesson-item-text--white"><?= Yii::t('front', 'Language - allows to select language which your
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'Detailed targeting allows you to show ads based on person\'s interests
                    and his behavior on Facebook and beyond it.'); ?></p>
                <p class="lesson-text"><?= Yii::t('front', 'It has 3 categories, each of them includes many subcategories:'); ?></p>
                ...
                <div class="lesson__block">
                    ...
                    <div class="lesson-block__container">
                        ...
                        <h3 class="lesson-block-text--bold"><?= Yii::t('front', 'Demographic interests:'); ?></h3>
                        <p class="lesson-block-text"><?= Yii::t('front', 'education, age mates, life events, marital status and work.'); ?></p>
                ...
                <div class="lesson__block">
                    ...
                    <div class="lesson-block__container">
                        ...
                        <h3 class="lesson-block-text--bold"><?= Yii::t('front', 'Interests:'); ?></h3>
                        <p class="lesson-block-text"><?= Yii::t('front', 'business and industry, foods and drinks, shopping and fashion,
                ...
                <div class="lesson__block">
                    ...
                    <div class="lesson-block__container">
                        ...
                        <h3 class="lesson-block-text--bold"><?= Yii::t('front', 'Behavior:'); ?></h3>
                        <p class="lesson-block-text"><?= Yii::t('front', 'anniversary, online activities, consumer classification,
                ...
                <div class="target-fb__container--white">
                    ...
                    <p class="lesson-block-text--border"><?= Yii::t('front', 'After choosing targeting you\'ll see audience size found by
                        Facebook.'); ?></p>
                ...
                <div class="lesson__block">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/setting-ad.svg"
                         class="lesson-block-icon"/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Choose your ad\'s placement'); ?></p>
                ...
                <div class="lesson__container">
                    ...
                    <p class="lesson-text--white"><?= Yii::t('front', 'When creating an ad Facebook suggests using auto or manually
                        selected placements (advertising spots).'); ?></p>
                    <p class="lesson-text--white"><?= Yii::t('front', 'We are interested in the latter. So click on "edit placement".'); ?></p>
                    <p class="lesson-text--white"><?= Yii::t('front', 'First of all you need to choose where you\'ll show ads:'); ?></p>
                    ...
                    <div class="lesson__block">
                        ...
                        <div class="lesson__block--three">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/smartphone.svg"
                                 class="lesson-block-icon--three"/>
                            <p class="lesson-block-text--three--white"><?= Yii::t('front', 'Smartphones\''); ?></p>
                        ...
                        <div class="lesson__block--three">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/smartphone.svg"
                                 class="lesson-block-icon--three"/>
                            <p class="lesson-block-text--three--white"><?= Yii::t('front', 'PCs'); ?></p>
                        ...
                        <div class="lesson__block--three">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/smartphone.svg"
                                 class="lesson-block-icon--three"/>
                            <p class="lesson-block-text--three--white"><?= Yii::t('front', 'All (smartphones and PCs)'); ?></p>
                ...
                <p class="lesson-text"><?= Yii::t('front', 'Select an option you need and go to ads placement. So, what types of placement
                    can be selected: '); ?></p>
                ...
                <div class="lesson__block">
                    ...
                    <div class="lesson__block--four">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/fb-logo.svg"
                             class="lesson-block-icon--four"/>
                        <b>Facebook</b>
                        <p class="lesson-block-text--four"><?= Yii::t('front', 'ads are shown on Facebook website and in the app'); ?></p>
                    ...
                    <div class="lesson__block--four">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/instagram-icon.svg"
                             class="lesson-block-icon--four"/>
                        <b>Instagram</b>
                        <p class="lesson-block-text--four"><?= Yii::t('front', 'ads are shown in the smartphone app'); ?></p>
                    ...
                    <div class="lesson__block--four">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/messenger.svg"
                             class="lesson-block-icon--four"/>
                        <b>Messenger</b>
                        <p class="lesson-block-text--four"><?= Yii::t('front', 'ads are shown on Facebook, in the app and in the messenger app'); ?></p>
                    ...
                    <div class="lesson__block--four">
                        ...
                        <p class="lesson-block-text--four"><?= Yii::t('front', 'ads are shown on sites and apps of Facebook partners'); ?></p>

                    </div>

                </div>

                <p class="lesson-text"><?= Yii::t('front', 'You can also choose devices and their models where your ads will be shown.'); ?></p>

                <div class="lesson__block">

                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/calculated.svg"
                         class="lesson-block-icon"/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Choose an advertising campaign budget'); ?></p>
                    <span class="lesson-block-num">8</span>

                </div>

                <p class="lesson-text"><?= Yii::t('front', 'You can choose 2 budget options:'); ?></p>
                <b class="lesson-text--bold"><?= Yii::t('front', 'Daily budget'); ?></b>
                <p class="lesson-text"><?= Yii::t('front', 'is the amount you\'re ready to spend on advertising daily.'); ?></p>

                <img src="/modules/admin/cabinet_assets/pictures/img/target-ad-fb-screen-7-<?=$lng;?>.png"
                     class="target-gb-screen"/>

                <b class="lesson-text--bold"><?= Yii::t('front', 'Budget for entire duration'); ?></b>
                <p class="lesson-text"><?= Yii::t('front', 'is the amount you\'re ready to spend on advertising for a certain period of time.'); ?></p>
                ...
                <div class="lesson__block">
                    ...
                    <p class="lesson-block-text"><?= Yii::t('front', 'Choose your ads optimization and price.'); ?></p>
                    <span class="lesson-block-num">9</span>

                </div>

                <p class="lesson-text--border"><?= Yii::t('front', 'You can choose how you\'ll pay for advertising: for showing it or per
                ...
                <p class="lesson-text"><?= Yii::t('front', 'You can set up start date and end date of ad. Here you can come up with schedule
                ...
                <div class="lesson__block">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/create-template.svg"
                         class="lesson-block-icon"/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Create an ad'); ?></p>
                ...
                <div class="lesson__container">
                    ...
                    <div class="lesson__block">
                        ...
                        <span class="lesson-block-num--white">1</span>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'Write ads title and select a page from which you\'ll
                            launch it'); ?></p>
                    ...
                    <div class="lesson__block">
                        ...
                        <span class="lesson-block-num--white">2</span>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'Select an ads format'); ?></p>
                    ...
                    <p class="lesson-text--border--white"><?= Yii::t('front', 'These are the most popular formats. If you set different
                    ...
                    <div class="lesson__block">
                        ...
                        <span class="lesson-block-num--white">3</span>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'Create an ad
                    ...
                    <ul class="lesson-list">
                        <li class="lesson-container-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/tick-white.svg"
                                 class="lesson-item-icon"/>
                            <p class="lesson-item-text"><?= Yii::t('front', 'Picture in size 1200x628 pixels'); ?></p>
                        </li>
                        <li class="lesson-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/tick-white.svg"
                                 class="lesson-item-icon"/>
                            <p class="lesson-item-text"><?= Yii::t('front', 'Links'); ?></p>
                        </li>
                        <li class="lesson-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/tick-white.svg"
                                 class="lesson-item-icon"/>
                            <p class="lesson-item-text"><?= Yii::t('front', 'Title'); ?></p>
                        </li>
                        <li class="lesson-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/tick-white.svg"
                                 class="lesson-item-icon"/>
                            <p class="lesson-item-text"><?= Yii::t('front', 'Text'); ?></p>
                        </li>
                        <li class="lesson-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/tick-white.svg"
                                 class="lesson-item-icon"/>
                            <p class="lesson-item-text"><?= Yii::t('front', 'Button'); ?></p>
                        </li>
                        <li class="lesson-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/tick-white.svg"
                                 class="lesson-item-icon"/>
                            <p class="lesson-item-text"><?= Yii::t('front', 'Description of a link in a news feed'); ?></p>
                        </li>
                        <li class="lesson-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/tick-white.svg"
                                 class="lesson-item-icon"/>
                            <p class="lesson-item-text"><?= Yii::t('front', 'Link for showing an ad'); ?></p>
                        </li>
                    </ul>

                    <p class="lesson-text--border--white"><?= Yii::t('front', 'Facebook collaborates with Shutterstock, so you have
                        high-quality paid images which you can use for free. To use them, click on "free stock".'); ?></p>
                    <p class="lesson-text--white"><?= Yii::t('front', 'An image must comply with Facebook advertising rules. You can find
                        them on official website.'); ?></p>

                    <img src="/modules/admin/cabinet_assets/pictures/img/target-ad-fb-screen-12-<?=$lng;?>.png"
                         class="target-gb-screen"/>

                    <p class="lesson-text--white"><?= Yii::t('front', 'Write text for title and description. It\' a very important element
                    ...
                    <p class="lesson-text--white"><?= Yii::t('front', 'On the right in "ads preview" window you can see how your ad will
                ...
                <div class="lesson__block">
                    ...
                    <p class="lesson-block-text"><?= Yii::t('front', 'Choose a payment method'); ?></p>
                    <span class="lesson-block-num">11</span>

                </div>

                <p class="lesson-text--border"><?= Yii::t('front', 'If this is your first advertising campaign, then Facebook will ask you
                    to choose how you\'ll pay for advertising.'); ?></p>
                <p class="lesson-text"><?= Yii::t('front', 'Choose payment method, enter required data and click "Next" button. After
                    launching an ads campaign it will be moderated from 15 minutes to 4 hours. But usually it goes
                    quickly.'); ?></p>
                <p class="lesson-text"><?= Yii::t('front', 'Congratulations! You just launched your first targeted ad on Facebook!'); ?></p>

                <footer class="lesson-footer">

                    <p class="lesson-footer-text"><?= Yii::t('front', 'In a private Facebook promotion course (you need to promote status
            ...
            <h1 class="school-accordion-caption"><?= Yii::t('front', 'Promotion on YouTube. Running your channel'); ?></h1>
            <div class="school-accordion__container">

                <div class="lesson-header">

                    <h2 class="lesson-header-caption"><?= Yii::t('front', 'Promotion on YouTube. Running your channel'); ?></h2>
                    <img src="/modules/admin/cabinet_assets/pictures/svg/drows/panda-vloger.svg"
                         class="lesson-header-img lesson-header-img--320" alt=""/>

                </div>

                <p class="lesson-text"><?= Yii::t('front', 'I doubt that there exist a person in the world who has never seen at least one
                    video on YouTube in his entire life. But how to use this service to promote your project, not just
                    for entertainment?'); ?></p>
                <p class="lesson-text--border"><?= Yii::t('front', 'In this DVC lesson you\'ll learn what you need to think about if you
                ...
                <div class="lesson__block">
                    ...
                    <div class="lesson-block__container">
                        ...
                        <h2 class="lesson-block-container-text--bold"><?= Yii::t('front', 'Why I need a YouTube channel?'); ?></h2>
                        <p class="lesson-block-container-text"><?= Yii::t('front', 'YouTube is the same social network as others, so you can actively use
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'If an Instagram photo lives several hours, a YouTube video won\'t go
                    anywhere. Thanks to keywords you can find it in a month and in a year.'); ?></p>

                <div class="lesson__container">

                    <h1 class="lesson-caption--white"><?= Yii::t('front', 'Choosing a concept'); ?></h1>
                    <p class="lesson-text--border--white"><?= Yii::t('front', 'Before creating a channel, answer a few important questions.
                    ...
                    <div class="lesson__block">
                        ...
                        <span class="lesson-block-num--white">1</span>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'What I need a channel for?'); ?></p>
                    ...
                    <ul class="lesson-list">
                        <li class="lesson-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/tick-white.svg"
                                 class="lesson-item-icon"/>
                            <p class="lesson-item-text--white"><?= Yii::t('front', 'increasing site traffic'); ?></p>
                        </li>
                        <li class="lesson-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/tick-white.svg"
                                 class="lesson-item-icon"/>
                            <p class="lesson-item-text--white"><?= Yii::t('front', 'increasing sales'); ?></p>
                        </li>
                        <li class="lesson-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/tick-white.svg"
                                 class="lesson-item-icon"/>
                            <p class="lesson-item-text--white"><?= Yii::t('front', 'keeping regular customers'); ?></p>
                        </li>
                        <li class="lesson-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/tick-white.svg"
                                 class="lesson-item-icon"/>
                            <p class="lesson-item-text--white"><?= Yii::t('front', 'building new customers trust'); ?></p>
                        </li>
                    </ul>

                    <p class="lesson-text--white"><?= Yii::t('front', 'We didn\'t list all goals, you can have your own which suits your
                    ...
                    <div class="lesson__block">
                        ...
                        <span class="lesson-block-num--white">2</span>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'Who a channel will be for?'); ?></p>

                    </div>

                    <p class="lesson-text--white"><?= Yii::t('front', 'Describe all characteristics of your potential customers as
                    ...
                    <ul class="lesson-list">
                        <li class="lesson-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/tick-white.svg"
                                 class="lesson-item-icon"/>
                            <p class="lesson-item-text--white"><?= Yii::t('front', 'sex and age, marital status, education'); ?></p>
                        </li>
                        <li class="lesson-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/tick-white.svg"
                                 class="lesson-item-icon"/>
                            <p class="lesson-item-text--white"><?= Yii::t('front', 'geolocation'); ?></p>
                        </li>
                        <li class="lesson-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/tick-white.svg"
                                 class="lesson-item-icon"/>
                            <p class="lesson-item-text--white"><?= Yii::t('front', 'work and income'); ?></p>
                        </li>
                        <li class="lesson-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/tick-white.svg"
                                 class="lesson-item-icon"/>
                            <p class="lesson-item-text--white"><?= Yii::t('front', 'temperament, mentality'); ?></p>
                        </li>
                        <li class="lesson-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/tick-white.svg"
                                 class="lesson-item-icon"/>
                            <p class="lesson-item-text--white"><?= Yii::t('front', 'life style'); ?></p>
                        </li>
                    </ul>
                    ...
                    <div class="lesson__block">
                        ...
                        <span class="lesson-block-num--white">3</span>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'What a channel will be about?'); ?></p>

                    </div>

                    <p class="lesson-text--border--white"><?= Yii::t('front', 'Choose main themes of your channel. If this is a channel of
                ...
                <p class="lesson-text"><?= Yii::t('front', 'Have you chosen a concept? Now let\'s move to creating a channel, it\'ll take
                    you a few minutes!'); ?></p>

                <h1 class="lesson-caption--black"><?= Yii::t('front', 'Creating a channel'); ?></h1>
                <p class="lesson-text--border"><?= Yii::t('front', 'You need a Gmail mailbox to create a business channel on YouTube. If
                ...
                <p class="lesson-text"><?= Yii::t('front', 'You have a little thing to do: set up an account. Click on your photo in the
                    top right corner and then on gear-wheel. Now you\'re in your YouTube account settings.'); ?></p>
                <p class="lesson-text--border"><?= Yii::t('front', 'When creating a channel choose a business one. It has advanced options
                ...
                <div class="lesson__container">
                    ...
                    <p class="lesson-text--border--white"><?= Yii::t('front', 'Not to violate YouTube rules, create an account under your
                    ...
                    <p class="lesson-text--white"><?= Yii::t('front', 'So, create a new channel within your personal account: click on
                ...
                <h1 class="lesson-caption--black"><?= Yii::t('front', 'Designing a channel'); ?></h1>
                <p class="lesson-text"><?= Yii::t('front', 'Now you just need to upload a cover, a photo and fill in a description field.'); ?></p>
                ...
                <div class="lesson__block">
                    ...
                    <div class="lesson__block--three">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/profile-avatar.svg"
                             class="lesson-block-icon--three"/>
                        <p class="lesson-block-text--three"><?= Yii::t('front', 'Upload a photo sized 800 × 800 pixels for a userpic.'); ?></p>
                    ...
                    <div class="lesson__block--three">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/backgroung-icon.svg"
                             class="lesson-block-icon--three"/>
                        <p class="lesson-block-text--three"><?= Yii::t('front', 'Cover or background image is displayed differently on PCs
                    ...
                    <div class="lesson__block--three">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/description-chanel-icon.svg"
                             class="lesson-block-icon--three"/>
                        <p class="lesson-block-text--three"><?= Yii::t('front', 'Write channel\'s description: it\'s limited to 1000
                            characters.'); ?></p>
                ...
                <div class="lesson__container">
                    ...
                    <p class="lesson-text--border--white"><?= Yii::t('front', 'By default section "About the channel" shows only first 250
                        ...
                        <a href="https://support.google.com/youtube/topic/16549?hl=en&ref_topic=4355169"
                           class="advanced-icon-link"><?= Yii::t('front', 'Show more'); ?></a>
                    </p>

                </div>

                <p class="lesson-text"><?= Yii::t('front', 'It\'s important to upload videos to your channel regularly. This is due to
                    several factors:'); ?></p>

                <div class="lesson__block">

                    <span class="lesson-block-num">1</span>
                    <p class="lesson-block-text"><?= Yii::t('front', 'It\'s well-known that YouTube likes when you regularly
                ...
                <div class="lesson__block">
                    ...
                    <span class="lesson-block-num">2</span>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Second factor is related to your subscribers. If you
                ...
                <footer class="lesson-footer">
                    ...
                    <p class="lesson-footer-text"><?= Yii::t('front', 'In the next DVC lessons on YouTube promotion, we\'ll talk about
            ...
            <h1 class="school-accordion-caption"><?= Yii::t('front', 'How to promote your channel on YouTube in the top 10'); ?></h1>
            <div class="school-accordion__container">

                <div class="lesson-header">

                    <h2 class="lesson-header-caption"><?= Yii::t('front', 'How to promote your channel on YouTube in the top 10'); ?></h2>
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'In the previous DVC lesson on basics of working with Youtube, we
                ...
                <p class="lesson-text"><?= Yii::t('front', 'First of all, it\'s necessary to understand principles of videos popularization
                    on Youtube.'); ?></p>

                <div class="lesson__block">

                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/rogue.svg" class="lesson-block-icon"/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Fraud won\'t work here! One of channel popularization peculiarities is the
                ...
                <div class="lesson__block">
                    ...
                    <p class="lesson-block-text"><?= Yii::t('front', 'A useful and interesting channel promotes by itself. That\'s why even if
                ...
                <div class="lesson__block">
                    ...
                    <p class="lesson-block-text"><?= Yii::t('front', 'You can\'t solve promotion issue with money. With money you can buy links,
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'So what you can do to make your channel popular and to subscribers come
                    and stay?'); ?></p>

                <div class="lesson__container">

                    <h1 class="lesson-caption--white"><?= Yii::t('front', 'We give you 10 effective tips:'); ?></h1>
                    ...
                    <div class="lesson__block">
                        ...
                        <div class="lesson-block__container">
                            ...
                            <h3 class="lesson-block-text--white--bold"><?= Yii::t('front', 'Title, description, tags'); ?></h3>
                            <p class="lesson-block-text--white--wide"><?= Yii::t('front', 'Always come up with a title, write a description for it, put tags and specify a
                    ...
                    <div class="lesson__block">
                        ...
                        <div class="lesson-block__container">
                            ...
                            <h3 class="lesson-block-text--white--bold"><?= Yii::t('front', 'Create a unique trademark'); ?></h3>
                            <p class="lesson-block-text--white--wide"><?= Yii::t('front', 'Think about what your channel\'s main page will look like, what will be the design
                    ...
                    <div class="lesson__block">
                        ...
                        <div class="lesson-block__container">
                            ...
                            <h3 class="lesson-block-text--white--bold"><?= Yii::t('front', 'Free channel advertising'); ?></h3>
                            <p class="lesson-block-text--white--wide"><?= Yii::t('front', 'Don\'t hesitate to promote your channel in every possible way. For example, mention
                    ...
                    <div class="lesson__block">
                        ...
                        <div class="lesson-block__container">
                            ...
                            <h3 class="lesson-block-text--white--bold"><?= Yii::t('front', 'Contextual advertising'); ?></h3>
                            <p class="lesson-block-text--white--wide"><?= Yii::t('front', 'This way of promoting your Youtube channel is paid, but not so expensive compared
                    ...
                    <div class="lesson__block">
                        ...
                        <div class="lesson-block__container">
                            ...
                            <h3 class="lesson-block-text--white--bold"><?= Yii::t('front', 'The more the better'); ?></h3>
                            <p class="lesson-block-text--white--wide"><?= Yii::t('front', 'If you\'re going to upload one video per month, you\'ll never be able to promote
                    ...
                    <div class="lesson__block">
                        ...
                        <div class="lesson-block__container">
                            ...
                            <h3 class="lesson-block-text--white--bold"><?= Yii::t('front', 'Ask correctly and people will listen to you'); ?></h3>
                            <p class="lesson-block-text--white--wide"><?= Yii::t('front', 'Communicate with your subscribers openly. It\'s better to directly ask for likes or
                    ...
                    <div class="lesson__block">
                        ...
                        <div class="lesson-block__container">
                            ...
                            <h3 class="lesson-block-text--white--bold"><?= Yii::t('front', 'Earn popularity on others'); ?></h3>
                            <p class="lesson-block-text--white--wide"><?= Yii::t('front', 'Look for top Youtube channels and create some video on the topic. For example,
                    ...
                    <div class="lesson__block">
                        ...
                        <div class="lesson-block__container">
                            ...
                            <h3 class="lesson-block-text--white--bold"><?= Yii::t('front', 'Make viral content'); ?></h3>
                            <p class="lesson-block-text--white--wide"><?= Yii::t('front', 'If there is at least one viral video on your channel (something that has millions
                    ...
                    <div class="lesson__block">
                        ...
                        <div class="lesson-block__container">
                            ...
                            <h3 class="lesson-block-text--white--bold"><?= Yii::t('front', 'Be friends with other bloggers'); ?></h3>
                            <p class="lesson-block-text--white--wide"><?= Yii::t('front', 'Yes, making friends with Youtube stars won\'t be easy, but if you succeed, there are
                    ...
                    <div class="lesson__block">
                        ...
                        <div class="lesson-block__container">
                            ...
                            <h3 class="lesson-block-text--white--bold"><?= Yii::t('front', 'Listen to subscribers'); ?></h3>
                            <p class="lesson-block-text--white--wide"><?= Yii::t('front', 'Be sure to read comments under your videos, respond to them and thank for
                ...
                <p class="lesson-text"><?= Yii::t('front', 'Having set a goal to get into the top, you should know that to promote a video
                    to Youtube top you need to take into account:'); ?></p>

                <div class="lesson__block">

                    <span class="lesson-block-num">1</span>
                    <p class="lesson-block-text"><?= Yii::t('front', '<b>Backlinks</b>
                ...
                <div class="lesson__block">
                    ...
                    <span class="lesson-block-num">2</span>
                    <p class="lesson-block-text"><?= Yii::t('front', '<b>Number of views</b>
                ...
                <div class="lesson__block">
                    ...
                    <span class="lesson-block-num">3</span>
                    <p class="lesson-block-text"><?= Yii::t('front', '<b>Duration of viewing</b>
                ...
                <div class="lesson__block">
                    ...
                    <span class="lesson-block-num">4</span>
                    <p class="lesson-block-text"><?= Yii::t('front', '<b>Involvement of viewer</b>
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'When creating content you should always be aware of the latest events
            ...
            <h1 class="school-accordion-caption"><?=Yii::t('front', 'Use of messengers as a instant sales channel');?></h1>
            <div class="school-accordion__container">

                <div class="lesson-header">

                    <h2 class="lesson-header-caption">
                        <?=Yii::t('front', 'Use of messengers as a instant sales channel');?>
                    </h2>
                ...
                <p class="lesson-text--border">
                    <?=Yii::t('front', 'In previous DVC lessons, we described how to promote product using sites like Facebook, Instagram and Line. This lesson is dedicated to messengers, one of the most effective channels for promoting and positioning DiaVita products.');?></p>

                <h2 class="lesson-caption--black">
                    <?=Yii::t('front', 'What are their advantages?');?></h2>

                <div class="lesson__block">

                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/fb-logo.svg" class="lesson-block-icon" />
                    <p class="lesson-block-text"><?=Yii::t('front', 'You know customer\'s mobile number. This is a more reliable and long-term contact than email, because the latter can be easily changed.');?></p>
                    <span class="lesson-block-num">1</span>
                ...
                <div class="lesson__block">
                    ...
                    <p class="lesson-block-text"><?=Yii::t('front', 'Instant push notifications. You can be sure a notification will reach a client and will be read.');?></p>
                    <span class="lesson-block-num">2</span>
                ...
                <div class="lesson__block">
                    ...
                    <p class="lesson-block-text"><?=Yii::t('front', 'Privacy and personality - unlike communicating with clients in social networks or public web-sites, messengers provide a sufficient level of privacy for personal communication.');?></p>
                    <span class="lesson-block-num">3</span>
                ...
                <div class="lesson__block">
                    ...
                    <p class="lesson-block-text"><?=Yii::t('front', 'Various content. Messengers allow you to share not only text, but also photos, videos and location. Also you can make free calls via them.');?></p>
                    <span class="lesson-block-num">4</span>
                ...
                <div class="lesson__block">
                    ...
                    <p class="lesson-block-text"><?=Yii::t('front', '24/7 support. In messengers you can communicate both in real time and with delayed messages. Communication in messenger doesn\'t imply an immediate response, but you can always stay in touch.');?></p>
                    <span class="lesson-block-num">5</span>
                ...
                <div class="lesson__block">
                    ...
                    <p class="lesson-block-text"><?=Yii::t('front', 'It\'s easy to start using messengers as well as customize them. Cost of sending information in messengers is less than via SMS and e-mail.');?></p>
                    <span class="lesson-block-num">6</span>
                ...
                <div class="lesson__container">
                    ...
                    <h2 class="lesson-caption--white"><?=Yii::t('front', 'What messenger to choose for a project?');?></h2>
                    <p class="lesson-text--white"><?=Yii::t('front', 'Before choosing messenger which is best for you, compare them by following criteria:');?></p>
                    <ul class="lesson-container-list">
                        <li class="lesson-container-item">
                            ...
                            <p class="lesson-container-item-text"><?=Yii::t('front', 'popularity among your target audience');?></p>
                        </li>
                        <li class="lesson-container-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/tick-white.svg" class="lesson-container-item-icon" />
                            <p class="lesson-container-item-text"><?=Yii::t('front', 'messenger functionality');?></p>
                        </li>
                        <li class="lesson-container-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/tick-white.svg" class="lesson-container-item-icon" />
                            <p class="lesson-container-item-text"><?=Yii::t('front', 'business project peculiarities');?></p>
                        </li>
                        <li class="lesson-container-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/tick-white.svg" class="lesson-container-item-icon" />
                            <p class="lesson-container-item-text"><?=Yii::t('front', 'possibility and convenience of using bots');?></p>
                        </li>
                    </ul>
                ...
                <div class="lesson__block">
                    ...
                    <div class="lesson-block__container">
                        ...
                        <p class="lesson-block-container-text--bold"><?=Yii::t('front', 'Line Messenger');?></p>
                        <p class="lesson-block-container-text"><?=Yii::t('front', 'In the lesson on Line we mentioned 4 essential stages for successful sale of goods in this messenger. We remind you these were: establishing a contact, identifying needs, product  presentation and working with with arguments against.');?></p>

                    </div>

                </div>

                <p class="lesson-text"><?=Yii::t('front', 'This messenger is the most popular in Thailand, here you can add friends, have a group chat and a personal page.');?></p>
                <p class="lesson-text"><?=Yii::t('front', 'Use Line if:');?></p>

                <ul class="lesson-list">
                    <li class="lesson-item">
                        <p class="lesson-item-text text-linechat"><?=Yii::t('front', 'Your audience is mostly from Thailand;');?></p>
                    </li>
                    <li class="lesson-item">
                        <p class="lesson-item-text text-linechat"><?=Yii::t('front', 'You need a system to communicate with employees;');?></p>
                    </li>
                    <li class="lesson-item">
                        <p class="lesson-item-text text-linechat"><?=Yii::t('front', 'You need a secure channel for communication (it has an option to create secret chats).');?></p>
                    </li>
                </ul>
                ...
                <div class="lesson__block">
                    ...
                    <div class="lesson-block__container">
                        ...
                        <p class="lesson-block-container-text--bold"><?=Yii::t('front', 'Facebook Messenger');?></p>
                        <p class="lesson-block-container-text"><?=Yii::t('front', 'It\' the second most popular messenger in the world and in Thailand. Its audience came close to a billion people.');?></p>

                    </div>

                </div>

                <p class="lesson-text"><?=Yii::t('front', 'Choose it if:');?></p>

                <ul class="lesson-list">
                    <li class="lesson-item">
                        <p class="lesson-item-text text-fb"><?=Yii::t('front', 'You or your company actively use Facebook;');?></p>
                    </li>
                    <li class="lesson-item">
                        <p class="lesson-item-text text-fb"><?=Yii::t('front', 'You need an alternative to contact form on the site. Messenger allows users to send messages directly to the page of your brand in Facebook;');?></p>
                    </li>
                    <li class="lesson-item">
                        <p class="lesson-item-text text-fb"><?=Yii::t('front', 'You need a convenient tool to communicate with customers and colleagues.');?></p>
                    </li>
                </ul>
                ...
                <div class="lesson__block">
                    ...
                    <div class="lesson-block__container">
                        ...
                        <p class="lesson-block-container-text--bold"><?=Yii::t('front', 'WhatsApp Messenger');?></p>
                        <p class="lesson-block-container-text"><?=Yii::t('front', 'World\'s most popular messenger. In WhatsApp you can create group chats, make video calls and share files. With WhatsApp on your PC you can synchronize chats. WhatsApp is useful if:');?></p>
                ...
                <ul class="lesson-list">
                    <li class="lesson-item">
                        <p class="lesson-item-text text-wa"><?=Yii::t('front', 'You need a channel to communicate with colleagues and clients from other countries;');?></p>
                    </li>
                    <li class="lesson-item">
                        <p class="lesson-item-text text-wa"><?=Yii::t('front', 'You need direct communication with customers;');?></p>
                    </li>
                    <li class="lesson-item">
                        <p class="lesson-item-text text-wa"><?=Yii::t('front', 'You want WhatsApp to be a place for communication between employees in group chats.');?></p>
                    </li>
                </ul>
                ...
                <ul class="lesson-list">
                    <li class="lesson-item">
                        <p class="lesson-item-text text-skype"><?=Yii::t('front', 'Ideal online support service for website visitors;');?></p>
                    </li>
                    <li class="lesson-item">
                        <p class="lesson-item-text text-skype"><?=Yii::t('front', 'As a tool for communication with customers, partners and employees;');?></p>
                    </li>
                    <li class="lesson-item">
                        <p class="lesson-item-text text-skype"><?=Yii::t('front', 'It\'s possible to organize video-conferences. Thanks to group video-communication you can hold a meeting and a training for DiaVita partners.');?></p>
                    </li>
                </ul>

                <p class="lesson-text"><?=Yii::t('front', 'Next, we\'ll talk about three following questions:');?></p>
                ...
                <div class="lesson__container">
                    ...
                    <div class="lesson__block">
                        ...
                        <span class="lesson-block-num--white">1</span>
                        <p class="lesson-block-text--white"><?=Yii::t('front', 'How to quickly build a base using these communication channels?');?></p>

                    </div>

                    <div class="lesson__container--border--left">

                        <p class="lesson-container-text--border"><?=Yii::t('front', 'Install a widget or subscribe buttons in messengers on a site. Write a text offering to subscribe:');?></p>
                        <p class="lesson-container-text--border--small">
                            <b><?=Yii::t('front', 'Offer benefits.');?></b>
                            <?=Yii::t('front', 'Users will subscribe if you tell them what they\'ll get thanks to it: useful news (Ex.: New tastes in DiaVita® healthy food collection), promos (Ex.: Buy any 2 cocktails by December, 15 and get DiaVita® bag as a gift), discounts (Ex.: It\'s New Year soon, so we\'ll give you a 15% discount until January, 7), articles (Ex: 4 myths about MLM, a few heard about), etc. <br/>When a customer subscribes, don\'t make him wait: send him a useful message immediately.');?>
                        </p>
                        <p class="lesson-container-text--border--small">
                            <b><?=Yii::t('front', 'Warn about your intentions.');?></b>
                            <?=Yii::t('front', 'Users will be pleased if you honestly tell them what and how often you\'re going to send. If they won\'t have this information, fear of getting too many messages can push them off.');?>
                        </p>

                        <p class="lesson-container-text--border"><?=Yii::t('front', 'Inform customers. They\'ll be happy to receive messages from you in a convenient channel if you inform them about this possibility. If earlier you sent information via email, make a mailout and specify links to all messengers through which you can send messages.');?></p>
                        <p class="lesson-container-text--border"><?=Yii::t('front', 'Do remarketing. Start Facebook advertising on email and phone base. In advertising offer to start communicating via messenger or get a discount for subscribing.');?></p>

                        <p class="lesson-container-text--border"><?=Yii::t('front', 'Use contacts of those who have already written. If you\'ve already started to communicate with clients in messengers and social networks, use collected contacts to send notifications. Remember about limitations:');?></p>
                        <p class="lesson-container-text--border--small"><?=Yii::t('front', 'If a client asked you a question on Facebook, you can reply to him 24 hours after his last message only once. If you have a lot of messages in Facebook try to immediately convert them into subscribers. Other messengers don\'t have time limits for client\'s last message.');?></p>
                        <p class="lesson-container-text--border--small"><?=Yii::t('front', 'WhatsApp doesn\'t have official API, so don\'t use this messenger for notifications. If you\'ll use unofficial API, there will be many malfunctions.');?></p>
                ...
                <div class="lesson__block">
                    ...
                    <span class="lesson-block-num">2</span>
                    <p class="lesson-block-text"><?=Yii::t('front', 'What elements to use to increase users amount? What exactly to send?');?></p>
                ...
                <div class="lesson__block">
                    ...
                    <div class="lesson-block__container">
                        ...
                        <h3 class="lesson-block-container-caption"><?=Yii::t('front', 'Text');?></h3>
                        <p class="lesson-block-container-text"><?=Yii::t('front', 'Before you start writing text, think what you want to tell client and why it\'ll be useful for him.');?></p>
                        <p class="lesson-block-container-text"><?=Yii::t('front', 'Refer to a customer by name. To do so use the <name> tag in message creating interface.');?></p>
                        <p class="lesson-block-container-text"><?=Yii::t('front', 'Don\'t write a long text, it\'ll be inconvenient to read from phone. Try to fit your idea in 2-3 sentences.');?></p>
                        <p class="lesson-block-container-text"><?=Yii::t('front', 'Don\'t type all text with Caps Lock, such text is harder to read and it has an unpleasant impression. Use Caps Lock to emphasize something.');?></p>
                        <p class="lesson-block-container-text"><?=Yii::t('front', 'Unlike SMS messengers are a two-way channel, and a client can answer you. Tell them about it and get feedback.');?></p>
                ...
                <div class="lesson__block">
                    ...
                    <div class="lesson-block__container">
                        ...
                        <h3 class="lesson-block-container-caption"><?=Yii::t('front', 'Image or map');?></h3>
                        <p class="lesson-block-container-text"><?=Yii::t('front', 'Use your brand\'s colors for an image, but don\'t make it too bright as it will look hauntingly.');?></p>
                        <p class="lesson-block-container-text"><?=Yii::t('front', 'Show what you want to say: if a picture won\'t be interesting for a user, it\'s unlikely that he will read a text. Let a special offer, new product or service effect be seen on it.');?></p>
                        <p class="lesson-block-container-text"><?=Yii::t('front', 'Don\'t add small inscriptions on image, they won\'t be visible anyway.');?></p>
                        <p class="lesson-block-container-text"><?=Yii::t('front', 'Fight with desire to send a picture with photos of all products: when viewed from phone it will be small and illegible.');?></p>
                        <p class="lesson-block-container-text"><?=Yii::t('front', 'If you want to show location use a link to map, not a picture.');?></p>
                ...
                <div class="lesson__block">
                    ...
                    <div class="lesson-block__container">
                        ...
                        <h3 class="lesson-block-container-caption"><?=Yii::t('front', 'Button');?></h3>
                        <p class="lesson-block-container-text"><?=Yii::t('front', 'Button tells user what you expect from him. It\'s a synonym to target action. Write on it what you offer: "Read article", "Checkout", "View all products", etc.');?></p>
                        <p class="lesson-block-container-text"><?=Yii::t('front', 'If your task is to tell short news to a client, put it all in a notice text. Don\'t send texts like "Your order status has been changed" with "View status" button which leads to the site.');?></p>
                        <p class="lesson-block-container-text"><?=Yii::t('front', 'Insert a UTM code in link so that clickthroughs will be displayed in analytics system.');?></p>
                        <p class="lesson-block-container-text"><?=Yii::t('front', 'Send a client to a landing page, don\'t force him to search a necessary web-site section by himself.');?></p>

                    </div>

                </div>

                <div class="lesson-block__texts">

                    <h3 class="lesson-block-container-caption"><?=Yii::t('front', 'Other elements');?></h3>
                    <p class="lesson-block-container-text"><?=Yii::t('front', 'You can attach file, audio or video to a message. Be careful with these formats: they take time to load. If you want to send a PDF presentation or a video with updates announcement, it\'s better to upload them on a disc or in a group and send a link.');?></p>
                ...
                <div class="lesson__container">
                    ...
                    <div class="lesson__block">
                        ...
                        <span class="lesson-block-num--white">3</span>
                        <p class="lesson-block-text--white"><?=Yii::t('front', 'In which cases to use messengers notifications?');?></p>

                    </div>

                    <p class="lesson-text--white"><?=Yii::t('front', 'Several cases when notifications are used in messengers:');?></p>

                    <ul class="lesson-list">
                        <li class="lesson-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/circle-white.svg" class="lesson-item-icon">
                            <p class="lesson-item-text--white"><?=Yii::t('front', 'Promos, discounts, promo codes');?></p>
                        </li>
                        <li class="lesson-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/circle-white.svg" class="lesson-item-icon">
                            <p class="lesson-item-text--white"><?=Yii::t('front', 'News and system updates');?></p>
                        </li>
                        <li class="lesson-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/circle-white.svg" class="lesson-item-icon">
                            <p class="lesson-item-text--white"><?=Yii::t('front', 'Events invitations');?></p>
                        </li>
                        <li class="lesson-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/circle-white.svg" class="lesson-item-icon">
                            <p class="lesson-item-text--white"><?=Yii::t('front', 'Carrying out competitions');?></p>
                        </li>
                        <li class="lesson-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/circle-white.svg" class="lesson-item-icon">
                            <p class="lesson-item-text--white"><?=Yii::t('front', 'Sending tickets, data to log in');?></p>
                        </li>
                        <li class="lesson-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/circle-white.svg" class="lesson-item-icon">
                            <p class="lesson-item-text--white"><?=Yii::t('front', 'Notifications about order status (requires CRM integration)');?></p>
                        </li>
                        <li class="lesson-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/circle-white.svg" class="lesson-item-icon">
                            <p class="lesson-item-text--white"><?=Yii::t('front', 'System notifications, for example, about account funds absence');?></p>
                        </li>
                        <li class="lesson-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/circle-white.svg" class="lesson-item-icon">
                            <p class="lesson-item-text--white"><?=Yii::t('front', 'Offer to renew subscription');?></p>
                        </li>
                        <li class="lesson-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/circle-white.svg" class="lesson-item-icon">
                            <p class="lesson-item-text--white"><?=Yii::t('front', 'Reminders about forgotten carts');?></p>
                        </li>
                        <li class="lesson-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/circle-white.svg" class="lesson-item-icon">
                            <p class="lesson-item-text--white"><?=Yii::t('front', 'Polls with multiple answers');?></p>
                        </li>
                        <li class="lesson-item">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/circle-white.svg" class="lesson-item-icon">
                            <p class="lesson-item-text--white"><?=Yii::t('front', 'Requests to evaluate quality of goods, services or support');?></p>
                        </li>
                    </ul>
                ...
                <footer class="lesson-footer">
                    ...
                    <p class="lesson-footer-text"><?=Yii::t('front', 'If used properly, all messengers listed above will not only be your assistants in optimizing work, but also channels of direct sales and attracting new partners to DiaVita Club. Don\'t forget to leave your contacts in websites, social networks pages and on business cards in messengers.');?></p>
        ...
        <h1 class="school-accordion-caption-empty"><?= Yii::t('front', 'Private course of promotion in Instagram'); ?></h1>

        <h1 class="school-accordion-caption-empty"><?= Yii::t('front', 'Private course of promotion on Facebook'); ?></h1>

        <h1 class="school-accordion-caption-empty"><?= Yii::t('front', 'Cheap targeted advertising on Facebook. Loyal customer flow'); ?></h1>

        <h1 class="school-accordion-caption-empty"><?= Yii::t('front', 'Closed sources. Definitive guide'); ?></h1>

        <h1 class="school-accordion-caption-empty"><?= Yii::t('front', 'Residual income with the help of Facebook and Instagram'); ?></h1>
    ...
    <div id="offline-promotion" class="school__body offline-promotion hide hide-mob">
        ...
        <div class="school-accordion">
            ...
            <h1 class="school-accordion-caption"><?= Yii::t('front', 'Fundamental principles of offline promotion'); ?></h1>
            <div class="school-accordion__container">

                <div class="lesson-header">

                    <h2 class="lesson-header-caption"><?= Yii::t('front', 'Fundamental principles of offline promotion'); ?></h2>
                    <img src="/modules/admin/cabinet_assets/pictures/svg/drows/salesPromo.svg"
                         class="lesson-header-img--big" alt=""/>

                </div>

                <p class="lesson-text--border"><?= Yii::t('front', 'Many of us worry when we have an important meeting, an interview. “ I\'ll
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'We prepared for you some rules and tips that will help You to sell any
                    goods and services calm and confidently, convince a person that you are right and attract him into
                    your partner network.'); ?></p>

                <div class="lesson__container">

                    <h2 class="lesson-caption--white"><?= Yii::t('front', 'Appearance'); ?></h2>
                    <p class="lesson-hint--white"><?= Yii::t('front', 'There is a rule of 150 score. 30 score for every point'); ?></p>

                    <div class="lesson__block">

                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/user.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'Appearance - the better you look, the better you are spick
                    ...
                    <div class="lesson__block">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/head-management.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'Internal state - a cheerful, confident and positive person
                    ...
                    <div class="lesson__block">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/rock.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'Status and solvency - the higher the person\'s place in the
                    ...
                    <div class="lesson__block">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/stationery.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'What you are saying. If your speech is rich with
                    ...
                    <div class="lesson__block">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/target.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'The way you speak. Easy, beautifully, funny, warmly and
                ...
                <h2 class="lesson-caption--black"><?= Yii::t('front', 'To get 150 scale is impossible. This is too ideal approach.'); ?></h2>
                <p class="lesson-text--border"><?= Yii::t('front', 'But 100 scale is good enough to close a transaction, attract partners and
                ...
                <div class="fundamental__container">
                    ...
                    <div class="fundamental-container--left">
                        ...
                        <div class="fundamental-container__content">
                            ...
                            <p class="fundamental-container-text"><?= Yii::t('front', 'Appearance. It is enough to have a well-groomed
                        ...
                        <div class="fundamental-container__content">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/box.svg"
                                 class="fundamental-container-icon" alt=""/>
                            <p class="fundamental-container-text"><?= Yii::t('front', 'Internal state. Our appearance, the quality of a
                        ...
                        <div class="fundamental-container__content">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/diamond.svg"
                                 class="fundamental-container-icon" alt=""/>
                            <p class="fundamental-container-text"><?= Yii::t('front', 'Status and solvency. Since you are at the beginning of
                        ...
                        <div class="fundamental-container__content">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/talking.svg"
                                 class="fundamental-container-icon" alt=""/>
                            <p class="fundamental-container-text"><?= Yii::t('front', 'What are you saying. Get rid of filler-words. Speak
                        ...
                        <div class="fundamental-container__content">
                            <img src=/modules/admin/cabinet_assets/pictures/svg/icons/contract.svg"
                                 class="fundamental-container-icon" alt=""/>
                            <p class="fundamental-container-text"><?= Yii::t('front', 'The way you speak. Have an eye-contact. This is a
                ...
                <h2 class="lesson-caption--black"><?= Yii::t('front', 'And here it is some important nuances before a meeting'); ?></h2>
                <p class="lesson-text--border"><?= Yii::t('front', 'Be an active and attentive listener. Smile, nod, frown when appropriate.
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'Call a person by name. This is not only a sign of respect and
                ...
                <footer class="lesson-footer">
                    <p class="lesson-footer-text"><?= Yii::t('front', 'In the following lessons, we will analyze in more detail the ability
            ...
            <h1 class="school-accordion-caption"><?= Yii::t('front', 'How to reach an agreement about cooperation'); ?></h1>
            <div class="school-accordion__container">

                <div class="lesson-header">

                    <h2 class="lesson-header-caption"><?= Yii::t('front', 'How to reach an agreement about cooperation'); ?></h2>
                    <img src=/modules/admin/cabinet_assets/pictures/svg/drows/cooperation.svg"
                         class="lesson-header-img--big" alt=""/>

                </div>

                <p class="lesson-text--border"><?= Yii::t('front', 'In order a person to become convinced that he need to cooperate with you
                ...
                <div class="lesson__block">
                    ...
                    <div class="lesson__block--three">
                        ...
                        <p class="lesson-block-text--three"><?= Yii::t('front', 'Untenable arguments'); ?></p>
                        <br>
                    ...
                    <div class="lesson__block--three">
                        ...
                        <img src=/modules/admin/cabinet_assets/pictures/svg/icons/puzzle2.svg"
                             class="lesson-block-icon--three" alt=""/>
                        <p class="lesson-block-text--three"><?= Yii::t('front', 'Weak arguments'); ?></p>
                    ...
                    <div class="lesson__block--three">
                        ...
                        <img src=/modules/admin/cabinet_assets/pictures/svg/icons/puzzle4.svg"
                             class="lesson-block-icon--three" alt=""/>
                        <p class="lesson-block-text--three"><?= Yii::t('front', 'Strong arguments'); ?></p>

                    </div>

                </div>

                <p class="lesson-text--border"><?= Yii::t('front', 'Arguments differ in a degree of impact on a mind and feelings of people:
                ...
                <div class="coop__container">
                    ...
                    <div class="coop__container-graphic">
                        ...
                        <div class="coop-container-graphic__texts">
                            ...
                            <p class="coop-container-graphic-text graphic-text--left"><?= Yii::t('front', 'Untenable arguments'); ?></p>
                            <p class="coop-container-graphic-text graphic-text--middle"><?= Yii::t('front', 'Weak arguments'); ?></p>
                            <p class="coop-container-graphic-text graphic-text--right"><?= Yii::t('front', 'Strong arguments'); ?></p>
                ...
                <h2 class="lesson-caption--black"><?= Yii::t('front', 'Strong arguments'); ?></h2>

                <div class="lesson__block">

                    <img src=/modules/admin/cabinet_assets/pictures/svg/icons/200-billion-en.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Arguments differ in a degree of impact on a mind and feelings of people:
                    strong, weak and untenable. Rebuttals (counter arguments) have the same gradation.'); ?></p>
                ...
                <div class="lesson__block">
                    <img src=/modules/admin/cabinet_assets/pictures/svg/icons/shield.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'World\'s richest market is the MLM market. The annual
                ...
                <div class="lesson__block">
                    <img src=/modules/admin/cabinet_assets/pictures/svg/icons/flasks.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Laws, charters, guidelines, if they are executed and
                ...
                <div class="lesson__block">
                    <img src=/modules/admin/cabinet_assets/pictures/svg/icons/medal.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Experimentally verified conclusions. Give examples of
                ...
                <div class="lesson__block">
                    <img src=/modules/admin/cabinet_assets/pictures/svg/icons/book.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Expert\'s opinion. There is a popular video of a world
                ...
                <div class="lesson__block">
                    <img src=/modules/admin/cabinet_assets/pictures/svg/icons/camera.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Eyewitness testimonies and witnesses of events. As an
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'Statistic information if data collection, processing and
                        analysis made by a professional statistician.'); ?></p>

                <div class="lesson__container">

                    <h2 class="lesson-caption--white"><?= Yii::t('front', 'Weak arguments'); ?></h2>
                    ...
                    <div class="argument__container">
                        ...
                        <p class="argument-container-text"><?= Yii::t('front', 'Inferences based on two or more separate facts, the
                            relationship between which is unclear without the third.'); ?></p>

                        <p class="argument-container-text"><?= Yii::t('front', 'Tricks and judgments built on alogisms (alogism is a
                        ...
                        <p class="argument-container-text"><?= Yii::t('front', 'References (quotes) to authorities, unknown or little-known
                            to your listeners.'); ?></p>

                        <p class="argument-container-text"><?= Yii::t('front', 'Analogies and non-indicative examples.'); ?></p>

                        <p class="argument-container-text"><?= Yii::t('front', 'Arguments of a private nature, coming out of circumstances or
                            dictated by motivation, desire.'); ?></p>

                        <p class="argument-container-text"><?= Yii::t('front', 'Biased retreats, aphorisms, sayings.'); ?></p>

                        <p class="argument-container-text"><?= Yii::t('front', 'Arguments, versions or generalizations, made on the basis of
                            conjectures, assumptions, sensations.'); ?></p>

                        <p class="argument-container-text--border"><?= Yii::t('front', 'Conclusions based on incomplete statistics.'); ?></p>

                    </div>

                </div>

                <p class="lesson-text--border"><?= Yii::t('front', 'They raise doubts of your opponents, clients, employees'); ?></p>


                <h2 class="lesson-caption--blue"><?= Yii::t('front', 'Untenable arguments'); ?></h2>

                <div class="argument__container--left">

                    <p class="lesson-text--circle"><?= Yii::t('front', 'Judgments based on fraudulent facts.'); ?></p>

                    <p class="lesson-text--circle"><?= Yii::t('front', 'References to doubtful, untested sources.'); ?></p>

                    <p class="lesson-text--circle"><?= Yii::t('front', 'Invalid decisions.'); ?></p>

                    <p class="lesson-text--circle"><?= Yii::t('front', 'Conjectures, guesses, assumptions, inventions.'); ?></p>

                    <p class="lesson-text--circle"><?= Yii::t('front', 'Arguments for prejudice, ignorance.'); ?></p>

                    <p class="lesson-text--circle"><?= Yii::t('front', 'Conclusions made from fictitious documents.'); ?></p>

                    <p class="lesson-text--circle"><?= Yii::t('front', 'Promises.'); ?></p>

                    <p class="lesson-text--circle"><?= Yii::t('front', 'False statements and evidences.'); ?></p>

                    <p class="lesson-text--circle"><?= Yii::t('front', 'Forgery and falsification of what is being said.'); ?></p>
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'They help to expose, discredit an opponent who used them.'); ?></p>
                ...
                <footer class="coop__footer">
                    ...
                    <div class="coop-footer__container">
                        ...
                        <p class="coop-footer-text"><?= Yii::t('front', 'In the course of argumentation, use only those arguments that you
                    ...
                    <div class="coop-footer__container">
                        ...
                        <img src=/modules/admin/cabinet_assets/pictures/svg/icons/handshake.svg"
                             class="coop-footer-img" alt=""/>
                        <p class="coop-footer-text"><?= Yii::t('front', 'If an argument is not accepted, find a reason for this and then do
                    ...
                    <div class="coop-footer__container">
                        ...
                        <img src=/modules/admin/cabinet_assets/pictures/svg/icons/like.svg"
                             class="coop-footer-img" alt=""/>
                        <p class="coop-footer-text"><?= Yii::t('front', 'Do not underestimate the importance of strong arguments of an enemy.
                    ...
                    <div class="coop-footer__container">
                        ...
                        <img src=/modules/admin/cabinet_assets/pictures/svg/icons/molecule.svg"
                             class="coop-footer-img" alt=""/>
                        <p class="coop-footer-text"><?= Yii::t('front', 'Say your arguments, not related to what an enemy or partner said,
                    ...
                    <div class="coop-footer__container">
                        ...
                        <img src=/modules/admin/cabinet_assets/pictures/svg/icons/panel.svg"
                             class="coop-footer-img" alt=""/>
                        <p class="coop-footer-text"><?= Yii::t('front', 'More accurately measure the pace of argumentation with the pace of a
                            partner.'); ?></p>
                    ...
                    <div class="coop-footer__container">
                        ...
                        <img src=/modules/admin/cabinet_assets/pictures/svg/icons/head-management.svg"
                             class="coop-footer-img" alt=""/>
                        <p class="coop-footer-text"><?= Yii::t('front', 'Excessive persuasiveness always provokes rebuff, as the superiority
                    ...
                    <div class="coop-footer__container">
                        ...
                        <img src=/modules/admin/cabinet_assets/pictures/svg/icons/idea.svg" class="coop-footer-img"
                             alt=""/>
                        <p class="coop-footer-text"><?= Yii::t('front', 'Give one or two bright arguments and, if a desired effect is
                    ...
                    <div class="coop-footer__container">
                        ...
                        <img src=/modules/admin/cabinet_assets/pictures/svg/icons/flag.svg"
                             class="coop-footer-img" alt=""/>
                        <p class="coop-footer-text"><?= Yii::t('front', 'Avoid weak and untenable arguments. They only harm. Use only strong
                            arguments.'); ?></p>
                    ...
                    <div class="coop-footer__container">
                        ...
                        <img src=/modules/admin/cabinet_assets/pictures/svg/icons/presentation.svg"
                             class="coop-footer-img" alt=""/>
                        <p class="coop-footer-text"><?= Yii::t('front', 'Be flexible. There is no need to argue with a man. When he says
            ...
            <h1 class="school-accordion-caption"><?= Yii::t('front', 'Create an image of a successful person'); ?></h1>
            <div class="school-accordion__container">

                <div class="lesson-header">

                    <h2 class="lesson-header-caption"><?= Yii::t('front', 'Create an image of a successful person'); ?></h2>
                    <img src=/modules/admin/cabinet_assets/pictures/svg/drows/successfull.svg"
                         class="lesson-header-img lesson-header-img--320" alt=""/>

                </div>

                <p class="lesson-text--border"><?= Yii::t('front', 'Image reveals in style, details, appearance – in everything that
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'Below we give you some tips how to create the vibrations of the success
                ...
                <div class="successful__contetn--left">
                    ...
                    <div class="successful__container">
                        ...
                        <img src=/modules/admin/cabinet_assets/pictures/svg/icons/earth.svg" class="successful-img"
                             alt=""/>
                        <p class="successful-text"><?= Yii::t('front', 'You need to correct your profiles in the social networks in
                    ...
                    <div class="successful__container">
                        ...
                        <img src=/modules/admin/cabinet_assets/pictures/svg/icons/beer.svg" class="successful-img"
                             alt=""/>
                        <p class="successful-text"><?= Yii::t('front', 'If you are planning to be engaged in politics you shouldn\'t load
                    ...
                    <div class="successful__container">
                        ...
                        <img src=/modules/admin/cabinet_assets/pictures/svg/icons/camera.svg" class="successful-img"
                             alt=""/>
                        <p class="successful-text"><?= Yii::t('front', 'Secondly, forbid anybody from tagging you on the photos without your
                ...
                <div class="successful__contetn--right">
                    ...
                    <div class="successful__container">
                        ...
                        <p class="successful-text"><?= Yii::t('front', 'You look more respectable wearing two layers of clothes. Men should
                    ...
                    <div class="successful__container">
                        ...
                        <p class="successful-text"><?= Yii::t('front', 'You should hide your tattoos and piercings if you have ones because
                    ...
                    <div class="successful__container">
                        ...
                        <p class="successful-text"><?= Yii::t('front', 'Use the right accessories. If you wear glasses, it should be a good
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'You are the arithmetical mean of your circle. This statement equally
                ...
                <p class="successful-text--border"><?= Yii::t('front', 'It takes more than a half of the year for the image that you are
                ...
                <p class="successful-text--border"><?= Yii::t('front', 'What else is important for creating the image of the successful
                ...
                <div class="successful__container">
                    ...
                    <p class="successful-text"><?= Yii::t('front', 'Work on your voice. Well trained and confident voice is a significant
                ...
                <div class="successful__container">
                    ...
                    <img src=/modules/admin/cabinet_assets/pictures/svg/icons/bell.svg"
                         class="successful-img" alt=""/>
                    <p class="successful-text"><?= Yii::t('front', 'Don\'t fuss, take your time. Let your movements and speech be calm and
                ...
                <div class="successful__container">
                    ...
                    <img src=/modules/admin/cabinet_assets/pictures/svg/icons/send-mail.svg"
                         class="successful-img" alt=""/>
                    <p class="successful-text"><?= Yii::t('front', 'Remember about the self-introduction. It\'s important to analyze your
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'All these small details create the successful vibrations, that help you
                ...
                <footer class="lesson-footer">
                    <p class="lesson-footer-text"><?= Yii::t('front', 'Taking care of the image and appearance is not the extravagance or the
            ...
            <h1 class="school-accordion-caption"><?= Yii::t('front', 'How to increase trust to yourself'); ?></h1>
            <div class="school-accordion__container">

                <div class="lesson-header">

                    <h2 class="lesson-header-caption"><?= Yii::t('front', 'How to increase trust to yourself'); ?></h2>
                    <img src=/modules/admin/cabinet_assets/pictures/svg/drows/famous.svg"
                         class="lesson-header-img lesson-header-img--320" alt=""/>

                </div>

                <p class="lesson-text--border"><?= Yii::t('front', 'When first getting into the company consumer believes your words about
                ...
                <h2 class="lesson-caption--black"><?= Yii::t('front', 'Use the power of brand and company\'s name'); ?></h2>
                ...
                <div class="lesson__block">
                    ...
                    <img src=/modules/admin/cabinet_assets/pictures/svg/icons/star.svg" class="lesson-block-icon"
                         alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Brand is one of the most powerful warranty of the quality. At the same time
                ...
                <h2 class="lesson-caption--black"><?= Yii::t('front', 'Work on the place for meetings with clients'); ?></h2>
                ...
                <div class="lesson__block">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/theatre.svg" class="lesson-block-icon"
                         alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'The impression that consumer gets coming in the office, in the salespoint or
                ...
                <h2 class="lesson-caption--black"><?= Yii::t('front', 'Share the working process and your achievements'); ?></h2>
                ...
                <div class="lesson__block">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/presentation.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'To earn the consumers\' sympathy tell them about the technologies that you are
                ...
                <h2 class="lesson-caption--black"><?= Yii::t('front', 'Provide the testing opportunity'); ?></h2>
                ...
                <div class="lesson__block">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/box.svg" class="lesson-block-icon"
                         alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Give consumers the opportunity to test your product or service before buying
                ...
                <h2 class="lesson-caption--black"><?= Yii::t('front', 'Use all the PR opportunities'); ?></h2>
                ...
                <div class="lesson__block">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/online-shop.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Undoubtedly, the more often your company\'s name being mentioned in the press
                ...
                <h2 class="lesson-caption--black"><?= Yii::t('front', 'Keep in touch with clients'); ?></h2>
                ...
                <div class="lesson__block">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/phone-24.svg" class="lesson-block-icon"
                         alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'One of the most simple and effective ways to earn the client\'s sympathy is the
                ...
                <h2 class="lesson-caption--black"><?= Yii::t('front', 'Encourage giving recommendations'); ?></h2>
                ...
                <div class="lesson__block">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/networking-2.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'How do you choose a doctor or a tutor? Right, you listen to your
                ...
                <h2 class="lesson-caption--black"><?= Yii::t('front', 'Show the result of buying and not buying your service'); ?></h2>
                ...
                <div class="lesson__block">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/hand-plant.svg" class="lesson-block-icon"
                         alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Demonstrate the clients who have already bought your service and who are
                ...
                <h2 class="lesson-caption--black"><?= Yii::t('front', 'Use stereotypes'); ?></h2>
                ...
                <div class="lesson__block">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/mustaches.svg" class="lesson-block-icon"
                         alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Usually the stereotypes in the clients\' lives refer the products and services
                ...
                <h2 class="lesson-caption--black"><?= Yii::t('front', 'Take care of the additional service'); ?></h2>
                ...
                <div class="lesson__block">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/gift.svg" class="lesson-block-icon"
                         alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'In addition to the general services you can include, for example, the hotline,
                ...
                <div class="trust-scheme__container">
                    ...
                    <h3 class="lesson-caption--white"><?= Yii::t('front', 'All these 10 methods work perfectly if you use them in
                    ...
                    <div class="lesson__block">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/pants.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'Take care of your appearance. You cannot look
                            inappropriate.'); ?></p>
                    ...
                    <div class="lesson__block">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/two.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'Ask clients the questions. Learn to listen to them and hear
                            them.'); ?></p>
                    ...
                    <div class="lesson__block">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/info.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'Don\'t hide your sight during the conversation. That\'s the sign
                            of lie.'); ?></p>
                    ...
                    <div class="lesson__block">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/gift-1.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'Offer clients the nice free staff such as a plastic bag with
                            your brand on it.'); ?></p>
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'Finally, the credibility is closely related to the gratitude. Everyone
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'Always thank people even if it seems to be unnecessary. You can increase
            ...
            <h1 class="school-accordion-caption"><?= Yii::t('front', 'Clients before a face'); ?></h1>
            <div class="school-accordion__container">

                <div class="lesson-header">

                    <h2 class="lesson-header-caption"><?= Yii::t('front', 'Clients before a face'); ?></h2>
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'Ok, you have just signed up the DiaVita Club (DVC), you\'ve learned a lot
                    of helpful information and now it\'s time to search for the first clients. Well, stop.'); ?></p>
                <p class="lesson-text--border"><?= Yii::t('front', 'Where you can find them? What should you do with them? In this DVC lesson
                    we will teach you how to find your first clients without efforts - they are just before your own
                    face! Let\'s start!'); ?></p>

                <h2 class="lesson-caption--black"><?= Yii::t('front', '1. Make a list of your acquaintances'); ?></h2>

                <div class="lesson__block">

                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/networking-2.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'This is a classic way to capture the clients. In the beginning you can
                ...
                <h2 class="lesson-caption--black"><?= Yii::t('front', '2. Acquaintances of your acquaintances'); ?></h2>

                <div class="lesson__block">

                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/networking.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'There are always people you haven\'t involved. In this case you can
                ...
                <div class="before-face-scheme__container">
                    ...
                    <h3 class="before-face-scheme-caption"><?= Yii::t('front', 'The first two variants may seem poorly effective because
                    ...
                    <div class="before-face-scheme__content">
                        ...
                        <div class="before-face-scheme__info">
                            ...
                            <p class="before-face-scheme-info-text"><?= Yii::t('front', 'Guests at the somebody\'s birthday party?'); ?></p>
                        ...
                        <div class="before-face-scheme__info">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/handshake.svg"
                                 class="before-face-scheme-info-icon" alt=""/>
                            <p class="before-face-scheme-info-text"><?= Yii::t('front', 'Colleagues or neighbors?'); ?></p>
                        ...
                        <div class="before-face-scheme__info">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/bus.svg"
                                 class="before-face-scheme-info-icon" alt=""/>
                            <p class="before-face-scheme-info-text"><?= Yii::t('front', 'Fellow travelers?'); ?></p>
                        ...
                        <div class="before-face-scheme__info">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/bag.svg"
                                 class="before-face-scheme-info-icon" alt=""/>
                            <p class="before-face-scheme-info-text"><?= Yii::t('front', 'Classmates?'); ?></p>
                        ...
                        <div class="before-face-scheme__info">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/cup-of-tea.svg"
                                 class="before-face-scheme-info-icon" alt=""/>
                            <p class="before-face-scheme-info-text"><?= Yii::t('front', 'People sitting next to you at the cafe?'); ?></p>
                        ...
                        <div class="before-face-scheme__info">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/mustaches.svg"
                                 class="before-face-scheme-info-icon" alt=""/>
                            <p class="before-face-scheme-info-text"><?= Yii::t('front', 'Your children\'s teachers, doctors?'); ?></p>
                        ...
                        <div class="before-face-scheme__info">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/searching.svg"
                                 class="before-face-scheme-info-icon" alt=""/>
                            <p class="before-face-scheme-info-text"><?= Yii::t('front', 'Contacts from your old notebook?'); ?></p>
                        ...
                        <div class="before-face-scheme__info">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/man-diagramma.svg"
                                 class="before-face-scheme-info-icon" alt=""/>
                            <p class="before-face-scheme-info-text"><?= Yii::t('front', 'Your teachers'); ?></p>
                ...
                <h2 class="lesson-caption--black"><?= Yii::t('front', '3. Social network advertising'); ?></h2>

                <div class="lesson__block">

                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/talking.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'There are lots of social networks that you can use for your business!
                ...
                <h2 class="lesson-caption--black"><?= Yii::t('front', '4. Mailout'); ?></h2>

                <div class="lesson__block">

                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/stationery.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Experience has proven that the mass mails distribution is a very
                ...
                <h2 class="lesson-caption--black"><?= Yii::t('front', '5. Landing pages'); ?></h2>

                <div class="lesson__block">

                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/laptop-and-rocket.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'The well-made landing pages can capture the enormous attention to your
                        project. Don\'t miss that opportunity!'); ?></p>

                </div>

                <h2 class="lesson-caption--black"><?= Yii::t('front', '6. Cold calls'); ?></h2>

                <div class="lesson__block">

                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/support.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Use cold calls to capture the potential clients whom you haven\'t known
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'Joining the business, you become the client of the company that you have
                ...
                <footer class="lesson-footer">
                    <p class="lesson-footer-text"><?= Yii::t('front', 'We believe that all these variants help you forget about the problem
            ...
            <h1 class="school-accordion-caption"><?= Yii::t('front', 'Customers for life'); ?></h1>
            <div class="school-accordion__container">

                <div class="lesson-header">

                    <h2 class="lesson-header-caption"><?= Yii::t('front', 'Customers for life'); ?></h2>
                    <img src="/modules/admin/cabinet_assets/pictures/svg/drows/oldFriends.svg"
                         class="lesson-header-img lesson-header-img--fix" alt=""/>

                </div>

                <p class="lesson-text--border"><?= Yii::t('front', 'In the past lesson, we told you how to find customers and sell them your
                ...
                <h2 class="lesson-caption--blue"><?= Yii::t('front', 'Keep them coming back'); ?></h2>

                <div class="lesson__block">

                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/heart.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Customers\' desires must be very important to you. Talk to them,
                ...
                <h2 class="lesson-caption--blue"><?= Yii::t('front', 'Having a system is the key'); ?></h2>

                <div class="lesson__block">

                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/networking.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Your structure must work distinctly and smoothly, just like
                ...
                <div class="customers__container-images--height">
                    ...
                    <p class="customers-container-text--light"><?= Yii::t('front', 'What do you<br/> think...'); ?></p>

                </div>

                <h2 class="lesson-caption--blue"><?= Yii::t('front', 'Don\'t just promise things – do them'); ?></h2>

                <div class="lesson__block">

                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/handshake.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Never promise the customer something you can\'t give him. For
                ...
                <h2 class="lesson-caption--blue"><?= Yii::t('front', 'If your customer asks for something, your reply should always be
                    “Yes”'); ?></h2>
                ...
                <div class="lesson__block">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/like.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'You should be not selling a product to the customer, but rather
                ...
                <h2 class="lesson-caption--blue"><?= Yii::t('front', 'Everyone makes mistakes'); ?></h2>

                <div class="lesson__block">

                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/gift.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Don\'t blame yourself or your partner if all the sudden a mistake
                ...
                <h2 class="lesson-caption--blue"><?= Yii::t('front', 'Not having any complaints is a bad thing'); ?></h2>

                <div class="lesson__block">

                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/support.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Remember, not everything can be perfect. Everyone has complaints
                ...
                <h2 class="lesson-caption--blue"><?= Yii::t('front', 'Measure everything'); ?></h2>

                <div class="lesson__block">

                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/progress.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Digits and statistics should be important to you. Measure
                ...
                <h2 class="lesson-caption--blue"><?= Yii::t('front', 'Become better'); ?></h2>

                <div class="lesson__block">

                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/searching.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'There is no limit to perfection. Find out how things are going
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'Building a relationship with a customer seems like a simple task, however
                ...
                <div class="customers__comment">
                    ...
                    <p class="customers-comment-text"><?= Yii::t('front', 'Treat people how you\'d like to be treated. This may seem obvious,
                ...
                <div class="customers__comment">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/avatarPandaGirl-2.svg"
                         class="customers-comment-img" alt=""/>
                    <p class="customers-comment-text"><?= Yii::t('front', 'Be honest. Lies about your products, raw materials, and service
                ...
                <div class="customers__comment">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/avatarPandaBoy-2.svg"
                         class="customers-comment-img" alt=""/>
                    <p class="customers-comment-text"><?= Yii::t('front', 'Remember that your customers are people, not numbers. After
                ...
                <div class="customers__comment">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/avatarPandaGirl-1.svg"
                         class="customers-comment-img" alt=""/>
                    <p class="customers-comment-text"><?= Yii::t('front', 'Follow body language. Many people don\'t say what\'s in their head.
                ...
                <div class="customers__comment">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/avatarPandaBoy-3.svg"
                         class="customers-comment-img" alt=""/>
                    <p class="customers-comment-text"><?= Yii::t('front', 'Take a sincere interest in your customer. Listen to him,
                ...
                <footer class="lesson-footer">
                    <p class="lesson-footer-text"><?= Yii::t('front', 'Working with customers is not a simple task and it has a lot of
            ...
            <h1 class="school-accordion-caption"><?= Yii::t('front', 'Making a residual income'); ?></h1>
            <div class="school-accordion__container">

                <div class="lesson-header">

                    <h2 class="lesson-header-caption"><?= Yii::t('front', 'Making a residual income'); ?></h2>
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'In this lesson we will answer the question “Where do people get passive
                ...
                <div class="lesson__container">
                    ...
                    <h2 class="lesson-caption--white"><?= Yii::t('front', 'The following are the benefits of passive income:'); ?></h2>

                    <div class="lesson__block">

                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/currency.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'In time, an unlimited amount of money can be acquired based
                    ...
                    <div class="lesson__block">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/clock-setting.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'Owners of assets generating money flows have more free time
                    ...
                    <div class="lesson__block">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/house.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'After achieving passive income, people can compile their own
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'Now let\'s investigate under what conditions you have a basis to count on
                    passive income at DiaVita.'); ?></p>


                <h2 class="lesson-caption--blue"><?= Yii::t('front', 'Your team'); ?></h2>
                <p class="lesson-text--border"><?= Yii::t('front', 'You\'ve worked vigorously with great focus for 3-4 years and created your
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'The company usually regularly pays interest to you off of revenue your
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'That\'s how huge organizations are created. Meanwhile, you can only know
                    10-20 partners from your first-second line.'); ?></p>

                <div class="lesson__container">

                    <h2 class="lesson-caption--white"><?= Yii::t('front', 'Quality products'); ?></h2>

                    <p class="lesson-text--white"><?= Yii::t('front', 'Your company\'s products usually have to be quality products.
                    ...
                    <p class="lesson-text--white"><?= Yii::t('front', 'There\'s a very simple test: are you prepared to regularly acquire
                    ...
                    <p class="lesson-text--white"><?= Yii::t('front', 'If you observe these conditions, both your partners and your
                        customers will need to regularly acquire your company\'s products, which will create product
                        revenue in your organization.'); ?></p>

                </div>

                <h2 class="lesson-caption--blue"><?= Yii::t('front', 'System'); ?></h2>
                <p class="lesson-text--border"><?= Yii::t('front', 'The whole secret\'s the system. It must be active within your team.'); ?></p>
                <p class="lesson-text--border"><?= Yii::t('front', 'This is the main condition for creating residual income, just like all
                ...
                <h2 class="lesson-caption--blue"><?= Yii::t('front', 'Off-line and on-line'); ?></h2>
                <p class="lesson-text--border"><?= Yii::t('front', 'We\'ve gradually made our way to yet another important condition in
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'If your team works only offline and doesn\'t have a path for development
                ...
                <footer class="lesson-footer">
                    <p class="lesson-footer-text"><?= Yii::t('front', 'You need to pave the way for passive income right now – the sooner you
    ...
    <div id="business-creating" class="school__body business-creating hide hide-mob">
        ...
        <h1 class="school-accordion-caption-empty"><?= Yii::t('front', 'Turn additional earnings into basic income'); ?></h1>

        <h1 class="school-accordion-caption-empty"><?= Yii::t('front', 'A quick way to make a team'); ?></h1>

        <h1 class="school-accordion-caption-empty"><?= Yii::t('front', 'Structure that grows by itself'); ?></h1>

        <h1 class="school-accordion-caption-empty"><?= Yii::t('front', 'How quickly to become a brand, which everyone will look up to'); ?></h1>

        <h1 class="school-accordion-caption-empty"><?= Yii::t('front', 'Secret ways of super popularity'); ?></h1>

        <h1 class="school-accordion-caption-empty"><?= Yii::t('front', 'Passive growth of a structure without your participation'); ?></h1>
    ...
    <div id="increase-in-sales" class="school__body increase-in-sales hide hide-mob">
        ...
        <div class="school-accordion">
            ...
            <h1 class="school-accordion-caption"><?= Yii::t('front', 'Increase the number of sales with a promo'); ?></h1>
            <div class="school-accordion__container">

                <div class="lesson-header">

                    <h2 class="lesson-header-caption"><?= Yii::t('front', 'Increase the number of sales with a promo'); ?></h2>
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/sales.svg"
                         class="lesson-header-img--big" alt=""/>

                </div>

                <p class="lesson-text--border"><?= Yii::t('front', 'Say who do not like bright and memorable articles and posts in social
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'It would be naive to believe that your audience buys only because it is
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'In this lesson we will tell you some rules that will allow you to create
                ...
                <div class="lesson__block">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/target-1.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Any images should be not just of high quality or unique - their
                ...
                <div class="lesson__block">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/shearch-1.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Do not be lazy to study search results of pictures in the search for
                ...
                <div class="lesson__block">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/clown.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Nobody forbids to use images from photobank, but they are better to
                ...
                <div class="lesson__block">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/camera.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'It\'s always better to make your own photos - they will be unique,
                ...
                <div class="lesson__block">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/two.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'If you use photos of people who recommend your product, it would be
                ...
                <div class="lesson__block">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/check-symbol.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Attract customers to do photos with your product, leave sell -
                ...
                <div class="lesson__block">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/hand-plant.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Good and effective approach - the use of schemes “before and after”
                ...
                <div class="lesson__block">
                    ...
                    <p class="lesson-block-text"><?= Yii::t('front', 'Pay attention to a colour composition of your promo. Colors should be
                ...
                <div class="lesson__block">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/table.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Pay special attention to the psychology of color. For example, black
                ...
                <div class="lesson__block">
                    ...
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/stars.svg"
                         class="lesson-block-icon" alt=""/>
                    <p class="lesson-block-text"><?= Yii::t('front', 'Try to bring out potential client\'s emotions with a promo. Shocking
                        promo always works better. The better promo is remembered, the better it sells.'); ?></p>

                </div>

                <p class="lesson-text--border"><?= Yii::t('front', 'But if you want more, then before you post a promo, answer the main
                    question: "Why will my goods be bought?"'); ?></p>
                <p class="lesson-text--border"><?= Yii::t('front', 'It\'s not enough to have just a picture, you need to think over a
            ...
            <h1 class="school-accordion-caption"><?= Yii::t('front', 'Combating contradictions'); ?></h1>
            <div class="school-accordion__container">

                <div class="lesson-header">

                    <h2 class="lesson-header-caption"><?= Yii::t('front', 'Combating contradictions'); ?></h2>
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/choosing.svg"
                         class="lesson-header-img--big lesson-header-img--fix" alt=""/>

                </div>

                <p class="lesson-text--border"><?= Yii::t('front', 'In the process of making sales, you will often face objections from a
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'Every of us strive to optimize own sales and for this you need to know
                ...
                <div class="contradictions__container">
                    ...
                    <div class="contradictions__block">
                        ...
                        <p class="contradictions-block-text"><?= Yii::t('front', 'Objection associated with goods'); ?></p>
                    ...
                    <div class="contradictions__block">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/support.svg"
                             class="contradictions-block-img" alt=""/>
                        <p class="contradictions-block-text"><?= Yii::t('front', 'Objection associated with a seller'); ?></p>
                    ...
                    <div class="contradictions__block">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/house.svg"
                             class="contradictions-block-img" alt=""/>
                        <p class="contradictions-block-text"><?= Yii::t('front', 'Objection associated with a company'); ?></p>
                    ...
                    <div class="contradictions__block">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/online-shop.svg"
                             class="contradictions-block-img" alt=""/>
                        <p class="contradictions-block-text"><?= Yii::t('front', 'Objection associated with a service'); ?></p>
                    ...
                    <div class="contradictions__block">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/currency.svg"
                             class="contradictions-block-img" alt=""/>
                        <p class="contradictions-block-text"><?= Yii::t('front', 'Objection associated with price'); ?></p>
                    ...
                    <div class="contradictions__block">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/handshake.svg"
                             class="contradictions-block-img" alt=""/>
                        <p class="contradictions-block-text"><?= Yii::t('front', 'Indecisiveness in decision-making'); ?></p>

                    </div>

                </div>

                <h2 class="lesson-caption--blue"><?= Yii::t('front', 'To deal with objections of any type there is a common algorithm'); ?></h2>

                <div class="contradictions__infographic">

                    <p class="contradictions-infographic-text-one"><?= Yii::t('front', 'Listen carefully to a buyer'); ?></p>
                ...
                <div class="contradictions__infographic">
                    ...
                    <p class="contradictions-infographic-text-two"><?= Yii::t('front', 'Recognize a buyer\'s point of view'); ?></p>
                ...
                <div class="contradictions__infographic">
                    ...
                    <p class="contradictions-infographic-text-two"><?= Yii::t('front', 'Choose the technique of dealing with an objection'); ?></p>
                ...
                <div class="contradictions__infographic">
                    ...
                    <p class="contradictions-infographic-text-one"><?= Yii::t('front', 'Answer the objection'); ?></p>
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/target.svg"
                         class="contradictions-infographic-icon" alt=""/>
                ...
                <div class="contradictions__infographic">
                    ...
                    <p class="contradictions-infographic-text-one"><?= Yii::t('front', 'Try to make a sale'); ?></p>
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'Everything is extremely simple: you only need to earn credit of trust
                ...
                <div class="contradictions__dialog">
                    ...
                    <h2 class="lesson-caption--blue"><?= Yii::t('front', 'Yes, but ...'); ?></h2>
                    <h3 class="lesson-caption--gray"><?= Yii::t('front', 'Technique number 1'); ?></h3>
                    <p class="lesson-text--border"><?= Yii::t('front', 'Agree with an objection of an interlocutor, but add a weighty
                ...
                <div class="contradictions__dialog">
                    ...
                    <h2 class="lesson-caption--blue"><?= Yii::t('front', 'That is why…'); ?></h2>
                    <h3 class="lesson-caption--gray"><?= Yii::t('front', 'Technique number 2'); ?></h3>
                    <p class="lesson-text--border"><?= Yii::t('front', 'Contest objections of an interlocutor, explaining them with your
                        positive motives.'); ?></p>
                ...
                <div class="contradictions__dialog">
                    ...
                    <h2 class="lesson-caption--blue"><?= Yii::t('front', 'Ask a Question'); ?></h2>
                    <h3 class="lesson-caption--gray"><?= Yii::t('front', 'Technique number 3'); ?></h3>
                ...
                <div class="contradictions__dialog">
                    ...
                    <h2 class="lesson-caption--blue"><?= Yii::t('front', 'Let\'s compare'); ?></h2>
                    <h3 class="lesson-caption--gray"><?= Yii::t('front', 'Technique number 4'); ?></h3>
                    <p class="lesson-text--border"><?= Yii::t('front', 'The method is very well suited to the objection of "Expensive". The
                ...
                <div class="contradictions__dialog">
                    ...
                    <h2 class="lesson-caption--blue"><?= Yii::t('front', 'Division'); ?></h2>
                    <h3 class="lesson-caption--gray"><?= Yii::t('front', 'Technique number 5'); ?></h3>
                    <p class="lesson-text--border"><?= Yii::t('front', 'A good method when you need to prove that a more expensive product is
                ...
                <div class="contradictions__dialog">
                    ...
                    <h2 class="lesson-caption--blue"><?= Yii::t('front', 'Reduction ad absurdum'); ?></h2>
                    <h3 class="lesson-caption--gray"><?= Yii::t('front', 'Technique number 6'); ?></h3>
                    <p class="lesson-text--border"><?= Yii::t('front', 'You take a client\'s objection and confront it with a stronger
                ...
                <div class="contradictions__dialog">
                    ...
                    <h2 class="lesson-caption--blue"><?= Yii::t('front', 'Reference to the past'); ?></h2>
                    <h3 class="lesson-caption--gray"><?= Yii::t('front', 'Technique number 7'); ?></h3>
                    <p class="lesson-text--border"><?= Yii::t('front', 'In order for this method to work, find in the past a client\'s
                ...
                <div class="contradictions__dialog">
                    ...
                    <h2 class="lesson-caption--blue"><?= Yii::t('front', 'Overstated the bar'); ?></h2>
                    <h3 class="lesson-caption--gray"><?= Yii::t('front', 'Technique number 8'); ?></h3>
                    <p class="lesson-text--border"><?= Yii::t('front', 'An overstated bar is a story about a more complex case.'); ?></p>
                ...
                <div class="contradictions__dialog">
                    ...
                    <h2 class="lesson-caption--blue"><?= Yii::t('front', 'A client can also help'); ?></h2>
                    <h3 class="lesson-caption--gray"><?= Yii::t('front', 'Technique number 9'); ?></h3>
                    <p class="lesson-text--border"><?= Yii::t('front', 'This method is a magic wand. You just find out the acceptable
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'These 9 simple techniques will help you significantly increase your
                ...
                <footer class="lesson-footer">
                    <p class="lesson-footer-text"><?= Yii::t('front', 'In further lessons of the DVC, we will tell you in detail how to
            ...
            <h1 class="school-accordion-caption"><?= Yii::t('front', 'The power of a declaration'); ?></h1>
            <div class="school-accordion__container">

                <div class="lesson-header">

                    <h2 class="lesson-header-caption"><?= Yii::t('front', 'The power of a declaration'); ?></h2>
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'Anyone would have to admit that we are constantly talking about goals. We
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'There exists a special technique called a “Declaration”. A Declaration is
                ...
                <div class="lesson__container--scheme">
                    ...
                    <h2 class="lesson-caption--white"><?= Yii::t('front', '“The declaration technique” can be broken down into four
                        basic elements:'); ?></h2>
                    ...
                    <div class="power__container">
                        ...
                        <p class="power-container-text"><?= Yii::t('front', 'The promise'); ?></p>
                    ...
                    <div class="power__container">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/three.svg"
                             class="power-container-icon" alt=""/>
                        <p class="power-container-text"><?= Yii::t('front', 'Publicity'); ?></p>
                    ...
                    <div class="power__container">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/teacher.svg"
                             class="power-container-icon" alt=""/>
                        <p class="power-container-text"><?= Yii::t('front', 'An overseer'); ?></p>
                    ...
                    <div class="power__container">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/coin.svg"
                             class="power-container-icon" alt=""/>
                        <p class="power-container-text"><?= Yii::t('front', 'Value in what you say'); ?></p>

                    </div>

                </div>

                <h2 class="lesson-caption--blue"><?= Yii::t('front', 'The promise'); ?></h2>
                <p class="lesson-text--border"><?= Yii::t('front', 'You think of a goal that you definitely have the guts for. Don\'t waste
                ...
                <p class="lesson-text"><?= Yii::t('front', 'Take a sheet of paper and write the following word for word:'); ?></p>
                ...
                <h2 class="lesson-caption--blue"><?= Yii::t('front', 'Value your words'); ?></h2>
                <p class="lesson-text--border"><?= Yii::t('front', 'After these daring words comes a key element that the declaration will
                ...
                <p class="lesson-text--blue"><?= Yii::t('front', 'Today, I have declared that I will buy an apartment in downtown Bangkok.
                ...
                <h2 class="lesson-caption--blue"><?= Yii::t('front', 'Overseer'); ?></h2>
                <p class="lesson-text--border"><?= Yii::t('front', 'This is one of the key aspects of the model. It\'s very easy to trick
                    ...
                    said.'); ?></p>
                <p class="lesson-text"><?= Yii::t('front', 'Who should the overseer be? The answer is simple – someone significant to you.
                    This is a person who you can\'t let down. It\'s a person who\'s attitude and respect toward you is very
                    important.'); ?></p>

                <h2 class="lesson-caption--blue"><?= Yii::t('front', 'Publicity'); ?></h2>
                <p class="lesson-text--border"><?= Yii::t('front', 'You can easily get away with it if your declaration is stored in a drawer
                ...
                <p class="lesson-text"><?= Yii::t('front', 'Very few people have the guts and the gall to set big goals. But if a person does
                    this – he already deserves respect.'); ?></p>

                <footer class="lesson-footer">
                    <p class="lesson-footer-text"><?= Yii::t('front', 'A declaration is quite an exotic and stressful method for achieving a
            ...
            <h1 class="school-accordion-caption"><?= Yii::t('front', 'The image that is imitated'); ?></h1>
            <div class="school-accordion__container">

                <div class="lesson-header">

                    <h2 class="lesson-header-caption"><?= Yii::t('front', 'The image that is imitated'); ?></h2>
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/mirror.svg"
                         class="lesson-header-img lesson-header-img--320" alt=""/>

                </div>

                <p class="lesson-text"><?= Yii::t('front', 'In other lessons of DiaVita Club we\'ve talked a lot about the importance of
                    creating a positive, successful public image to increase your sales and attract partners.'); ?></p>
                <p class="lesson-text"><?= Yii::t('front', 'During this lesson we\'ll take a closer look at your public image components which
                    will not only allow you to be well-liked but also make them imitate your style.'); ?></p>

                <p class="lesson-text--border"><?= Yii::t('front', 'The most tangible qualities in public image are those through which effect
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'When do you want to be like a person, an idol? First, when this person lives
                ...
                <div class="lesson__container">
                    ...
                    <h2 class="lesson-caption--white"><?= Yii::t('front', 'Personal growth'); ?></h2>
                    ...
                    <p class="lesson-text--white"><?= Yii::t('front', 'You surely have your own role model, a person you\'d like to become.
                    ...
                    <h2 class="lesson-caption--white"><?= Yii::t('front', 'Learn self-presentation skills'); ?></h2>
                    ...
                    <p class="lesson-text--white"><?= Yii::t('front', 'Developing qualities worthy of imitation is half the battle. To get
                    ...
                    <div class="lesson__block">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/dialog.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'First, express your affection for other people. Forget about
                    ...
                    <div class="lesson__block">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/group-trio.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'Secondly, look for similarities. People look up to those who are even
                    ...
                    <div class="lesson__block">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/harmony.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'Thirdly, do not forget about modesty. A person rich in his inner world
                    ...
                    <h2 class="lesson-caption--white"><?= Yii::t('front', 'Competence and status strength'); ?></h2>
                    ...
                    <p class="lesson-text--border--white"><?= Yii::t('front', 'In order for people following you and wanting to be like you show
                    ...
                    <p class="lesson-text--white"><?= Yii::t('front', 'As for power of authority, any person wants to touch the heights of
                    ...
                    <div class="lesson__block">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/growup-man.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'Show fasces of status and power. However, be careful and don\'t confuse
                    ...
                    <div class="lesson__block">
                        ...
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/four-hands.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-block-text--white"><?= Yii::t('front', 'Unite yourself with people who have high status and power. "Tell me
                    ...
                    <h2 class="lesson-caption--white"><?= Yii::t('front', 'Stay true to your public image until the end'); ?></h2>
                    ...
                    <p class="lesson-text--white"><?= Yii::t('front', 'If you create a public image people look up to you don\'t have the
                ...
                <footer class="income__footer">
                    ...
                    <p class="income-footer-text"><?= Yii::t('front', 'I wish you success in personal development!'); ?></p>
        ...
        <h1 class="school-accordion-caption-empty"><?= Yii::t('front', 'The passive-growing audience of your communities'); ?></h1>

        <h1 class="school-accordion-caption-empty"><?= Yii::t('front', 'A complete guide of increasing sales by 200%'); ?></h1>
    ...
    <div id="negotiation" class="school__body negotiation hide hide-mob">
        ...
        <div class="school-accordion">
            ...
            <h1 class="school-accordion-caption"><?= Yii::t('front', 'The rule of 3 “Yes”'); ?></h1>
            <div class="school-accordion__container">

                <div class="lesson-header">

                    <h2 class="lesson-header-caption"><?= Yii::t('front', 'The rule of 3 “Yes”'); ?></h2>
                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/3yes.svg"
                         class="lesson-header-img" alt=""/>

                </div>

                <p class="lesson-text--border"><?= Yii::t('front', 'During the process of negotiations many people ask a question that seems
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'Such certain rules do not exist, but there are many effective techniques
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'One of such rules is the rule of 3 “yes”. It gives you more chances to
                ...
                <p class="lesson-hint"><?= Yii::t('front', 'This rule is used with success even by ordinary people. For example, children
                ...
                <div class="yes__dialog">
                    ...
                    <ul class="yes-dialog-list">
                        <li class="yes-dialog-item-first">
                            ...
                            <p class="yes-dialog-first"><?= Yii::t('front', 'Mummy, do you love me?'); ?></p>
                        </li>
                        <li class="yes-dialog-item-second">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/dashdark.svg"
                                 class="yes-dialog-icon" alt=""/>
                            <p class="yes-dialog-second"><?= Yii::t('front', 'Yes'); ?></p>
                        </li>
                        <li class="yes-dialog-item-first">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/dash.svg"
                                 class="yes-dialog-icon" alt=""/>
                            <p class="yes-dialog-first"><?= Yii::t('front', 'Mummy? did I behave good today?'); ?></p>
                        </li>
                        <li class="yes-dialog-item-second">
                        ...
                        <li class="yes-dialog-item-first">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/dash.svg"
                                 class="yes-dialog-icon" alt=""/>
                            <p class="yes-dialog-first"><?= Yii::t('front', 'Mummy, will you buy me this toy car?'); ?></p>
                        </li>
                    </ul>

                </div>

                <p class="lesson-hint"><?= Yii::t('front', 'What do you think the answer in 99% of cases is?'); ?></p>


                <div class="lesson__container">

                    <p class="lesson-text--white"><?= Yii::t('front', 'This method is interesting and because of the fact that there is
                ...
                <p class="lesson-hint"><?= Yii::t('front', 'Let\'s consider a simple example: you found a potential buyer and now you need to
                ...
                <div class="yes__dialog">
                    ...
                    <ul class="yes-dialog-list">
                        <li class="yes-dialog-item-first">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/dash.svg"
                                 class="yes-dialog-icon" alt=""/>
                            <p class="yes-dialog-first"><?= Yii::t('front', 'So, you want to lose weight for a long time?'); ?></p>
                        </li>
                        <li class="yes-dialog-item-second">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/dashdark.svg"
                                 class="yes-dialog-icon" alt=""/>
                        ...
                        <li class="yes-dialog-item-first">
                            <img src="/modules/modules/admin/cabinet_assets/pictures/svg/dash.svg"
                                 class="yes-dialog-icon" alt=""/>
                            <p class="yes-dialog-first"><?= Yii::t('front', 'You said you haven\'t time to eat right?'); ?></p>
                        </li>
                        <li class="yes-dialog-item-second">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/dashdark.svg"
                                 class="yes-dialog-icon" alt=""/>
                        ...
                        <li class="yes-dialog-item-first">
                            <img src="/modules/admin/cabinet_assets/pictures/svg/dash.svg"
                                 class="yes-dialog-icon" alt=""/>
                            <p class="yes-dialog-first"><?= Yii::t('front', 'By the way, the cocktail Vita Energy I told you, can be made for
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'This method is very easy, but to make it work you need to follow THREE
                    MAIN PRINCIPLES:'); ?></p>
                ...
                <div class="lesson__block">
                    ...
                    <div class="lesson-block__container">
                        ...
                        <h3 class="lesson-block-text--bold"><?= Yii::t('front', 'LOGIC.'); ?></h3>
                        <p class="lesson-block-text"><?= Yii::t('front', 'Questions must belong to a topic and logically
                            bracketed'); ?></p>
                ...
                <div class="lesson__block">
                    ...
                    <div class="lesson-block__container">
                        ...
                        <h3 class="lesson-block-text--bold"><?= Yii::t('front', 'SIMPLICITY.'); ?></h3>
                        <p class="lesson-block-text"><?= Yii::t('front', 'You should not use difficult and complex
                ...
                <div class="lesson__block">
                    ...
                    <div class="lesson-block__container">
                        ...
                        <h3 class="lesson-block-text--bold"><?= Yii::t('front', 'ADEQUATENESS.'); ?></h3>
                        <p class="lesson-block-text"><?= Yii::t('front', 'Questions must be adequate your listener
                ...
                <p class="lesson-hint"><?= Yii::t('front', 'In our opinion this method has advantages and disadvantages'); ?></p>
                ...
                <div class="yes-hang__container">
                    ...
                    <div class="yes-hang yes-hang__minus">
                        ...
                        <p class="yes-hang-text"><?= Yii::t('front', 'it is necessary to think in advance a chain of questions and variants
                    ...
                    <div class="yes-hang yes-hang__plus">
                        ...
                        <div class="yes-hang__text">
                            <p class="yes-hang-text"><?= Yii::t('front', 'Allows you to inconspicuously bring an interlocutor to the solution
                                we need'); ?></p>
                        </div>
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'So if you think over the course of the conversation in advance and pay
                ...
                <footer class="lesson-footer">
                    <p class="lesson-footer-text"><?= Yii::t('front', 'This rule is only one of few that can help you develop the skill of
            ...
            <h1 class="school-accordion-caption"><?= Yii::t('front', 'Mister-charm'); ?></h1>
            <div class="school-accordion__container">

                <div class="lesson-header">

                    <h2 class="lesson-header-caption"><?= Yii::t('front', 'Mister-charm'); ?></h2>
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'Have you ever thought why some people literally “attract” people to
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'There are 3 main groups of traits, thanks to which you can increase the
                    level of personal charm. The first group includes the following natural traits:'); ?></p>

                <div class="charm__container">

                    <h2 class="lesson-caption--white"><?= Yii::t('front', 'Natural traits'); ?></h2>

                    <div class="charm-container__content">
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/three.svg"
                             class="charm-content-img" alt=""/>
                        <p class="charm-content-text--white"><?= Yii::t('front', 'Sociability (ability to easily get on with people)'); ?></p>
                    </div>

                    <div class="charm-container__content">
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/masks.svg"
                             class="charm-content-img" alt=""/>
                        <p class="charm-content-text--white"><?= Yii::t('front', 'Empathy ( ability to empathize)'); ?></p>
                    </div>

                    <div class="charm-container__content">
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/search.svg"
                             class="charm-content-img" alt=""/>
                        <p class="charm-content-text--white"><?= Yii::t('front', 'Reflexion ( ability to understand a person)'); ?></p>
                    </div>

                    <div class="charm-container__content">
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/two.svg"
                             class="charm-content-img" alt=""/>
                        <p class="charm-content-text--white"><?= Yii::t('front', 'Eloquence (the ability to impact with a word).'); ?></p>
                    </div>

                </div>

                <p class="lesson-text--border"><?= Yii::t('front', 'These traits form the basis of natural talents, designated by the
                ...
                <div class="charm__container--white">
                    ...
                    <h2 class="lesson-caption--blue"><?= Yii::t('front', 'Characteristics of a personality'); ?></h2>

                    <div class="charm-container__content">
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/libra.svg"
                             class="charm-content-img" alt=""/>
                        <p class="charm-content-text"><?= Yii::t('front', 'Moral values'); ?></p>
                    </div>

                    <div class="charm-container__content">
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/certeficate.svg"
                             class="charm-content-img" alt=""/>
                        <p class="charm-content-text"><?= Yii::t('front', 'Mental health'); ?></p>
                    </div>

                    <div class="charm-container__content-fix">
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/networking-3.svg"
                             class="charm-content-img" alt=""/>
                        <p class="charm-content-text"><?= Yii::t('front', 'Possession of communication techniques: interpersonal
                            communication, business speech, anticipation and overcoming of conflict situations.'); ?></p>
                    </div>

                </div>

                <p class="lesson-text--border"><?= Yii::t('front', 'The third group should include what is related to the life and
                ...
                <p class="lesson-text--border"><?= Yii::t('front', 'How to strengthen personal charisma? What do you need to change in
                ...
                <div class="lesson__container">
                    <div class="lesson__block">
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/user.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-text--white"><?= Yii::t('front', 'Behave naturally. Just be yourself, you do not need to chase
                    ...
                    <div class="lesson__block">
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/hand-plant.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-text--white"><?= Yii::t('front', 'Be a good listener. People are always more interested in their
                    ...
                    <div class="lesson__block">
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/rockstar.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-text--white"><?= Yii::t('front', 'Demonstrate your interest in others - this is one of the best
                    ...
                    <div class="lesson__block">
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/heart.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-text--white"><?= Yii::t('front', 'Try to understand and support an interlocutor. Let people meet
                    ...
                    <div class="lesson__block">
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/networking-1.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-text--white"><?= Yii::t('front', 'Emphasize the similarity with your interlocutor. As you know,
                    ...
                    <div class="lesson__block">
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/like.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-text--white"><?= Yii::t('front', 'Express sincere approval. Except in very rare exceptions,
                    ...
                    <div class="lesson__block">
                        <img src="/modules/admin/cabinet_assets/pictures/svg/icons/shirt.svg"
                             class="lesson-block-icon" alt=""/>
                        <p class="lesson-text--white"><?= Yii::t('front', 'Do not scrimp on compliments. Let people feel their sincerity,
            ...
            <h1 class="school-accordion-caption-empty"><?= Yii::t('front', 'Pockets full of money'); ?></h1>

            <h1 class="school-accordion-caption-empty"><?= Yii::t('front', 'How to convince a person to become BL'); ?></h1>

            <h1 class="school-accordion-caption-empty"><?= Yii::t('front', 'Conversation examples that unconditionally convince to follow
                You'); ?></h1>

            <h1 class="school-accordion-caption-empty"><?= Yii::t('front', 'Residual income. Structure of strong BL and SBL (senior business
                leader)'); ?></h1>

            <h1 class="school-accordion-caption-empty"><?= Yii::t('front', 'Word-painter. Even the most stubborn people will be faithful'); ?></h1>
