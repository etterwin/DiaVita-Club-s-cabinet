...
<div class="wrapper-school">
            ...
            <div id="online-promotion" class="school__body online-promotion hide hide-mob">
                ...
                <div class="school-accordion">
                    ...
                    <h1 class="school-accordion-caption"><?=Yii::t(category:'front', message:'Promotion on YouTube. Running your channel');?></h1>
                    <div class="school-accordion__container">

                        <div class="lesson-header">

                            <h2 class="lesson-header-caption"><?=Yii::t(category:'front', message:'Promotion on YouTube. Running your channel');?></h2>
                            <img src="/modules/admin/cabinet_assets/pictures/svg/drows/panda-vloger.svg"
                                 class="lesson-header-img lesson-header-img--320" alt="" />

                        </div>

                        <p class="lesson-text"><?=Yii::t(category:'front', message:'I doubt that there exist a person in the world who has never seen at least one
                    video on YouTube in his entire life. But how to use this service to promote your project, not just
                    for entertainment?');?></p>
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'In this DVC lesson you\'ll learn what you need to think about if you
                    decide to create a channel for your business.');?></p>
                        ...
                        <div class="lesson__block">
                            ...
                            <div class="lesson-block__container">
                                ...
                                <h2 class="lesson-block-container-text--bold"><?=Yii::t(category:'front', message:'Why I need a YouTube channel?');?></h2>
                                <p class="lesson-block-container-text"><?=Yii::t(category:'front', message:'YouTube is the same social network as others, so you can actively use
                        ...
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'If an Instagram photo lives several hours, a YouTube video won\'t go
                    anywhere. Thanks to keywords you can find it in a month and in a year.');?></p>

                        <div class="lesson__container">

                            <h1 class="lesson-caption--white"><?=Yii::t(category:'front', message:'Choosing a concept');?></h1>
                            <p class="lesson-text--border--white"><?=Yii::t(category:'front', message:'Before creating a channel, answer a few important questions.
                        ...
                        trust me!');?></p>
                            ...
                            <div class="lesson__block">
                                ...
                                <span class="lesson-block-num--white">1</span>
                                <p class="lesson-block-text--white"><?=Yii::t(category:'front', message:'What I need a channel for?');?></p>
                            ...
                            <ul class="lesson-list">
                                <li class="lesson-item">
                                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/tick-white.svg" class="lesson-item-icon" />
                                    <p class="lesson-item-text--white"><?=Yii::t(category:'front', message:'increasing site traffic');?></p>
                                </li>
                                <li class="lesson-item">
                                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/tick-white.svg" class="lesson-item-icon" />
                                    <p class="lesson-item-text--white"><?=Yii::t(category:'front', message:'increasing sales');?></p>
                                </li>
                                <li class="lesson-item">
                                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/tick-white.svg" class="lesson-item-icon" />
                                    <p class="lesson-item-text--white"><?=Yii::t(category:'front', message:'keeping regular customers');?></p>
                                </li>
                                <li class="lesson-item">
                                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/tick-white.svg" class="lesson-item-icon" />
                                    <p class="lesson-item-text--white"><?=Yii::t(category:'front', message:'building new customers trust');?></p>
                                </li>
                            </ul>

                            <p class="lesson-text--white"><?=Yii::t(category:'front', message:'We didn\'t list all goals, you can have your own which suits your
                        ...
                        only according to the main goal.');?></p>
                            ...
                            <div class="lesson__block">
                                ...
                                <span class="lesson-block-num--white">2</span>
                                <p class="lesson-block-text--white"><?=Yii::t(category:'front', message:'Who a channel will be for?');?></p>

                            </div>

                            <p class="lesson-text--white"><?=Yii::t(category:'front', message:'Describe all characteristics of your potential customers as
                        detailed as possible, here are some of them (of course, you can add what you need):');?></p>

                            <ul class="lesson-list">
                                <li class="lesson-item">
                                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/tick-white.svg" class="lesson-item-icon" />
                                    <p class="lesson-item-text--white"><?=Yii::t(category:'front', message:'sex and age, marital status, education');?></p>
                                </li>
                                <li class="lesson-item">
                                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/tick-white.svg" class="lesson-item-icon" />
                                    <p class="lesson-item-text--white"><?=Yii::t(category:'front', message:'geolocation');?></p>
                                </li>
                                <li class="lesson-item">
                                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/tick-white.svg" class="lesson-item-icon" />
                                    <p class="lesson-item-text--white"><?=Yii::t(category:'front', message:'work and income');?></p>
                                </li>
                                <li class="lesson-item">
                                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/tick-white.svg" class="lesson-item-icon" />
                                    <p class="lesson-item-text--white"><?=Yii::t(category:'front', message:'temperament, mentality');?></p>
                                </li>
                                <li class="lesson-item">
                                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/tick-white.svg" class="lesson-item-icon" />
                                    <p class="lesson-item-text--white"><?=Yii::t(category:'front', message:'life style');?></p>
                                </li>
                            </ul>
                            ...
                            <div class="lesson__block">
                                ...
                                <span class="lesson-block-num--white">3</span>
                                <p class="lesson-block-text--white"><?=Yii::t(category:'front', message:'What a channel will be about?');?></p>

                            </div>

                            <p class="lesson-text--border--white"><?=Yii::t(category:'front', message:'Choose main themes of your channel. If this is a channel of
                        ...
                        <p class="lesson-text"><?=Yii::t(category:'front', message:'Have you chosen a concept? Now let\'s move to creating a channel, it\'ll take
                    you a few minutes!');?></p>

                        <h1 class="lesson-caption--black"><?=Yii::t(category:'front', message:'Creating a channel');?></h1>
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'You need a Gmail mailbox to create a business channel on YouTube. If
                    ...
                    \"Google Apps\" icon in the upper right corner. Select YouTube in the apps list.');?></p>
                        ...
                        <p class="lesson-text"><?=Yii::t(category:'front', message:'You have a little thing to do: set up an account. Click on your photo in the
                    top right corner and then on gear-wheel. Now you\'re in your YouTube account settings.');?></p>
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'When creating a channel choose a business one. It has advanced options
                    ...
                    channel.');?></p>
                        ...
                        <div class="lesson__container">
                            ...
                            <p class="lesson-text--border--white"><?=Yii::t(category:'front', message:'Not to violate YouTube rules, create an account under your
                        ...
                        several business channels, it\'s better to register them from different accounts.');?></p>
                            <p class="lesson-text--white"><?=Yii::t(category:'front', message:'So, create a new channel within your personal account: click on
                        ...
                        <h1 class="lesson-caption--black"><?=Yii::t(category:'front', message:'Designing a channel');?></h1>
                        <p class="lesson-text"><?=Yii::t(category:'front', message:'Now you just need to upload a cover, a photo and fill in a description field.');?></p>
                        ...
                        <div class="lesson__block">
                            ...
                            <div class="lesson__block--three">
                                ...
                                <p class="lesson-block-text--three"><?=Yii::t(category:'front', message:'Upload a photo sized 800 × 800 pixels for a userpic.');?></p>
                            ...
                            <div class="lesson__block--three">
                                ...
                                <p class="lesson-block-text--three"><?=Yii::t(category:'front', message:'Cover or background image is displayed differently on PCs
                            ...
                            <div class="lesson__block--three">
                                ...
                                <p class="lesson-block-text--three"><?=Yii::t(category:'front', message:'Write channel\'s description: it\'s limited to 1000
                            characters.');?></p>
                        ...
                        <div class="lesson__container">
                            ...
                            <p class="lesson-text--border--white"><?=Yii::t(category:'front', message:'By default section \"About the channel\" shows only first 250
                        ...
                        <p class="lesson-text"><?=Yii::t(category:'front', message:'It\'s important to upload videos to your channel regularly. This is due to
                    several factors:');?></p>

                        <div class="lesson__block">

                            <span class="lesson-block-num">1</span>
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'It\'s well-known that YouTube likes when you regularly
                        ...
                        <div class="lesson__block">
                            ...
                            <span class="lesson-block-num">2</span>
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'Second factor is related to your subscribers. If you
                        ...
                        <footer class="lesson-footer">
                            ...
                            <p class="lesson-footer-text"><?=Yii::t(category:'front', message:'In the next DVC lessons on YouTube promotion, we\'ll talk about
                    ...
                    <h1 class="school-accordion-caption"><?=Yii::t(category:'front', message:'How to promote your channel on YouTube in the top 10');?></h1>
                    <div class="school-accordion__container">

                        <div class="lesson-header">

                            <h2 class="lesson-header-caption"><?=Yii::t(category:'front', message:'How to promote your channel on YouTube in the top 10');?></h2>
                        ...
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'In the previous DVC lesson on basics of working with Youtube, we
                    ...
                    about how to make your channel popular and quickly get subscribers.');?></p>
                        <p class="lesson-text"><?=Yii::t(category:'front', message:'First of all, it\'s necessary to understand principles of videos popularization
                    on Youtube.');?></p>

                        <div class="lesson__block">

                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/rogue.svg" class="lesson-block-icon" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'Fraud won\'t work here! One of channel popularization peculiarities is the
                        ...
                        <div class="lesson__block">
                            ...
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'A useful and interesting channel promotes by itself. That\'s why even if
                        ...
                        <div class="lesson__block">
                            ...
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'You can\'t solve promotion issue with money. With money you can buy links,
                        ...
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'So what you can do to make your channel popular and to subscribers come
                    and stay?');?></p>

                        <div class="lesson__container">

                            <h1 class="lesson-caption--white"><?=Yii::t(category:'front', message:'We give you 10 effective tips:');?></h1>
                            ...
                            <div class="lesson__block">
                                ...
                                <div class="lesson-block__container">
                                    ...
                                    <h3 class="lesson-block-text--white--bold"><?=Yii::t(category:'front', message:'Title, description, tags');?></h3>
                                    <p class="lesson-block-text--white--wide"><?=Yii::t(category:'front', message:'Always come up with a title, write a description for it, put tags and specify a
                            ...
                            <div class="lesson__block">
                                ...
                                <div class="lesson-block__container">
                                    ...
                                    <h3 class="lesson-block-text--white--bold"><?=Yii::t(category:'front', message:'Create a unique trademark');?></h3>
                                    <p class="lesson-block-text--white--wide"><?=Yii::t(category:'front', message:'Think about what your channel\'s main page will look like, what will be the design
                            ...
                            <div class="lesson__block">
                                ...
                                <div class="lesson-block__container">
                                    ...
                                    <h3 class="lesson-block-text--white--bold"><?=Yii::t(category:'front', message:'Free channel advertising');?></h3>
                                    <p class="lesson-block-text--white--wide"><?=Yii::t(category:'front', message:'Don\'t hesitate to promote your channel in every possible way. For example, mention
                            ...
                            <div class="lesson__block">
                                ...
                                <div class="lesson-block__container">
                                    ...
                                    <h3 class="lesson-block-text--white--bold"><?=Yii::t(category:'front', message:'Contextual advertising');?></h3>
                                    <p class="lesson-block-text--white--wide"><?=Yii::t(category:'front', message:'This way of promoting your Youtube channel is paid, but not so expensive compared
                            ...
                            <div class="lesson__block">
                                ...
                                <div class="lesson-block__container">
                                    ...
                                    <h3 class="lesson-block-text--white--bold"><?=Yii::t(category:'front', message:'The more the better');?></h3>
                                    <p class="lesson-block-text--white--wide"><?=Yii::t(category:'front', message:'If you\'re going to upload one video per month, you\'ll never be able to promote
                            ...
                            <div class="lesson__block">
                                ...
                                <div class="lesson-block__container">
                                    ...
                                    <h3 class="lesson-block-text--white--bold"><?=Yii::t(category:'front', message:'Ask correctly and people will listen to you');?></h3>
                                    <p class="lesson-block-text--white--wide"><?=Yii::t(category:'front', message:'Communicate with your subscribers openly. It\'s better to directly ask for likes or
                            ...
                            <div class="lesson__block">
                                ...
                                <div class="lesson-block__container">
                                    ...
                                    <h3 class="lesson-block-text--white--bold"><?=Yii::t(category:'front', message:'Earn popularity on others');?></h3>
                                    <p class="lesson-block-text--white--wide"><?=Yii::t(category:'front', message:'Look for top Youtube channels and create some video on the topic. For example,
                            ...
                            <div class="lesson__block">
                                ...
                                <div class="lesson-block__container">
                                    ...
                                    <h3 class="lesson-block-text--white--bold"><?=Yii::t(category:'front', message:'Make viral content');?></h3>
                                    <p class="lesson-block-text--white--wide"><?=Yii::t(category:'front', message:'If there is at least one viral video on your channel (something that has millions
                            ...
                            <div class="lesson__block">
                                ...
                                <div class="lesson-block__container">
                                    ...
                                    <h3 class="lesson-block-text--white--bold"><?=Yii::t(category:'front', message:'Be friends with other bloggers');?></h3>
                                    <p class="lesson-block-text--white--wide"><?=Yii::t(category:'front', message:'Yes, making friends with Youtube stars won\'t be easy, but if you succeed, there are
                            ...
                            <div class="lesson__block">
                                ...
                                <div class="lesson-block__container">
                                    ...
                                    <h3 class="lesson-block-text--white--bold"><?=Yii::t(category:'front', message:'Listen to subscribers');?></h3>
                                    <p class="lesson-block-text--white--wide"><?=Yii::t(category:'front', message:'Be sure to read comments under your videos, respond to them and thank for
                        ...
                        <p class="lesson-text"><?=Yii::t(category:'front', message:'Having set a goal to get into the top, you should know that to promote a video
                    to Youtube top you need to take into account:');?></p>

                        <div class="lesson__block">

                            <span class="lesson-block-num">1</span>
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'<b>Backlinks</b>
                        ...
                        <div class="lesson__block">
                            ...
                            <span class="lesson-block-num">2</span>
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'<b>Number of views</b>
                        ...
                        <div class="lesson__block">
                            ...
                            <span class="lesson-block-num">3</span>
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'<b>Duration of viewing</b>
                        ...
                        <div class="lesson__block">
                            ...
                            <span class="lesson-block-num">4</span>
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'<b>Involvement of viewer</b>
                        ...
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'When creating content you should always be aware of the latest events
                ...
                <h1 class="school-accordion-caption-empty"><?=Yii::t(category:'front', message:'Use of messengers as a instant sales channel');?></h1>

                <h1 class="school-accordion-caption-empty"><?=Yii::t(category:'front', message:'Private course of promotion in Instagram');?></h1>

                <h1 class="school-accordion-caption-empty"><?=Yii::t(category:'front', message:'Private course of promotion on Facebook');?></h1>

                <h1 class="school-accordion-caption-empty"><?=Yii::t(category:'front', message:'Cheap targeted advertising on Facebook. Loyal customer flow');?></h1>

                <h1 class="school-accordion-caption-empty"><?=Yii::t(category:'front', message:'Closed sources. Definitive guide');?></h1>

                <h1 class="school-accordion-caption-empty"><?=Yii::t(category:'front', message:'Residual income with the help of Facebook and Instagram');?></h1>
            ...
            <div id="offline-promotion" class="school__body offline-promotion hide hide-mob">
                ...
                <div class="school-accordion">
                    ...
                    <h1 class="school-accordion-caption"><?=Yii::t(category:'front', message:'Fundamental principles of offline promotion');?></h1>
                    <div class="school-accordion__container">

                        <div class="lesson-header">

                            <h2 class="lesson-header-caption"><?=Yii::t(category:'front', message:'Fundamental principles of offline promotion');?></h2>
                            <img src="/modules/admin/cabinet_assets/pictures/svg/drows/salesPromo.svg"
                                 class="lesson-header-img--big" alt="" />

                        </div>

                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'Many of us worry when we have an important meeting, an interview. “ I\'ll
                    ...
                    and accept Your point of view.');?></p>
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'We prepared for you some rules and tips that will help You to sell any
                    goods and services calm and confidently, convince a person that you are right and attract him into
                    your partner network.');?></p>

                        <div class="lesson__container">

                            <h2 class="lesson-caption--white"><?=Yii::t(category:'front', message:'Appearance');?></h2>
                            <p class="lesson-hint--white"><?=Yii::t(category:'front', message:'There is a rule of 150 score. 30 score for every point');?></p>

                            <div class="lesson__block">

                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/user.svg"
                                     class="lesson-block-icon" alt="" />
                                <p class="lesson-block-text--white"><?=Yii::t(category:'front', message:'Appearance - the better you look, the better you are spick
                            ...
                            <div class="lesson__block">
                                ...
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/head-management.svg"
                                     class="lesson-block-icon" alt="" />
                                <p class="lesson-block-text--white"><?=Yii::t(category:'front', message:'Internal state - a cheerful, confident and positive person
                            ...
                            <div class="lesson__block">
                                ...
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/rock.svg"
                                     class="lesson-block-icon" alt="" />
                                <p class="lesson-block-text--white"><?=Yii::t(category:'front', message:'Status and solvency - the higher the person\'s place in the
                            ...
                            <div class="lesson__block">
                                ...
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/stationery.svg"
                                     class="lesson-block-icon" alt="" />
                                <p class="lesson-block-text--white"><?=Yii::t(category:'front', message:'What you are saying. If your speech is rich with
                            ...
                            <div class="lesson__block">
                                ...
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/target.svg"
                                     class="lesson-block-icon" alt="" />
                                <p class="lesson-block-text--white"><?=Yii::t(category:'front', message:'The way you speak. Easy, beautifully, funny, warmly and
                        ...
                        <h2 class="lesson-caption--black"><?=Yii::t(category:'front', message:'To get 150 scale is impossible. This is too ideal approach.');?></h2>
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'But 100 scale is good enough to close a transaction, attract partners and
                    strike up Lots of acquaintances');?></p>
                        ...
                        <div class="fundamental__container">
                            ...
                            <div class="fundamental-container--left">
                                ...
                                <div class="fundamental-container__content">
                                    ...
                                    <p class="fundamental-container-text"><?=Yii::t(category:'front', message:'Appearance. It is enough to have a well-groomed
                                ...
                                <div class="fundamental-container__content">
                                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/box.svg"
                                         class="fundamental-container-icon" alt="" />
                                    <p class="fundamental-container-text"><?=Yii::t(category:'front', message:'Internal state. Our appearance, the quality of a
                                ...
                                <div class="fundamental-container__content">
                                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/diamond.svg"
                                         class="fundamental-container-icon" alt="" />
                                    <p class="fundamental-container-text"><?=Yii::t(category:'front', message:'Status and solvency. Since you are at the beginning of
                                ...
                                <div class="fundamental-container__content">
                                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/talking.svg"
                                         class="fundamental-container-icon" alt="" />
                                    <p class="fundamental-container-text"><?=Yii::t(category:'front', message:'What are you saying. Get rid of filler-words. Speak
                                ...
                                <div class="fundamental-container__content">
                                    <img src=/modules/admin/cabinet_assets/pictures/svg/icons/contract.svg"
                                         class="fundamental-container-icon" alt="" />
                                    <p class="fundamental-container-text"><?=Yii::t(category:'front', message:'The way you speak. Have an eye-contact. This is a
                        ...
                        <h2 class="lesson-caption--black"><?=Yii::t(category:'front', message:'And here it is some important nuances before a meeting');?></h2>
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'Be an active and attentive listener. Smile, nod, frown when appropriate.
                    ...
                    Where? Why? This will visibly enliven a conversation and make it more friendly.');?></p>
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'Call a person by name. This is not only a sign of respect and
                    ...
                    is always pleasant to hear your name - use it.');?></p>
                        ...
                        <footer class="lesson-footer">
                            <p class="lesson-footer-text"><?=Yii::t(category:'front', message:'In the following lessons, we will analyze in more detail the ability
                    ...
                    <h1 class="school-accordion-caption"><?=Yii::t(category:'front', message:'How to reach an agreement about cooperation');?></h1>
                    <div class="school-accordion__container">

                        <div class="lesson-header">

                            <h2 class="lesson-header-caption"><?=Yii::t(category:'front', message:'How to reach an agreement about cooperation');?></h2>
                            <img src=/modules/admin/cabinet_assets/pictures/svg/drows/cooperation.svg"
                                 class="lesson-header-img--big" alt="" />

                        </div>

                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'In order a person to become convinced that he need to cooperate with you
                    ...
                    this, arguments that convince a person that his fears are groundless.');?></p>
                        ...
                        <div class="lesson__block">
                            ...
                            <div class="lesson__block--three">
                                ...
                                <p class="lesson-block-text--three"><?=Yii::t(category:'front', message:'Untenable arguments');?></p>
                                <br>
                            ...
                            <div class="lesson__block--three">
                                ...
                                <img src=/modules/admin/cabinet_assets/pictures/svg/icons/puzzle2.svg"
                                     class="lesson-block-icon--three" alt="" />
                                <p class="lesson-block-text--three"><?=Yii::t(category:'front', message:'Weak arguments');?></p>
                            ...
                            <div class="lesson__block--three">
                                ...
                                <img src=/modules/admin/cabinet_assets/pictures/svg/icons/puzzle4.svg"
                                     class="lesson-block-icon--three" alt="" />
                                <p class="lesson-block-text--three"><?=Yii::t(category:'front', message:'Strong arguments');?></p>

                            </div>

                        </div>

                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'Arguments differ in a degree of impact on a mind and feelings of people:
                    strong, weak and untenable. Rebuttals (counter arguments) have the same gradation.');?></p>
                        ...
                        <div class="coop__container">
                            ...
                            <div class="coop__container-graphic">
                                ...
                                <div class="coop-container-graphic__texts">
                                    ...
                                    <p class="coop-container-graphic-text graphic-text--left"><?=Yii::t(category:'front', message:'Untenable arguments');?></p>
                                    <p class="coop-container-graphic-text graphic-text--middle"><?=Yii::t(category:'front', message:'Weak arguments');?></p>
                                    <p class="coop-container-graphic-text graphic-text--right"><?=Yii::t(category:'front', message:'Strong arguments');?></p>
                        ...
                        <h2 class="lesson-caption--black"><?=Yii::t(category:'front', message:'Strong arguments');?></h2>

                        <div class="lesson__block">

                            <img src=/modules/admin/cabinet_assets/pictures/svg/icons/200-billion-en.svg"
                                 class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'Arguments differ in a degree of impact on a mind and feelings of people:
                    strong, weak and untenable. Rebuttals (counter arguments) have the same gradation.');?></p>
                        ...
                        <div class="lesson__block">
                            <img src=/modules/admin/cabinet_assets/pictures/svg/icons/shield.svg"
                                 class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'World\'s richest market is the MLM market. The annual
                        ...
                        <div class="lesson__block">
                            <img src=/modules/admin/cabinet_assets/pictures/svg/icons/flasks.svg"
                                 class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'Laws, charters, guidelines, if they are executed and
                        ...
                        <div class="lesson__block">
                            <img src=/modules/admin/cabinet_assets/pictures/svg/icons/medal.svg"
                                 class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'Experimentally verified conclusions. Give examples of
                        ...
                        <div class="lesson__block">
                            <img src=/modules/admin/cabinet_assets/pictures/svg/icons/book.svg"
                                 class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'Expert\'s opinion. There is a popular video of a world
                        ...
                        <div class="lesson__block">
                            <img src=/modules/admin/cabinet_assets/pictures/svg/icons/camera.svg"
                                 class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'Eyewitness testimonies and witnesses of events. As an
                        ...
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'Statistic information if data collection, processing and
                        analysis made by a professional statistician.');?></p>

                        <div class="lesson__container">

                            <h2 class="lesson-caption--white"><?=Yii::t(category:'front', message:'Weak arguments');?></h2>
                            ...
                            <div class="argument__container">
                                ...
                                <p class="argument-container-text"><?=Yii::t(category:'front', message:'Inferences based on two or more separate facts, the
                            relationship between which is unclear without the third.');?></p>

                                <p class="argument-container-text"><?=Yii::t(category:'front', message:'Tricks and judgments built on alogisms (alogism is a
                            ...
                            \"Water, I drank it once. It does not quench thirst\").');?></p>
                                ...
                                <p class="argument-container-text"><?=Yii::t(category:'front', message:'References (quotes) to authorities, unknown or little-known
                            to your listeners.');?></p>

                                <p class="argument-container-text"><?=Yii::t(category:'front', message:'Analogies and non-indicative examples.');?></p>

                                <p class="argument-container-text"><?=Yii::t(category:'front', message:'Arguments of a private nature, coming out of circumstances or
                            dictated by motivation, desire.');?></p>

                                <p class="argument-container-text"><?=Yii::t(category:'front', message:'Biased retreats, aphorisms, sayings.');?></p>

                                <p class="argument-container-text"><?=Yii::t(category:'front', message:'Arguments, versions or generalizations, made on the basis of
                            conjectures, assumptions, sensations.');?></p>

                                <p class="argument-container-text--border"><?=Yii::t(category:'front', message:'Conclusions based on incomplete statistics.');?></p>

                            </div>

                        </div>

                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'They raise doubts of your opponents, clients, employees');?></p>


                        <h2 class="lesson-caption--blue"><?=Yii::t(category:'front', message:'Untenable arguments');?></h2>

                        <div class="argument__container--left">

                            <p class="lesson-text--circle"><?=Yii::t(category:'front', message:'Judgments based on fraudulent facts.');?></p>

                            <p class="lesson-text--circle"><?=Yii::t(category:'front', message:'References to doubtful, untested sources.');?></p>

                            <p class="lesson-text--circle"><?=Yii::t(category:'front', message:'Invalid decisions.');?></p>

                            <p class="lesson-text--circle"><?=Yii::t(category:'front', message:'Conjectures, guesses, assumptions, inventions.');?></p>

                            <p class="lesson-text--circle"><?=Yii::t(category:'front', message:'Arguments for prejudice, ignorance.');?></p>

                            <p class="lesson-text--circle"><?=Yii::t(category:'front', message:'Conclusions made from fictitious documents.');?></p>

                            <p class="lesson-text--circle"><?=Yii::t(category:'front', message:'Promises.');?></p>

                            <p class="lesson-text--circle"><?=Yii::t(category:'front', message:'False statements and evidences.');?></p>

                            <p class="lesson-text--circle"><?=Yii::t(category:'front', message:'Forgery and falsification of what is being said.');?></p>
                        ...
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'They help to expose, discredit an opponent who used them.');?></p>
                        ...
                        <footer class="coop__footer">
                            ...
                            <div class="coop-footer__container">
                                ...
                                <p class="coop-footer-text"><?=Yii::t(category:'front', message:'In the course of argumentation, use only those arguments that you
                            ...
                            <div class="coop-footer__container">
                                ...
                                <img src=/modules/admin/cabinet_assets/pictures/svg/icons/handshake.svg"
                                     class="coop-footer-img" alt="" />
                                <p class="coop-footer-text"><?=Yii::t(category:'front', message:'If an argument is not accepted, find a reason for this and then do
                            ...
                            <div class="coop-footer__container">
                                ...
                                <img src=/modules/admin/cabinet_assets/pictures/svg/icons/like.svg"
                                     class="coop-footer-img" alt="" />
                                <p class="coop-footer-text"><?=Yii::t(category:'front', message:'Do not underestimate the importance of strong arguments of an enemy.
                            ...
                            <div class="coop-footer__container">
                                ...
                                <img src=/modules/admin/cabinet_assets/pictures/svg/icons/molecule.svg"
                                     class="coop-footer-img" alt="" />
                                <p class="coop-footer-text"><?=Yii::t(category:'front', message:'Say your arguments, not related to what an enemy or partner said,
                            ...
                            <div class="coop-footer__container">
                                ...
                                <img src=/modules/admin/cabinet_assets/pictures/svg/icons/panel.svg"
                                     class="coop-footer-img" alt="" />
                                <p class="coop-footer-text"><?=Yii::t(category:'front', message:'More accurately measure the pace of argumentation with the pace of a
                            partner.');?></p>
                            ...
                            <div class="coop-footer__container">
                                ...
                                <img src=/modules/admin/cabinet_assets/pictures/svg/icons/head-management.svg"
                                     class="coop-footer-img" alt="" />
                                <p class="coop-footer-text"><?=Yii::t(category:'front', message:'Excessive persuasiveness always provokes rebuff, as the superiority
                            ...
                            <div class="coop-footer__container">
                                ...
                                <p class="coop-footer-text"><?=Yii::t(category:'front', message:'Give one or two bright arguments and, if a desired effect is
                            ...
                            <div class="coop-footer__container">
                                ...
                                <img src=/modules/admin/cabinet_assets/pictures/svg/icons/flag.svg"
                                     class="coop-footer-img" alt="" />
                                <p class="coop-footer-text"><?=Yii::t(category:'front', message:'Avoid weak and untenable arguments. They only harm. Use only strong
                            arguments.');?></p>
                            ...
                            <div class="coop-footer__container">
                                ...
                                <img src=/modules/admin/cabinet_assets/pictures/svg/icons/presentation.svg"
                                     class="coop-footer-img" alt="" />
                                <p class="coop-footer-text"><?=Yii::t(category:'front', message:'Be flexible. There is no need to argue with a man. When he says
                    ...
                    <h1 class="school-accordion-caption"><?=Yii::t(category:'front', message:'Create an image of a successful person');?></h1>
                    <div class="school-accordion__container">

                        <div class="lesson-header">

                            <h2 class="lesson-header-caption"><?=Yii::t(category:'front', message:'Create an image of a successful person');?></h2>
                            <img src=/modules/admin/cabinet_assets/pictures/svg/drows/successfull.svg"
                                 class="lesson-header-img lesson-header-img--320" alt="" />

                        </div>

                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'Image reveals in style, details, appearance – in everything that
                    ...
                    you need to look as you have already succeeded\”, - Thomas More urged upon his fellow citizens.');?></p>
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'Below we give you some tips how to create the vibrations of the success
                    ...
                    solemn fool.');?></p>
                        ...
                        <div class="successful__contetn--left">
                            ...
                            <div class="successful__container">
                                ...
                                <p class="successful-text"><?=Yii::t(category:'front', message:'You need to correct your profiles in the social networks in
                            ...
                            <div class="successful__container">
                                ...
                                <p class="successful-text"><?=Yii::t(category:'front', message:'If you are planning to be engaged in politics you shouldn\'t load
                            ...
                            <div class="successful__container">
                                ...
                                <p class="successful-text"><?=Yii::t(category:'front', message:'Secondly, forbid anybody from tagging you on the photos without your
                        ...
                        <div class="successful__contetn--right">
                            ...
                            <div class="successful__container">
                                ...
                                <p class="successful-text"><?=Yii::t(category:'front', message:'You look more respectable wearing two layers of clothes. Men should
                            ...
                            <div class="successful__container">
                                ...
                                <p class="successful-text"><?=Yii::t(category:'front', message:'You should hide your tattoos and piercings if you have ones because
                            ...
                            <div class="successful__container">
                                ...
                                <p class="successful-text"><?=Yii::t(category:'front', message:'Use the right accessories. If you wear glasses, it should be a good
                        ...
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'You are the arithmetical mean of your circle. This statement equally
                    ...
                    your communicative skills taking special trainings and courses.');?></p>
                        ...
                        <p class="successful-text--border"><?=Yii::t(category:'front', message:'It takes more than a half of the year for the image that you are
                    ...
                    success depends on you only. Now you can decide what to do to achieve this success.');?></p>
                        <p class="successful-text--border"><?=Yii::t(category:'front', message:'What else is important for creating the image of the successful
                    ...
                    such as doing sports, sleeping well, healthy eating etc.');?></p>
                        ...
                        <div class="successful__container">
                            ...
                            <p class="successful-text"><?=Yii::t(category:'front', message:'Work on your voice. Well trained and confident voice is a significant
                        ...
                        <div class="successful__container">
                            ...
                            <img src=/modules/admin/cabinet_assets/pictures/svg/icons/bell.svg"
                                 class="successful-img" alt="" />
                            <p class="successful-text"><?=Yii::t(category:'front', message:'Don\'t fuss, take your time. Let your movements and speech be calm and
                        ...
                        <div class="successful__container">
                            ...
                            <img src=/modules/admin/cabinet_assets/pictures/svg/icons/send-mail.svg"
                                 class="successful-img" alt="" />
                            <p class="successful-text"><?=Yii::t(category:'front', message:'Remember about the self-introduction. It\'s important to analyze your
                        ...
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'All these small details create the successful vibrations, that help you
                    ...
                    women. This experience proves the existence and efficiency of the successful image rules.');?></p>
                        ...
                        <footer class="lesson-footer">
                            <p class="lesson-footer-text"><?=Yii::t(category:'front', message:'Taking care of the image and appearance is not the extravagance or the
                    ...
                    <h1 class="school-accordion-caption"><?=Yii::t(category:'front', message:'How to increase trust to yourself');?></h1>
                    <div class="school-accordion__container">

                        <div class="lesson-header">

                            <h2 class="lesson-header-caption"><?=Yii::t(category:'front', message:'How to increase trust to yourself');?></h2>
                            <img src=/modules/admin/cabinet_assets/pictures/svg/drows/famous.svg"
                                 class="lesson-header-img lesson-header-img--320" alt="" />

                        </div>

                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'When first getting into the company consumer believes your words about
                    ...
                    complex would be much more efficient.');?></p>
                        ...
                        <h2 class="lesson-caption--black"><?=Yii::t(category:'front', message:'Use the power of brand and company\'s name');?></h2>

                        <div class="lesson__block">

                            <span class="lesson-block-num">1</span>
                            <img src=/modules/admin/cabinet_assets/pictures/svg/icons/star.svg" class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'Brand is one of the most powerful warranty of the quality. At the same time
                        ...
                        <h2 class="lesson-caption--black"><?=Yii::t(category:'front', message:'Work on the place for meetings with clients');?></h2>

                        <div class="lesson__block">

                            <span class="lesson-block-num">2</span>
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/theatre.svg" class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'The impression that consumer gets coming in the office, in the salespoint or
                        ...
                        <h2 class="lesson-caption--black"><?=Yii::t(category:'front', message:'Share the working process and your achievements');?></h2>

                        <div class="lesson__block">

                            <span class="lesson-block-num">3</span>
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/presentation.svg" class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'To earn the consumers\' sympathy tell them about the technologies that you are
                        ...
                        <h2 class="lesson-caption--black"><?=Yii::t(category:'front', message:'Provide the testing opportunity');?></h2>

                        <div class="lesson__block">

                            <span class="lesson-block-num">4</span>
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/box.svg" class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'Give consumers the opportunity to test your product or service before buying
                        ...
                        <h2 class="lesson-caption--black"><?=Yii::t(category:'front', message:'Use all the PR opportunities');?></h2>

                        <div class="lesson__block">

                            <span class="lesson-block-num">5</span>
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/online-shop.svg" class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'Undoubtedly, the more often your company\'s name being mentioned in the press
                        ...
                        <h2 class="lesson-caption--black"><?=Yii::t(category:'front', message:'Keep in touch with clients');?></h2>

                        <div class="lesson__block">

                            <span class="lesson-block-num">6</span>
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/phone-24.svg" class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'One of the most simple and effective ways to earn the client\'s sympathy is the
                        ...
                        <h2 class="lesson-caption--black"><?=Yii::t(category:'front', message:'Encourage giving recommendations');?></h2>
                        ...
                        <div class="lesson__block">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/networking-2.svg"
                                 class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'How do you choose a doctor or a tutor? Right, you listen to your
                        ...
                        <h2 class="lesson-caption--black"><?=Yii::t(category:'front', message:'Show the result of buying and not buying your service');?></h2>

                        <div class="lesson__block">

                            <span class="lesson-block-num">8</span>
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/hand-plant.svg" class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'Demonstrate the clients who have already bought your service and who are
                        ...
                        <h2 class="lesson-caption--black"><?=Yii::t(category:'front', message:'Use stereotypes');?></h2>

                        <div class="lesson__block">

                            <span class="lesson-block-num">9</span>
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/mustaches.svg" class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'Usually the stereotypes in the clients\' lives refer the products and services
                        ...
                        <h2 class="lesson-caption--black"><?=Yii::t(category:'front', message:'Take care of the additional service');?></h2>

                        <div class="lesson__block">

                            <span class="lesson-block-num">10</span>
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/gift.svg" class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'In addition to the general services you can include, for example, the hotline,
                        ...
                        <div class="trust-scheme__container">
                            ...
                            <h3 class="lesson-caption--white"><?=Yii::t(category:'front', message:'All these 10 methods work perfectly if you use them in
                        ...
                        credibility. You need to use them in order to achieve the desired result:');?></h3>
                            ...
                            <div class="lesson__block">
                                ...
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/pants.svg"
                                     class="lesson-block-icon" alt="" />
                                <p class="lesson-block-text--white"><?=Yii::t(category:'front', message:'Take care of your appearance. You cannot look
                            inappropriate.');?></p>
                            ...
                            <div class="lesson__block">
                                ...
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/two.svg"
                                     class="lesson-block-icon" alt="" />
                                <p class="lesson-block-text--white"><?=Yii::t(category:'front', message:'Ask clients the questions. Learn to listen to them and hear
                            them.');?></p>
                            ...
                            <div class="lesson__block">
                                ...
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/info.svg"
                                     class="lesson-block-icon" alt="" />
                                <p class="lesson-block-text--white"><?=Yii::t(category:'front', message:'Don\'t hide your sight during the conversation. That\'s the sign
                            of lie.');?></p>
                            ...
                            <div class="lesson__block">
                                ...
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/gift-1.svg"
                                     class="lesson-block-icon" alt="" />
                                <p class="lesson-block-text--white"><?=Yii::t(category:'front', message:'Offer clients the nice free staff such as a plastic bag with
                            your brand on it.');?></p>
                        ...
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'Finally, the credibility is closely related to the gratitude. Everyone
                    ...
                    around us always pay attention to it.');?></p>
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'Always thank people even if it seems to be unnecessary. You can increase
                    ...
                    <h1 class="school-accordion-caption"><?=Yii::t(category:'front', message:'Clients before a face');?></h1>
                    <div class="school-accordion__container">

                        <div class="lesson-header">

                            <h2 class="lesson-header-caption"><?=Yii::t(category:'front', message:'Clients before a face');?></h2>
                        ...
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'Ok, you have just signed up the DiaVita Club (DVC), you\'ve learned a lot
                    of helpful information and now it\'s time to search for the first clients. Well, stop.');?></p>
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'Where you can find them? What should you do with them? In this DVC lesson
                    we will teach you how to find your first clients without efforts - they are just before your own
                    face! Let\'s start!');?></p>

                        <h2 class="lesson-caption--black"><?=Yii::t(category:'front', message:'1. Make a list of your acquaintances');?></h2>

                        <div class="lesson__block">

                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/networking-2.svg"
                                 class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'This is a classic way to capture the clients. In the beginning you can
                        ...
                        <h2 class="lesson-caption--black"><?=Yii::t(category:'front', message:'2. Acquaintances of your acquaintances');?></h2>

                        <div class="lesson__block">

                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/networking.svg"
                                 class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'There are always people you haven\'t involved. In this case you can
                        ...
                        <div class="before-face-scheme__container">
                            ...
                            <h3 class="before-face-scheme-caption"><?=Yii::t(category:'front', message:'The first two variants may seem poorly effective because
                        sometimes it may seem that you have already offered your business to everyone. Have you really
                            ...
                            <div class="before-face-scheme__content">
                                ...
                                <div class="before-face-scheme__info">
                                    ...
                                    <p class="before-face-scheme-info-text"><?=Yii::t(category:'front', message:'Guests at the somebody\'s birthday party?');?></p>
                                ...
                                <div class="before-face-scheme__info">
                                    ...
                                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/handshake.svg"
                                         class="before-face-scheme-info-icon" alt="" />
                                    <p class="before-face-scheme-info-text"><?=Yii::t(category:'front', message:'Colleagues or neighbors?');?></p>
                                ...
                                <div class="before-face-scheme__info">
                                    ...
                                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/bus.svg"
                                         class="before-face-scheme-info-icon" alt="" />
                                    <p class="before-face-scheme-info-text"><?=Yii::t(category:'front', message:'Fellow travelers?');?></p>
                                ...
                                <div class="before-face-scheme__info">
                                    ...
                                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/bag.svg"
                                         class="before-face-scheme-info-icon" alt="" />
                                    <p class="before-face-scheme-info-text"><?=Yii::t(category:'front', message:'Classmates?');?></p>
                                ...
                                <div class="before-face-scheme__info">
                                    ...
                                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/cup-of-tea.svg"
                                         class="before-face-scheme-info-icon" alt="" />
                                    <p class="before-face-scheme-info-text"><?=Yii::t(category:'front', message:'People sitting next to you at the cafe?');?></p>
                                ...
                                <div class="before-face-scheme__info">
                                    ...
                                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/mustaches.svg"
                                         class="before-face-scheme-info-icon" alt="" />
                                    <p class="before-face-scheme-info-text"><?=Yii::t(category:'front', message:'Your children\'s teachers, doctors?');?></p>
                                ...
                                <div class="before-face-scheme__info">
                                    ...
                                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/searching.svg"
                                         class="before-face-scheme-info-icon" alt="" />
                                    <p class="before-face-scheme-info-text"><?=Yii::t(category:'front', message:'Contacts from your old notebook?');?></p>
                                ...
                                <div class="before-face-scheme__info">
                                    ...
                                    <img src="/modules/admin/cabinet_assets/pictures/svg/icons/man-diagramma.svg"
                                         class="before-face-scheme-info-icon" alt="" />
                                    <p class="before-face-scheme-info-text"><?=Yii::t(category:'front', message:'Your teachers');?></p>
                        ...
                        <h2 class="lesson-caption--black"><?=Yii::t(category:'front', message:'3. Social network advertising');?></h2>

                        <div class="lesson__block">

                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/talking.svg"
                                 class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'There are lots of social networks that you can use for your business!
                        ...
                        <h2 class="lesson-caption--black"><?=Yii::t(category:'front', message:'4. Mailout');?></h2>

                        <div class="lesson__block">

                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/stationery.svg"
                                 class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'Experience has proven that the mass mails distribution is a very
                        ...
                        <h2 class="lesson-caption--black"><?=Yii::t(category:'front', message:'5. Landing pages');?></h2>

                        <div class="lesson__block">

                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/laptop-and-rocket.svg"
                                 class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'The well-made landing pages can capture the enormous attention to your
                        project. Don\'t miss that opportunity!');?></p>

                        </div>

                        <h2 class="lesson-caption--black"><?=Yii::t(category:'front', message:'6. Cold calls');?></h2>

                        <div class="lesson__block">

                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/support.svg"
                                 class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'Use cold calls to capture the potential clients whom you haven\'t known
                        ...
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'Joining the business, you become the client of the company that you have
                    ...
                    people.');?></p>
                        ...
                        <footer class="lesson-footer">
                            <p class="lesson-footer-text"><?=Yii::t(category:'front', message:'We believe that all these variants help you forget about the problem
                    ...
                    <h1 class="school-accordion-caption"><?=Yii::t(category:'front', message:'Customers for life');?></h1>
                    <div class="school-accordion__container">

                        <div class="lesson-header">

                            <h2 class="lesson-header-caption"><?=Yii::t(category:'front', message:'Customers for life');?></h2>
                            <img src="/modules/admin/cabinet_assets/pictures/svg/drows/oldFriends.svg"
                                 class="lesson-header-img lesson-header-img--fix" alt="" />

                        </div>

                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'In the past lesson, we told you how to find customers and sell them your
                    ...
                    correspondingly, retain them, be sure to observe 8 important commandments:');?></p>
                        ...
                        <h2 class="lesson-caption--blue"><?=Yii::t(category:'front', message:'Keep them coming back');?></h2>

                        <div class="lesson__block">

                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/heart.svg"
                                 class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'Customers\' desires must be very important to you. Talk to them,
                        ...
                        <h2 class="lesson-caption--blue"><?=Yii::t(category:'front', message:'Having a system is the key');?></h2>

                        <div class="lesson__block">

                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/networking.svg"
                                 class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'Your structure must work distinctly and smoothly, just like
                        ...
                        <div class="customers__container-images--height">
                            ...
                            <p class="customers-container-text--light"><?=Yii::t(category:'front', message:'What do you<br/> think...');?></p>

                        </div>

                        <h2 class="lesson-caption--blue"><?=Yii::t(category:'front', message:'Don\'t just promise things – do them');?></h2>

                        <div class="lesson__block">

                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/handshake.svg"
                                 class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'Never promise the customer something you can\'t give him. For
                        ...
                        <h2 class="lesson-caption--blue"><?=Yii::t(category:'front', message:'If your customer asks for something, your reply should always be
                    \“Yes\”');?></h2>
                        ...
                        <div class="lesson__block">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/like.svg"
                                 class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'You should be not selling a product to the customer, but rather
                        ...
                        <h2 class="lesson-caption--blue"><?=Yii::t(category:'front', message:'Everyone makes mistakes');?></h2>

                        <div class="lesson__block">

                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/gift.svg"
                                 class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'Don\'t blame yourself or your partner if all the sudden a mistake
                        ...
                        <h2 class="lesson-caption--blue"><?=Yii::t(category:'front', message:'Not having any complaints is a bad thing');?></h2>

                        <div class="lesson__block">

                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/support.svg"
                                 class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'Remember, not everything can be perfect. Everyone has complaints
                        ...
                        <h2 class="lesson-caption--blue"><?=Yii::t(category:'front', message:'Measure everything');?></h2>

                        <div class="lesson__block">

                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/progress.svg"
                                 class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'Digits and statistics should be important to you. Measure
                        ...
                        <h2 class="lesson-caption--blue"><?=Yii::t(category:'front', message:'Become better');?></h2>

                        <div class="lesson__block">

                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/searching.svg"
                                 class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'There is no limit to perfection. Find out how things are going
                        ...
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'Building a relationship with a customer seems like a simple task, however
                    ...
                    with customers, try these several methods as well:');?><</p>
                        ...
                        <div class="customers__comment">
                            ...
                            <p class="customers-comment-text"><?=Yii::t(category:'front', message:'Treat people how you\'d like to be treated. This may seem obvious,
                        ...
                        <div class="customers__comment">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/avatarPandaGirl-2.svg"
                                 class="customers-comment-img" alt="" />
                            <p class="customers-comment-text"><?=Yii::t(category:'front', message:'Be honest. Lies about your products, raw materials, and service
                        ...
                        <div class="customers__comment">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/avatarPandaBoy-2.svg"
                                 class="customers-comment-img" alt="" />
                            <p class="customers-comment-text"><?=Yii::t(category:'front', message:'Remember that your customers are people, not numbers. After
                        ...
                        <div class="customers__comment">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/avatarPandaGirl-1.svg"
                                 class="customers-comment-img" alt="" />
                            <p class="customers-comment-text"><?=Yii::t(category:'front', message:'Follow body language. Many people don\'t say what\'s in their head.
                        ...
                        <div class="customers__comment">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/avatarPandaBoy-3.svg"
                                 class="customers-comment-img" alt="" />
                            <p class="customers-comment-text"><?=Yii::t(category:'front', message:'Take a sincere interest in your customer. Listen to him,
                        ...
                        <footer class="lesson-footer">
                            <p class="lesson-footer-text"><?=Yii::t(category:'front', message:'Working with customers is not a simple task and it has a lot of
                    ...
                    <h1 class="school-accordion-caption"><?=Yii::t(category:'front', message:'Making a residual income');?></h1>
                    <div class="school-accordion__container">

                        <div class="lesson-header">

                            <h2 class="lesson-header-caption"><?=Yii::t(category:'front', message:'Making a residual income');?></h2>
                        ...
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'In this lesson we will answer the question \“Where do people get passive
                    ...
                    very business and obtain a passive income from it in the amount you planned for.');?></p>
                        ...
                        <div class="lesson__container">
                            ...
                            <h2 class="lesson-caption--white"><?=Yii::t(category:'front', message:'The following are the benefits of passive income:');?></h2>

                            <div class="lesson__block">

                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/currency.svg"
                                     class="lesson-block-icon" alt="" />
                                <p class="lesson-block-text--white"><?=Yii::t(category:'front', message:'In time, an unlimited amount of money can be acquired based
                            ...
                            <div class="lesson__block">
                                ...
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/clock-setting.svg"
                                     class="lesson-block-icon" alt="" />
                                <p class="lesson-block-text--white"><?=Yii::t(category:'front', message:'Owners of assets generating money flows have more free time
                            ...
                            <div class="lesson__block">
                                ...
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/house.svg"
                                     class="lesson-block-icon" alt="" />
                                <p class="lesson-block-text--white"><?=Yii::t(category:'front', message:'After achieving passive income, people can compile their own
                        ...
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'Now let\'s investigate under what conditions you have a basis to count on
                    passive income at DiaVita.');?></p>


                        <h2 class="lesson-caption--blue"><?=Yii::t(category:'front', message:'Your team');?></h2>
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'You\'ve worked vigorously with great focus for 3-4 years and created your
                    ...
                    maintain their own distributors.');?></p>
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'The company usually regularly pays interest to you off of revenue your
                    ...
                    easily copy your actions and create their own teams. All of this is passed down the structure.');?></p>
                        ...
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'That\'s how huge organizations are created. Meanwhile, you can only know
                    10-20 partners from your first-second line.');?></p>

                        <div class="lesson__container">

                            <h2 class="lesson-caption--white"><?=Yii::t(category:'front', message:'Quality products');?></h2>

                            <p class="lesson-text--white"><?=Yii::t(category:'front', message:'Your company\'s products usually have to be quality products.
                        ...
                        your distributor network.');?></p>
                            <p class="lesson-text--white"><?=Yii::t(category:'front', message:'There\'s a very simple test: are you prepared to regularly acquire
                        ...
                        assets? If the answer is “Yes”, then you\'re on the right track!');?></p>
                            ...
                            <p class="lesson-text--white"><?=Yii::t(category:'front', message:'If you observe these conditions, both your partners and your
                        customers will need to regularly acquire your company\'s products, which will create product
                        revenue in your organization.');?></p>

                        </div>

                        <h2 class="lesson-caption--blue"><?=Yii::t(category:'front', message:'System');?></h2>
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'The whole secret\'s the system. It must be active within your team.');?></p>
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'This is the main condition for creating residual income, just like all
                    ...
                    their partners who also get engaged in the system.');?></p>
                        ...
                        <h2 class="lesson-caption--blue"><?=Yii::t(category:'front', message:'Off-line and on-line');?></h2>
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'We\'ve gradually made our way to yet another important condition in
                    ...
                    structures for your business at the same time.');?></p>
                        ...
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'If your team works only offline and doesn\'t have a path for development
                    ...
                    contacts.');?></p>
                        ...
                        <footer class="lesson-footer">
                            <p class="lesson-footer-text"><?=Yii::t(category:'front', message:'You need to pave the way for passive income right now – the sooner you
            ...
            <div id="business-creating" class="school__body business-creating hide hide-mob">
                ...
                <h1 class="school-accordion-caption-empty"><?=Yii::t(category:'front', message:'Turn additional earnings into basic income');?></h1>

                <h1 class="school-accordion-caption-empty"><?=Yii::t(category:'front', message:'A quick way to make a team');?></h1>

                <h1 class="school-accordion-caption-empty"><?=Yii::t(category:'front', message:'Structure that grows by itself');?></h1>

                <h1 class="school-accordion-caption-empty"><?=Yii::t(category:'front', message:'How quickly to become a brand, which everyone will look up to');?></h1>

                <h1 class="school-accordion-caption-empty"><?=Yii::t(category:'front', message:'Secret ways of super popularity');?></h1>

                <h1 class="school-accordion-caption-empty"><?=Yii::t(category:'front', message:'Passive growth of a structure without your participation');?></h1>
            ...
            <div id="increase-in-sales" class="school__body increase-in-sales hide hide-mob">
                ...
                <div class="school-accordion">
                    ...
                    <h1 class="school-accordion-caption"><?=Yii::t(category:'front', message:'Increase the number of sales with a promo');?></h1>
                    <div class="school-accordion__container">

                        <div class="lesson-header">

                            <h2 class="lesson-header-caption"><?=Yii::t(category:'front', message:'Increase the number of sales with a promo');?></h2>
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/sales.svg"
                                 class="lesson-header-img--big" alt="" />

                        </div>

                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'Say who do not like bright and memorable articles and posts in social
                    ...
                    matter how brilliant it is written.');?></p>
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'It would be naive to believe that your audience buys only because it is
                    ...
                    promo form a potential buyer\'s decision to purchase the goods.');?></p>
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'In this lesson we will tell you some rules that will allow you to create
                    a promo that helps increase your sales.');?></p>
                        ...
                        <div class="lesson__block">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/target-1.svg"
                                 class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'Any images should be not just of high quality or unique - their
                        ...
                        <div class="lesson__block">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/shearch-1.svg"
                                 class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'Do not be lazy to study search results of pictures in the search for
                        ...
                        <div class="lesson__block">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/clown.svg"
                                 class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'Nobody forbids to use images from photobank, but they are better to
                        ...
                        <div class="lesson__block">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/camera.svg"
                                 class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'It\'s always better to make your own photos - they will be unique,
                        ...
                        <div class="lesson__block">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/two.svg"
                                 class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'If you use photos of people who recommend your product, it would be
                        ...
                        <div class="lesson__block">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/check-symbol.svg"
                                 class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'Attract customers to do photos with your product, leave sell -
                        ...
                        <div class="lesson__block">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/hand-plant.svg"
                                 class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'Good and effective approach - the use of schemes “before and after”
                        ...
                        <div class="lesson__block">
                            ...
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'Pay attention to a colour composition of your promo. Colors should be
                        ...
                        <div class="lesson__block">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/table.svg"
                                 class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'Pay special attention to the psychology of color. For example, black
                        ...
                        <div class="lesson__block">
                            ...
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/stars.svg"
                                 class="lesson-block-icon" alt="" />
                            <p class="lesson-block-text"><?=Yii::t(category:'front', message:'Try to bring out potential client\'s emotions with a promo. Shocking
                        promo always works better. The better promo is remembered, the better it sells.');?></p>

                        </div>

                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'But if you want more, then before you post a promo, answer the main
                    question: \"Why will my goods be bought?\"');?></p>
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'It\'s not enough to have just a picture, you need to think over a
                    ...
                    <h1 class="school-accordion-caption"><?=Yii::t(category:'front', message:'Combating contradictions');?></h1>
                    <div class="school-accordion__container">

                        <div class="lesson-header">

                            <h2 class="lesson-header-caption"><?=Yii::t(category:'front', message:'Combating contradictions');?></h2>
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/choosing.svg"
                                 class="lesson-header-img--big lesson-header-img--fix" alt="" />

                        </div>

                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'In the process of making sales, you will often face objections from a
                    ...
                    techniques to work with objections, which will be discussed in this lesson.');?></p>
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'Every of us strive to optimize own sales and for this you need to know
                    ...
                    divided into 6 mail categories, even if they are formulated in different ways:');?></p>
                        ...
                        <div class="contradictions__container">
                            ...
                            <div class="contradictions__block">
                                ...
                                <p class="contradictions-block-text"><?=Yii::t(category:'front', message:'Objection associated with goods');?></p>
                            ...
                            <div class="contradictions__block">
                                ...
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/support.svg"
                                     class="contradictions-block-img" alt="" />
                                <p class="contradictions-block-text"><?=Yii::t(category:'front', message:'Objection associated with a seller');?></p>
                            ...
                            <div class="contradictions__block">
                                ...
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/house.svg"
                                     class="contradictions-block-img" alt="" />
                                <p class="contradictions-block-text"><?=Yii::t(category:'front', message:'Objection associated with a company');?></p>
                            ...
                            <div class="contradictions__block">
                                ...
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/online-shop.svg"
                                     class="contradictions-block-img" alt="" />
                                <p class="contradictions-block-text"><?=Yii::t(category:'front', message:'Objection associated with a service');?></p>
                            ...
                            <div class="contradictions__block">
                                ...
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/currency.svg"
                                     class="contradictions-block-img" alt="" />
                                <p class="contradictions-block-text"><?=Yii::t(category:'front', message:'Objection associated with price');?></p>
                            ...
                            <div class="contradictions__block">
                                ...
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/handshake.svg"
                                     class="contradictions-block-img" alt="" />
                                <p class="contradictions-block-text"><?=Yii::t(category:'front', message:'Indecisiveness in decision-making');?></p>

                            </div>

                        </div>

                        <h2 class="lesson-caption--blue"><?=Yii::t(category:'front', message:'To deal with objections of any type there is a common algorithm');?></h2>

                        <div class="contradictions__infographic">

                            <p class="contradictions-infographic-text-one"><?=Yii::t(category:'front', message:'Listen carefully to a buyer');?></p>
                        ...
                        <div class="contradictions__infographic">
                            ...
                            <p class="contradictions-infographic-text-two"><?=Yii::t(category:'front', message:'Recognize a buyer\'s point of view');?></p>
                        ...
                        <div class="contradictions__infographic">
                            ...
                            <p class="contradictions-infographic-text-two"><?=Yii::t(category:'front', message:'Choose the technique of dealing with an objection');?></p>
                        ...
                        <div class="contradictions__infographic">
                            ...
                            <p class="contradictions-infographic-text-one"><?=Yii::t(category:'front', message:'Answer the objection');?></p>
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/target.svg"
                                 class="contradictions-infographic-icon" alt="" />
                        ...
                        <div class="contradictions__infographic">
                            ...
                            <p class="contradictions-infographic-text-one"><?=Yii::t(category:'front', message:'Try to make a sale');?></p>
                        ...
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'Everything is extremely simple: you only need to earn credit of trust
                    ...
                    - from simple to complex.');?></p>
                        ...
                        <div class="contradictions__dialog">
                            ...
                            <h2 class="lesson-caption--blue"><?=Yii::t(category:'front', message:'Yes, but ...');?></h2>
                            <h3 class="lesson-caption--gray"><?=Yii::t(category:'front', message:'Technique number 1');?></h3>
                            <p class="lesson-text--border"><?=Yii::t(category:'front', message:'Agree with an objection of an interlocutor, but add a weighty
                        ...
                        <div class="contradictions__dialog">
                            ...
                            <h2 class="lesson-caption--blue"><?=Yii::t(category:'front', message:'That is why…');?></h2>
                            <h3 class="lesson-caption--gray"><?=Yii::t(category:'front', message:'Technique number 2');?></h3>
                            <p class="lesson-text--border"><?=Yii::t(category:'front', message:'Contest objections of an interlocutor, explaining them with your
                        positive motives.');?></p>
                        ...
                        <div class="contradictions__dialog">
                            ...
                            <h2 class="lesson-caption--blue"><?=Yii::t(category:'front', message:'Ask a Question');?></h2>
                            <h3 class="lesson-caption--gray"><?=Yii::t(category:'front', message:'Technique number 3');?></h3>
                        ...
                        <div class="contradictions__dialog">
                            ...
                            <h2 class="lesson-caption--blue"><?=Yii::t(category:'front', message:'Let\'s compare');?></h2>
                            <h3 class="lesson-caption--gray"><?=Yii::t(category:'front', message:'Technique number 4');?></h3>
                            <p class="lesson-text--border"><?=Yii::t(category:'front', message:'The method is very well suited to the objection of \"Expensive\". The
                        ...
                        <div class="contradictions__dialog">
                            ...
                            <h2 class="lesson-caption--blue"><?=Yii::t(category:'front', message:'Division');?></h2>
                            <h3 class="lesson-caption--gray"><?=Yii::t(category:'front', message:'Technique number 5');?></h3>
                            <p class="lesson-text--border"><?=Yii::t(category:'front', message:'A good method when you need to prove that a more expensive product is
                        ...
                        <div class="contradictions__dialog">
                            ...
                            <h2 class="lesson-caption--blue"><?=Yii::t(category:'front', message:'Reduction ad absurdum');?></h2>
                            <h3 class="lesson-caption--gray"><?=Yii::t(category:'front', message:'Technique number 6');?></h3>
                            <p class="lesson-text--border"><?=Yii::t(category:'front', message:'You take a client\'s objection and confront it with a stronger
                        ...
                        <div class="contradictions__dialog">
                            ...
                            <h2 class="lesson-caption--blue"><?=Yii::t(category:'front', message:'Reference to the past');?></h2>
                            <h3 class="lesson-caption--gray"><?=Yii::t(category:'front', message:'Technique number 7');?></h3>
                            <p class="lesson-text--border"><?=Yii::t(category:'front', message:'In order for this method to work, find in the past a client\'s
                        ...
                        <div class="contradictions__dialog">
                            ...
                            <h2 class="lesson-caption--blue"><?=Yii::t(category:'front', message:'Overstated the bar');?></h2>
                            <h3 class="lesson-caption--gray"><?=Yii::t(category:'front', message:'Technique number 8');?></h3>
                            <p class="lesson-text--border"><?=Yii::t(category:'front', message:'An overstated bar is a story about a more complex case.');?></p>
                        ...
                        <div class="contradictions__dialog">
                            ...
                            <h2 class="lesson-caption--blue"><?=Yii::t(category:'front', message:'A client can also help');?></h2>
                            <h3 class="lesson-caption--gray"><?=Yii::t(category:'front', message:'Technique number 9');?></h3>
                            <p class="lesson-text--border"><?=Yii::t(category:'front', message:'This method is a magic wand. You just find out the acceptable
                        ...
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'These 9 simple techniques will help you significantly increase your
                    ...
                    otherwise you will spoil your reputation.');?></p>
                        ...
                        <footer class="lesson-footer">
                            <p class="lesson-footer-text"><?=Yii::t(category:'front', message:'In further lessons of the DVC, we will tell you in detail how to
                    ...
                    <h1 class="school-accordion-caption"><?=Yii::t(category:'front', message:'The power of a declaration');?></h1>
                    <div class="school-accordion__container">

                        <div class="lesson-header">

                            <h2 class="lesson-header-caption"><?=Yii::t(category:'front', message:'The power of a declaration');?></h2>
                        ...
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'Anyone would have to admit that we are constantly talking about goals. We
                    ...
                    promise, it\'s better not to make it in the first place.');?></p>
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'There exists a special technique called a “Declaration”. A Declaration is
                    ...
                    result.');?></p>
                        ...
                        <div class="lesson__container--scheme">
                            ...
                            <h2 class="lesson-caption--white"><?=Yii::t(category:'front', message:'\“The declaration technique\” can be broken down into four
                        basic elements:');?></h2>
                            ...
                            <div class="power__container">
                                ...
                                <p class="power-container-text"><?=Yii::t(category:'front', message:'The promise');?></p>
                            ...
                            <div class="power__container">
                                ...
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/three.svg"
                                     class="power-container-icon" alt="" />
                                <p class="power-container-text"><?=Yii::t(category:'front', message:'Publicity');?></p>
                            ...
                            <div class="power__container">
                                ...
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/teacher.svg"
                                     class="power-container-icon" alt="" />
                                <p class="power-container-text"><?=Yii::t(category:'front', message:'An overseer');?></p>
                            ...
                            <div class="power__container">
                                ...
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/coin.svg"
                                     class="power-container-icon" alt="" />
                                <p class="power-container-text"><?=Yii::t(category:'front', message:'Value in what you say');?></p>

                            </div>

                        </div>

                        <h2 class="lesson-caption--blue"><?=Yii::t(category:'front', message:'The promise');?></h2>
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'You think of a goal that you definitely have the guts for. Don\'t waste
                    ...
                    important: a maximum of three declarations per year.');?></p>
                        <p class="lesson-text"><?=Yii::t(category:'front', message:'Take a sheet of paper and write the following word for word:');?></p>
                        ...
                        <h2 class="lesson-caption--blue"><?=Yii::t(category:'front', message:'Value your words');?></h2>
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'After these daring words comes a key element that the declaration will
                    ...
                    how much you will give them if you do. For instance:');?></p>
                        <p class="lesson-text--blue"><?=Yii::t(category:'front', message:'Today, I have declared that I will buy an apartment in downtown Bangkok.
                    ...
                    do.');?></p>
                        ...
                        <h2 class="lesson-caption--blue"><?=Yii::t(category:'front', message:'Overseer');?></h2>
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'This is one of the key aspects of the model. It\'s very easy to trick
                    ...
                    said.');?></p>
                        <p class="lesson-text"><?=Yii::t(category:'front', message:'Who should the overseer be? The answer is simple – someone significant to you.
                    This is a person who you can\'t let down. It\'s a person who\'s attitude and respect toward you is very
                    important.');?></p>

                        <h2 class="lesson-caption--blue"><?=Yii::t(category:'front', message:'Publicity');?></h2>
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'You can easily get away with it if your declaration is stored in a drawer
                    ...
                    dissemination of your declaration.');?></p>
                        <p class="lesson-text"><?=Yii::t(category:'front', message:'Very few people have the guts and the gall to set big goals. But if a person does
                    this – he already deserves respect.');?></p>

                        <footer class="lesson-footer">
                            <p class="lesson-footer-text"><?=Yii::t(category:'front', message:'A declaration is quite an exotic and stressful method for achieving a
                    ...
                    <h1 class="school-accordion-caption"><?=Yii::t(category:'front', message:'The image that is imitated');?></h1>
                    <div class="school-accordion__container">

                        <div class="lesson-header">

                            <h2 class="lesson-header-caption"><?=Yii::t(category:'front', message:'The image that is imitated');?></h2>
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/mirror.svg"
                                 class="lesson-header-img lesson-header-img--320" alt="" />

                        </div>

                        <p class="lesson-text"><?=Yii::t(category:'front', message:'In other lessons of DiaVita Club we\'ve talked a lot about the importance of
                    creating a positive, successful public image to increase your sales and attract partners.');?></p>
                        <p class="lesson-text"><?=Yii::t(category:'front', message:'During this lesson we\'ll take a closer look at your public image components which
                    will not only allow you to be well-liked but also make them imitate your style.');?></p>

                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'The most tangible qualities in public image are those through which effect
                    ...
                    seem attractive to others and hold out these features. So what are these features? Let\'s start one by one.');?></p>
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'When do you want to be like a person, an idol? First, when this person lives
                    ...
                    to life.  So how to become such a person?');?></p>
                        ...
                        <div class="lesson__container">
                            ...
                            <h2 class="lesson-caption--white"><?=Yii::t(category:'front', message:'Personal growth');?></h2>
                            ...
                            <p class="lesson-text--white"><?=Yii::t(category:'front', message:'You surely have your own role model, a person you\'d like to become.
                        ...
                        these traits in yourself. Now you\'re already on the road to success.');?></p>
                            ...
                            <h2 class="lesson-caption--white"><?=Yii::t(category:'front', message:'Learn self-presentation skills');?></h2>
                            ...
                            <p class="lesson-text--white"><?=Yii::t(category:'front', message:'Developing qualities worthy of imitation is half the battle. To get
                        ...
                        in your qualities. How to do it?');?></p>
                            ...
                            <div class="lesson__block">
                                ...
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/dialog.svg"
                                     class="lesson-block-icon" alt="" />
                                <p class="lesson-block-text--white"><?=Yii::t(category:'front', message:'First, express your affection for other people. Forget about
                            ...
                            <div class="lesson__block">
                                ...
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/group-trio.svg"
                                     class="lesson-block-icon" alt="" />
                                <p class="lesson-block-text--white"><?=Yii::t(category:'front', message:'Secondly, look for similarities. People look up to those who are even
                            ...
                            <div class="lesson__block">
                                ...
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/harmony.svg"
                                     class="lesson-block-icon" alt="" />
                                <p class="lesson-block-text--white"><?=Yii::t(category:'front', message:'Thirdly, do not forget about modesty. A person rich in his inner world
                            ...
                            <h2 class="lesson-caption--white"><?=Yii::t(category:'front', message:'Competence and status strength');?></h2>
                            ...
                            <p class="lesson-text--border--white"><?=Yii::t(category:'front', message:'In order for people following you and wanting to be like you show
                        ...
                        Your competent opinion will only strengthen your authority.');?></p>
                            <p class="lesson-text--white"><?=Yii::t(category:'front', message:'As for power of authority, any person wants to touch the heights of
                        ...
                        for creating a public image of a person with high social status and power are:');?></p>
                            ...
                            <div class="lesson__block">
                                ...
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/growup-man.svg"
                                     class="lesson-block-icon" alt="" />
                                <p class="lesson-block-text--white"><?=Yii::t(category:'front', message:'Show fasces of status and power. However, be careful and don\'t confuse
                            ...
                            <div class="lesson__block">
                                ...
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/four-hands.svg"
                                     class="lesson-block-icon" alt="" />
                                <p class="lesson-block-text--white"><?=Yii::t(category:'front', message:'Unite yourself with people who have high status and power. \"Tell me
                            ...
                            <h2 class="lesson-caption--white"><?=Yii::t(category:'front', message:'Stay true to your public image until the end');?></h2>
                            ...
                            <p class="lesson-text--white"><?=Yii::t(category:'front', message:'If you create a public image people look up to you don\'t have the
                        ...
                        <footer class="income__footer">
                            ...
                            <p class="income-footer-text"><?=Yii::t(category:'front', message:'I wish you success in personal development!');?></p>
                ...
                <h1 class="school-accordion-caption-empty"><?=Yii::t(category:'front', message:'The passive-growing audience of your communities');?></h1>

                <h1 class="school-accordion-caption-empty"><?=Yii::t(category:'front', message:'A complete guide of increasing sales by 200%');?></h1>
            ...
            <div id="negotiation" class="school__body negotiation hide hide-mob">
                ...
                <div class="school-accordion">
                    ...
                    <h1 class="school-accordion-caption"><?=Yii::t(category:'front', message:'The rule of 3 \“Yes\”');?></h1>
                    <div class="school-accordion__container">

                        <div class="lesson-header">

                            <h2 class="lesson-header-caption"><?=Yii::t(category:'front', message:'The rule of 3 \“Yes\”');?></h2>
                            <img src="/modules/admin/cabinet_assets/pictures/svg/icons/3yes.svg"
                                 class="lesson-header-img" alt="" />

                        </div>

                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'During the process of negotiations many people ask a question that seems
                    ...
                    dream of a negotiator!');?></p>
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'Such certain rules do not exist, but there are many effective techniques
                    ...
                    good impression of you as a good negotiator.');?></p>
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'One of such rules is the rule of 3 “yes”. It gives you more chances to
                    ...
                    perfectly well.');?></p>
                        ...
                        <p class="lesson-hint"><?=Yii::t(category:'front', message:'This rule is used with success even by ordinary people. For example, children
                    ...
                    between a child and a mother:');?></p>
                        ...
                        <div class="yes__dialog">
                            ...
                            <ul class="yes-dialog-list">
                                <li class="yes-dialog-item-first">
                                    ...
                                    <p class="yes-dialog-first"><?=Yii::t(category:'front', message:'Mummy, do you love me?');?></p>
                                </li>
                                <li class="yes-dialog-item-second">
                                    <img src="/modules/admin/cabinet_assets/pictures/svg/dashdark.svg"
                                         class="yes-dialog-icon" alt="" />
                                    <p class="yes-dialog-second"><?=Yii::t(category:'front', message:'Yes');?></p>
                                </li>
                                <li class="yes-dialog-item-first">
                                    <img src="/modules/admin/cabinet_assets/pictures/svg/dash.svg"
                                         class="yes-dialog-icon" alt="" />
                                    <p class="yes-dialog-first"><?=Yii::t(category:'front', message:'Mummy? did I behave good today?');?></p>
                                </li>
                                <li class="yes-dialog-item-second">
                                ...
                                <li class="yes-dialog-item-first">
                                    <img src="/modules/admin/cabinet_assets/pictures/svg/dash.svg"
                                         class="yes-dialog-icon" alt="" />
                                    <p class="yes-dialog-first"><?=Yii::t(category:'front', message:'Mummy, will you buy me this toy car?');?></p>
                                </li>
                            </ul>

                        </div>

                        <p class="lesson-hint"><?=Yii::t(category:'front', message:'What do you think the answer in 99% of cases is?');?></p>


                        <div class="lesson__container">

                            <p class="lesson-text--white"><?=Yii::t(category:'front', message:'This method is interesting and because of the fact that there is
                        ...
                        <p class="lesson-hint"><?=Yii::t(category:'front', message:'Let\'s consider a simple example: you found a potential buyer and now you need to
                    ...
                    according to the rule of 3 \“yes\”:');?></p>
                        ...
                        <div class="yes__dialog">
                            ...
                            <ul class="yes-dialog-list">
                                <li class="yes-dialog-item-first">
                                    <img src="/modules/admin/cabinet_assets/pictures/svg/dash.svg"
                                         class="yes-dialog-icon" alt="" />
                                    <p class="yes-dialog-first"><?=Yii::t(category:'front', message:'So, you want to lose weight for a long time?');?></p>
                                </li>
                                <li class="yes-dialog-item-second">
                                    <img src="/modules/admin/cabinet_assets/pictures/svg/dashdark.svg"
                                         class="yes-dialog-icon" alt="" />
                                ...
                                <li class="yes-dialog-item-first">
                                    <img src="/modules/modules/admin/cabinet_assets/pictures/svg/dash.svg"
                                         class="yes-dialog-icon" alt="" />
                                    <p class="yes-dialog-first"><?=Yii::t(category:'front', message:'You said you haven\'t time to eat right?');?></p>
                                </li>
                                <li class="yes-dialog-item-second">
                                    <img src="/modules/admin/cabinet_assets/pictures/svg/dashdark.svg"
                                         class="yes-dialog-icon" alt="" />
                                ...
                                <li class="yes-dialog-item-first">
                                    <img src="/modules/admin/cabinet_assets/pictures/svg/dash.svg"
                                         class="yes-dialog-icon" alt="" />
                                    <p class="yes-dialog-first"><?=Yii::t(category:'front', message:'By the way, the cocktail Vita Energy I told you, can be made for
                        ...
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'This method is very easy, but to make it work you need to follow THREE
                    MAIN PRINCIPLES:');?></p>
                        ...
                        <div class="lesson__block">
                            ...
                            <div class="lesson-block__container">
                                ...
                                <h3 class="lesson-block-text--bold"><?=Yii::t(category:'front', message:'LOGIC.');?></h3>
                                <p class="lesson-block-text"><?=Yii::t(category:'front', message:'Questions must belong to a topic and logically
                            bracketed');?></p>
                        ...
                        <div class="lesson__block">
                            ...
                            <div class="lesson-block__container">
                                ...
                                <h3 class="lesson-block-text--bold"><?=Yii::t(category:'front', message:'SIMPLICITY.');?></h3>
                                <p class="lesson-block-text"><?=Yii::t(category:'front', message:'You should not use difficult and complex
                        ...
                        <div class="lesson__block">
                            ...
                            <div class="lesson-block__container">
                                ...
                                <h3 class="lesson-block-text--bold"><?=Yii::t(category:'front', message:'ADEQUATENESS.');?></h3>
                                <p class="lesson-block-text"><?=Yii::t(category:'front', message:'Questions must be adequate your listener
                        ...
                        <p class="lesson-hint"><?=Yii::t(category:'front', message:'In our opinion this method has advantages and disadvantages');?></p>
                        ...
                        <div class="yes-hang__container">
                            ...
                            <div class="yes-hang yes-hang__minus">
                                ...
                                <p class="yes-hang-text"><?=Yii::t(category:'front', message:'it is necessary to think in advance a chain of questions and variants
                            ...
                            <div class="yes-hang yes-hang__plus">
                                ...
                                <div class="yes-hang__text">
                                    <p class="yes-hang-text"><?=Yii::t(category:'front', message:'Allows you to inconspicuously bring an interlocutor to the solution
                                we need');?></p>
                                </div>
                        ...
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'So if you think over the course of the conversation in advance and pay
                    ...
                    can be used very successfully to increase the number of your sales in DV.');?></p>
                        ...
                        <footer class="lesson-footer">
                            <p class="lesson-footer-text"><?=Yii::t(category:'front', message:'This rule is only one of few that can help you develop the skill of
                    ...
                    <h1 class="school-accordion-caption"><?=Yii::t(category:'front', message:'Mister-charm');?></h1>
                    <div class="school-accordion__container">

                        <div class="lesson-header">

                            <h2 class="lesson-header-caption"><?=Yii::t(category:'front', message:'Mister-charm');?></h2>
                        ...
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'Have you ever thought why some people literally “attract” people to
                    ...
                    natural gift and it can not be strengthened. In fact, it is very simple to improve this trait!');?></p>
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'There are 3 main groups of traits, thanks to which you can increase the
                    level of personal charm. The first group includes the following natural traits:');?></p>

                        <div class="charm__container">

                            <h2 class="lesson-caption--white"><?=Yii::t(category:'front', message:'Natural traits');?></h2>

                            <div class="charm-container__content">
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/three.svg"
                                     class="charm-content-img" alt="" />
                                <p class="charm-content-text--white"><?=Yii::t(category:'front', message:'Sociability (ability to easily get on with people)');?></p>
                            </div>

                            <div class="charm-container__content">
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/masks.svg"
                                     class="charm-content-img" alt="" />
                                <p class="charm-content-text--white"><?=Yii::t(category:'front', message:'Empathy ( ability to empathize)');?></p>
                            </div>

                            <div class="charm-container__content">
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/search.svg"
                                     class="charm-content-img" alt="" />
                                <p class="charm-content-text--white"><?=Yii::t(category:'front', message:'Reflexion ( ability to understand a person)');?></p>
                            </div>

                            <div class="charm-container__content">
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/two.svg"
                                     class="charm-content-img" alt="" />
                                <p class="charm-content-text--white"><?=Yii::t(category:'front', message:'Eloquence (the ability to impact with a word).');?></p>
                            </div>

                        </div>

                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'These traits form the basis of natural talents, designated by the
                    ...
                    a personality, which are the result of education and upbringing.');?></p>
                        ...
                        <div class="charm__container--white">
                            ...
                            <h2 class="lesson-caption--blue"><?=Yii::t(category:'front', message:'Characteristics of a personality');?></h2>

                            <div class="charm-container__content">
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/libra.svg"
                                     class="charm-content-img" alt="" />
                                <p class="charm-content-text"><?=Yii::t(category:'front', message:'Moral values');?></p>
                            </div>

                            <div class="charm-container__content">
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/certeficate.svg"
                                     class="charm-content-img" alt="" />
                                <p class="charm-content-text"><?=Yii::t(category:'front', message:'Mental health');?></p>
                            </div>

                            <div class="charm-container__content-fix">
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/networking-3.svg"
                                     class="charm-content-img" alt="" />
                                <p class="charm-content-text"><?=Yii::t(category:'front', message:'Possession of communication techniques: interpersonal
                            communication, business speech, anticipation and overcoming of conflict situations.');?></p>
                            </div>

                        </div>

                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'The third group should include what is related to the life and
                    ...
                    perception of a person who is interested in recognition and benevolent attitude.');?></p>
                        <p class="lesson-text--border"><?=Yii::t(category:'front', message:'How to strengthen personal charisma? What do you need to change in
                    yourself, in your behavior for this? Just use our tips:');?></p>
                        ...
                        <div class="lesson__container">
                            <div class="lesson__block">
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/user.svg"
                                     class="lesson-block-icon" alt="" />
                                <p class="lesson-text--white"><?=Yii::t(category:'front', message:'Behave naturally. Just be yourself, you do not need to chase
                            ...
                            <div class="lesson__block">
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/hand-plant.svg"
                                     class="lesson-block-icon" alt="" />
                                <p class="lesson-text--white"><?=Yii::t(category:'front', message:'Be a good listener. People are always more interested in their
                            ...
                            <div class="lesson__block">
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/rockstar.svg"
                                     class="lesson-block-icon" alt="" />
                                <p class="lesson-text--white"><?=Yii::t(category:'front', message:'Demonstrate your interest in others - this is one of the best
                            ...
                            <div class="lesson__block">
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/heart.svg"
                                     class="lesson-block-icon" alt="" />
                                <p class="lesson-text--white"><?=Yii::t(category:'front', message:'Try to understand and support an interlocutor. Let people meet
                            ...
                            <div class="lesson__block">
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/networking-1.svg"
                                     class="lesson-block-icon" alt="" />
                                <p class="lesson-text--white"><?=Yii::t(category:'front', message:'Emphasize the similarity with your interlocutor. As you know,
                            ...
                            <div class="lesson__block">
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/like.svg"
                                     class="lesson-block-icon" alt="" />
                                <p class="lesson-text--white"><?=Yii::t(category:'front', message:'Express sincere approval. Except in very rare exceptions,
                            ...
                            <div class="lesson__block">
                                <img src="/modules/admin/cabinet_assets/pictures/svg/icons/shirt.svg"
                                     class="lesson-block-icon" alt="" />
                                <p class="lesson-text--white"><?=Yii::t(category:'front', message:'Do not scrimp on compliments. Let people feel their sincerity,
                    ...
                    <h1 class="school-accordion-caption-empty"><?=Yii::t(category:'front', message:'Pockets full of money');?></h1>

                    <h1 class="school-accordion-caption-empty"><?=Yii::t(category:'front', message:'How to convince a person to become BL');?></h1>

                    <h1 class="school-accordion-caption-empty"><?=Yii::t(category:'front', message:'Conversation examples that unconditionally convince to follow
                You');?></h1>

                    <h1 class="school-accordion-caption-empty"><?=Yii::t(category:'front', message:'Residual income. Structure of strong BL and SBL (senior business
                leader)');?></h1>

                    <h1 class="school-accordion-caption-empty"><?=Yii::t(category:'front', message:'Word-painter. Even the most stubborn people will be faithful');?></h1>
